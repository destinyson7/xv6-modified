...
int main(int argc, char *argv[]) {
   ...
   d:	53                   	push   %ebx
   e:	51                   	push   %ecx
   f:	bb 07 00 00 00       	mov    $0x7,%ebx
    int id, n = 7, limit = 1e8;
    double x = 0, z;
    x = 0;
    id = 0;
    for (int k = 0; k < n; k++) {
  ...
  1b:	78 33                	js     50 <main+0x50>
            printf(1, "%d failed in fork!\n", getpid());
        }
        if (id == 0) {  // child
  1d:	74 4b                	je     6a <main+0x6a>
    for (int k = 0; k < n; k++) {
  ...
  42:	e8 a3 02 00 00       	call   2ea <wait>
    ...
    exit();
  47:	e8 96 02 00 00       	call   2e2 <exit>
  4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
            printf(1, "%d failed in fork!\n", getpid());
  50:	e8 0d 03 00 00       	call   362 <getpid>
  55:	83 ec 04             	sub    $0x4,%esp
  58:	50                   	push   %eax
  59:	68 98 07 00 00       	push   $0x798
  5e:	6a 01                	push   $0x1
  60:	e8 db 03 00 00       	call   440 <printf>
  65:	83 c4 10             	add    $0x10,%esp
  68:	eb b5                	jmp    1f <main+0x1f>
            for (z = 0; z < limit; z += 1)
  6a:	d9 ee                	fldz   
  6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  70:	d8 05 ac 07 00 00    	fadds  0x7ac
  76:	d9 05 b0 07 00 00    	flds   0x7b0
  7c:	df e9                	fucomip %st(1),%st
  7e:	77 f0                	ja     70 <main+0x70>
  80:	dd d8                	fstp   %st(0)
  82:	eb c3                	jmp    47 <main+0x47>
  84:	66 90                	xchg   %ax,%ax
  86:	66 90                	xchg   %ax,%ax
  88:	66 90                	xchg   %ax,%ax
  8a:	66 90                	xchg   %ax,%ax
