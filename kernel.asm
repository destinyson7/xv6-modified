...
80100524:	e8 97 42 00 00       	call   801047c0 <memmove>
...
80100541:	e8 ca 41 00 00       	call   80104710 <memset>
...
801007f0:	e8 0b 3e 00 00       	call   80104600 <acquire>
...
80100823:	e8 d8 3d 00 00       	call   80104600 <acquire>
  while((c = getc()) >= 0){
...
801009d0:	e8 eb 3a 00 00       	call   801044c0 <initlock>
...
80100c39:	e8 f2 3c 00 00       	call   80104930 <strlen>
...
80100c4c:	e8 df 3c 00 00       	call   80104930 <strlen>
...
80100d0a:	e8 e1 3b 00 00       	call   801048f0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d91:	e8 6a 38 00 00       	call   80104600 <acquire>
...
80100dff:	e8 fc 37 00 00       	call   80104600 <acquire>
  if(f->ref < 1)
...
80101265:	e8 a6 34 00 00       	call   80104710 <memset>
  log_write(bp);
...
801012aa:	e8 51 33 00 00       	call   80104600 <acquire>
...
8010130f:	e8 ac 33 00 00       	call   801046c0 <release>
...
8010133a:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
8010133d:	e8 7e 33 00 00       	call   801046c0 <release>
      return ip;
...
80101461:	e8 5a 33 00 00       	call   801047c0 <memmove>
  brelse(bp);
...
8010158e:	e8 7d 31 00 00       	call   80104710 <memset>
      dip->type = type;
...
80101631:	e8 8a 31 00 00       	call   801047c0 <memmove>
  log_write(bp);
...
8010165f:	e8 9c 2f 00 00       	call   80104600 <acquire>
  ip->ref++;
80101664:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101668:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010166f:	e8 4c 30 00 00       	call   801046c0 <release>
}
...
80101718:	e8 a3 30 00 00       	call   801047c0 <memmove>
    brelse(bp);
...
801017c0:	e8 0b 2c 00 00       	call   801043d0 <acquiresleep>
...
801017da:	e8 51 2c 00 00       	call   80104430 <releasesleep>
  acquire(&icache.lock);
801017df:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017e6:	e8 15 2e 00 00       	call   80104600 <acquire>
  ip->ref--;
...
801017ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101800:	e9 bb 2e 00 00       	jmp    801046c0 <release>
80101805:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101808:	83 ec 0c             	sub    $0xc,%esp
8010180b:	68 e0 09 11 80       	push   $0x801109e0
80101810:	e8 eb 2d 00 00       	call   80104600 <acquire>
    int r = ip->ref;
80101815:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101818:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010181f:	e8 9c 2e 00 00       	call   801046c0 <release>
    if(r == 1){
...
80101a05:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a07:	e8 b4 2d 00 00       	call   801047c0 <memmove>
    brelse(bp);
...
80101b03:	e8 b8 2c 00 00       	call   801047c0 <memmove>
    log_write(bp);
...
80101bfd:	e8 2e 2c 00 00       	call   80104830 <strncmp>
      continue;
...
80101c89:	e8 72 29 00 00       	call   80104600 <acquire>
  ip->ref++;
80101c8e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c92:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101c99:	e8 22 2a 00 00       	call   801046c0 <release>
...
80101cf5:	e8 c6 2a 00 00       	call   801047c0 <memmove>
    path++;
...
80101d88:	e8 33 2a 00 00       	call   801047c0 <memmove>
    name[len] = 0;
...
80101e7d:	e8 0e 2a 00 00       	call   80104890 <strncpy>
  de.inum = inum;
...
80102010:	e8 ab 24 00 00       	call   801044c0 <initlock>
...
8010208e:	e8 6d 25 00 00       	call   80104600 <acquire>
...
8010210f:	e8 ac 25 00 00       	call   801046c0 <release>
...
8010212e:	e8 3d 23 00 00       	call   80104470 <holdingsleep>
...
80102168:	e8 93 24 00 00       	call   80104600 <acquire>
...
801021d5:	c9                   	leave  
  release(&idelock);
801021d6:	e9 e5 24 00 00       	jmp    801046c0 <release>
801021db:	90                   	nop
...
80102342:	e8 c9 23 00 00       	call   80104710 <memset>
...
8010237a:	c9                   	leave  
    release(&kmem.lock);
8010237b:	e9 40 23 00 00       	jmp    801046c0 <release>
    acquire(&kmem.lock);
80102380:	83 ec 0c             	sub    $0xc,%esp
80102383:	68 40 26 11 80       	push   $0x80112640
80102388:	e8 73 22 00 00       	call   80104600 <acquire>
...
80102405:	e8 b6 20 00 00       	call   801044c0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024f3:	e8 08 21 00 00       	call   80104600 <acquire>
  r = kmem.freelist;
...
80102521:	e8 9a 21 00 00       	call   801046c0 <release>
  return (char*)r;
...
80102937:	e8 24 1e 00 00       	call   80104760 <memcmp>
...
80102a64:	e8 57 1d 00 00       	call   801047c0 <memmove>
...
80102b14:	e8 a7 19 00 00       	call   801044c0 <initlock>
  readsb(dev, &sb);
80102b19:	58                   	pop    %eax
...
80102bab:	e8 50 1a 00 00       	call   80104600 <acquire>
...
80102bfc:	e8 bf 1a 00 00       	call   801046c0 <release>
      break;
    }
  }
}
...
80102c1e:	e8 dd 19 00 00       	call   80104600 <acquire>
  log.outstanding -= 1;
...
80102c5c:	e8 5f 1a 00 00       	call   801046c0 <release>
}
...
80102cb6:	e8 05 1b 00 00       	call   801047c0 <memmove>
...
80102cff:	e8 fc 18 00 00       	call   80104600 <acquire>
    wakeup(&log);
...
80102d21:	e8 9a 19 00 00       	call   801046c0 <release>
...
80102d4c:	e8 6f 19 00 00       	call   801046c0 <release>
...
80102dae:	e8 4d 18 00 00       	call   80104600 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dfc:	c9                   	leave  
  release(&log.lock);
80102dfd:	e9 be 18 00 00       	jmp    801046c0 <release>
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 a5 3c 00 00       	call   80106b30 <switchkvm>
  seginit();
80102e8b:	e8 10 3c 00 00       	call   80106aa0 <seginit>
  lapicinit();
...
80102ed0:	e8 cb 3b 00 00       	call   80106aa0 <seginit>
  picinit();       // disable pic
...
80102ee4:	e8 87 2e 00 00       	call   80105d70 <uartinit>
  pinit();         // process table
...
80102f14:	e8 a7 18 00 00       	call   801047c0 <memmove>
...
80102ff4:	e8 67 17 00 00       	call   80104760 <memcmp>
...
801030b2:	e8 a9 16 00 00       	call   80104760 <memcmp>
...
80103301:	e8 ba 11 00 00       	call   801044c0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010335f:	e8 9c 12 00 00       	call   80104600 <acquire>
  if(writable){
...
8010337f:	e8 ec 0d 00 00       	call   80104170 <wakeup>
...
801033a3:	5d                   	pop    %ebp
    release(&p->lock);
801033a4:	e9 17 13 00 00       	jmp    801046c0 <release>
...
801033c4:	e8 a7 0d 00 00       	call   80104170 <wakeup>
...
801033d4:	e8 e7 12 00 00       	call   801046c0 <release>
    kfree((char*)p);
...
801033fd:	e8 fe 11 00 00       	call   80104600 <acquire>
  for(i = 0; i < n; i++){
...
80103454:	e8 17 0d 00 00       	call   80104170 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103459:	5a                   	pop    %edx
8010345a:	59                   	pop    %ecx
...
80103494:	e8 27 12 00 00       	call   801046c0 <release>
        return -1;
...
801034e3:	e8 88 0c 00 00       	call   80104170 <wakeup>
  release(&p->lock);
801034e8:	89 1c 24             	mov    %ebx,(%esp)
801034eb:	e8 d0 11 00 00       	call   801046c0 <release>
  return n;
...
80103510:	e8 eb 10 00 00       	call   80104600 <acquire>
...
8010357e:	e8 3d 11 00 00       	call   801046c0 <release>
      return -1;
...
801035d7:	e8 94 0b 00 00       	call   80104170 <wakeup>
  release(&p->lock);
801035dc:	89 34 24             	mov    %esi,(%esp)
801035df:	e8 dc 10 00 00       	call   801046c0 <release>
  return i;
...
80103611:	e8 ea 0f 00 00       	call   80104600 <acquire>
...
801036ab:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
801036ae:	c7 40 14 9f 59 10 80 	movl   $0x8010599f,0x14(%eax)
  p->context = (struct context*)sp;
...
801036bd:	e8 4e 10 00 00       	call   80104710 <memset>
...
801036ea:	e8 d1 0f 00 00       	call   801046c0 <release>
}
...
8010371b:	e8 a0 0f 00 00       	call   801046c0 <release>
...
80103766:	68 75 77 10 80       	push   $0x80107775
8010376b:	68 20 2d 11 80       	push   $0x80112d20
80103770:	e8 4b 0d 00 00       	call   801044c0 <initlock>
}
...
80103824:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103827:	e8 04 0d 00 00       	call   80104530 <pushcli>
  c = mycpu();
8010382c:	e8 4f ff ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103831:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103837:	e8 34 0d 00 00       	call   80104570 <popcli>
}
...
80103863:	e8 18 37 00 00       	call   80106f80 <setupkvm>
...
80103881:	e8 da 33 00 00       	call   80106c60 <inituvm>
...
80103896:	e8 75 0e 00 00       	call   80104710 <memset>
...
801038ef:	68 a5 77 10 80       	push   $0x801077a5
801038f4:	50                   	push   %eax
801038f5:	e8 f6 0f 00 00       	call   801048f0 <safestrcpy>
  p->cwd = namei("/");
801038fa:	c7 04 24 ae 77 10 80 	movl   $0x801077ae,(%esp)
...
80103933:	68 8c 77 10 80       	push   $0x8010778c
...
80103945:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103948:	e8 e3 0b 00 00       	call   80104530 <pushcli>
  c = mycpu();
8010394d:	e8 2e fe ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103952:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103958:	e8 13 0c 00 00       	call   80104570 <popcli>
  if(n > 0){
...
8010396c:	e8 df 31 00 00       	call   80106b50 <switchuvm>
  return 0;
...
8010398a:	e8 11 34 00 00       	call   80106da0 <allocuvm>
...
801039aa:	e8 21 35 00 00       	call   80106ed0 <deallocuvm>
...
801039c6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801039c9:	e8 62 0b 00 00       	call   80104530 <pushcli>
  c = mycpu();
801039ce:	e8 ad fd ff ff       	call   80103780 <mycpu>
  p = c->proc;
801039d3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039d9:	e8 92 0b 00 00       	call   80104570 <popcli>
  if((np = allocproc()) == 0){
...
801039f8:	e8 53 36 00 00       	call   80107050 <copyuvm>
...
80103a71:	e8 7a 0e 00 00       	call   801048f0 <safestrcpy>
  pid = np->pid;
80103a76:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a79:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a80:	e8 7b 0b 00 00       	call   80104600 <acquire>
  np->state = RUNNABLE;
...
80103aef:	e8 0c 0b 00 00       	call   80104600 <acquire>
...
80103b2a:	e8 91 0b 00 00       	call   801046c0 <release>
}
...
80103b7b:	e8 80 0a 00 00       	call   80104600 <acquire>
80103b80:	83 c4 10             	add    $0x10,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b83:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103b88:	eb 21                	jmp    80103bab <scheduler+0x5b>
80103b8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      else if(p -> priority < proc_with_highest_priority -> priority)
80103b90:	8b 97 8c 00 00 00    	mov    0x8c(%edi),%edx
80103b96:	39 90 8c 00 00 00    	cmp    %edx,0x8c(%eax)
80103b9c:	0f 4c f8             	cmovl  %eax,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b9f:	05 90 00 00 00       	add    $0x90,%eax
80103ba4:	3d 54 51 11 80       	cmp    $0x80115154,%eax
80103ba9:	73 1d                	jae    80103bc8 <scheduler+0x78>
      if(p->state != RUNNABLE)
80103bab:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103baf:	75 ee                	jne    80103b9f <scheduler+0x4f>
      if(proc_with_highest_priority == 0)
80103bb1:	85 ff                	test   %edi,%edi
80103bb3:	75 db                	jne    80103b90 <scheduler+0x40>
80103bb5:	89 c7                	mov    %eax,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bb7:	05 90 00 00 00       	add    $0x90,%eax
80103bbc:	3d 54 51 11 80       	cmp    $0x80115154,%eax
80103bc1:	72 e8                	jb     80103bab <scheduler+0x5b>
80103bc3:	90                   	nop
80103bc4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(proc_with_highest_priority != 0)
80103bc8:	85 ff                	test   %edi,%edi
80103bca:	74 46                	je     80103c12 <scheduler+0xc2>
      cprintf("Core = %d, pid = %d\n", c -> apicid, proc_with_highest_priority -> pid);
80103bcc:	83 ec 04             	sub    $0x4,%esp
80103bcf:	ff 77 10             	pushl  0x10(%edi)
80103bd2:	0f b6 03             	movzbl (%ebx),%eax
80103bd5:	50                   	push   %eax
80103bd6:	68 b0 77 10 80       	push   $0x801077b0
80103bdb:	e8 80 ca ff ff       	call   80100660 <cprintf>
      c->proc = proc_with_highest_priority;
80103be0:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(proc_with_highest_priority);
80103be6:	89 3c 24             	mov    %edi,(%esp)
80103be9:	e8 62 2f 00 00       	call   80106b50 <switchuvm>
...
80103bfb:	e8 4b 0d 00 00       	call   8010494b <swtch>
      switchkvm();
80103c00:	e8 2b 2f 00 00       	call   80106b30 <switchkvm>
      c->proc = 0;
80103c05:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103c0c:	00 00 00 
80103c0f:	83 c4 10             	add    $0x10,%esp
    release(&ptable.lock);
80103c12:	83 ec 0c             	sub    $0xc,%esp
80103c15:	68 20 2d 11 80       	push   $0x80112d20
80103c1a:	e8 a1 0a 00 00       	call   801046c0 <release>
  for(;;){
80103c1f:	83 c4 10             	add    $0x10,%esp
80103c22:	e9 49 ff ff ff       	jmp    80103b70 <scheduler+0x20>
...
80103c34:	53                   	push   %ebx
  pushcli();
80103c35:	e8 f6 08 00 00       	call   80104530 <pushcli>
  c = mycpu();
80103c3a:	e8 41 fb ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103c3f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c45:	e8 26 09 00 00       	call   80104570 <popcli>
  if(!holding(&ptable.lock))
80103c4a:	83 ec 0c             	sub    $0xc,%esp
80103c4d:	68 20 2d 11 80       	push   $0x80112d20
80103c52:	e8 79 09 00 00       	call   801045d0 <holding>
80103c57:	83 c4 10             	add    $0x10,%esp
80103c5a:	85 c0                	test   %eax,%eax
80103c5c:	74 4f                	je     80103cad <sched+0x7d>
  if(mycpu()->ncli != 1)
80103c5e:	e8 1d fb ff ff       	call   80103780 <mycpu>
...
80103c77:	75 41                	jne    80103cba <sched+0x8a>
  intena = mycpu()->intena;
80103c79:	e8 02 fb ff ff       	call   80103780 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103c7e:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103c81:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103c87:	e8 f4 fa ff ff       	call   80103780 <mycpu>
80103c8c:	83 ec 08             	sub    $0x8,%esp
80103c8f:	ff 70 04             	pushl  0x4(%eax)
80103c92:	53                   	push   %ebx
80103c93:	e8 b3 0c 00 00       	call   8010494b <swtch>
  mycpu()->intena = intena;
80103c98:	e8 e3 fa ff ff       	call   80103780 <mycpu>
}
...
80103cf6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103cf9:	e8 32 08 00 00       	call   80104530 <pushcli>
  c = mycpu();
80103cfe:	e8 7d fa ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103d03:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103d09:	e8 62 08 00 00       	call   80104570 <popcli>
  if(curproc == initproc)
80103d0e:	39 35 b8 a5 10 80    	cmp    %esi,0x8010a5b8
80103d14:	8d 5e 28             	lea    0x28(%esi),%ebx
80103d17:	8d 7e 68             	lea    0x68(%esi),%edi
80103d1a:	0f 84 fc 00 00 00    	je     80103e1c <exit+0x12c>
    if(curproc->ofile[fd]){
...
80103d62:	e8 99 08 00 00       	call   80104600 <acquire>
...
80103d9b:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
80103dd8:	05 90 00 00 00       	add    $0x90,%eax
80103ddd:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
80103df8:	a1 a0 59 11 80       	mov    0x801159a0,%eax
  curproc->state = ZOMBIE;
80103dfd:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  curproc -> end_time = ticks;  // Assignment
80103e04:	89 86 80 00 00 00    	mov    %eax,0x80(%esi)
  sched();
80103e0a:	e8 21 fe ff ff       	call   80103c30 <sched>
  panic("zombie exit");
80103e0f:	83 ec 0c             	sub    $0xc,%esp
80103e12:	68 12 78 10 80       	push   $0x80107812
80103e17:	e8 74 c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103e1c:	83 ec 0c             	sub    $0xc,%esp
80103e1f:	68 05 78 10 80       	push   $0x80107805
80103e24:	e8 67 c5 ff ff       	call   80100390 <panic>
...
80103e3c:	e8 bf 07 00 00       	call   80104600 <acquire>
  pushcli();
80103e41:	e8 ea 06 00 00       	call   80104530 <pushcli>
  c = mycpu();
80103e46:	e8 35 f9 ff ff       	call   80103780 <mycpu>
  p = c->proc;
...
80103e69:	e8 52 08 00 00       	call   801046c0 <release>
}
...
80103e8c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103e8f:	e8 9c 06 00 00       	call   80104530 <pushcli>
  c = mycpu();
...
80103ec0:	e8 3b 07 00 00       	call   80104600 <acquire>
    release(lk);
80103ec5:	89 34 24             	mov    %esi,(%esp)
80103ec8:	e8 f3 07 00 00       	call   801046c0 <release>
  p->chan = chan;
...
80103eea:	e8 d1 07 00 00       	call   801046c0 <release>
    acquire(lk);
...
80103efb:	5d                   	pop    %ebp
    acquire(lk);
80103efc:	e9 ff 06 00 00       	jmp    80104600 <acquire>
...
80103f29:	68 24 78 10 80       	push   $0x80107824
80103f2e:	e8 5d c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103f33:	83 ec 0c             	sub    $0xc,%esp
80103f36:	68 1e 78 10 80       	push   $0x8010781e
...
80103f44:	53                   	push   %ebx
  pushcli();
80103f45:	e8 e6 05 00 00       	call   80104530 <pushcli>
  c = mycpu();
...
80103f62:	e8 99 06 00 00       	call   80104600 <acquire>
...
80103f78:	81 c3 90 00 00 00    	add    $0x90,%ebx
80103f7e:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
...
80103f8f:	74 37                	je     80103fc8 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f91:	81 c3 90 00 00 00    	add    $0x90,%ebx
      havekids = 1;
80103f97:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f9c:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
...
80103fda:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103fe1:	e8 1a 2f 00 00       	call   80106f00 <freevm>
        release(&ptable.lock);
...
80104006:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010400d:	e8 ae 06 00 00       	call   801046c0 <release>
        return pid;
...
8010402b:	e8 90 06 00 00       	call   801046c0 <release>
      return -1;
...
8010407e:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
...
80104097:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010409c:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
801040a2:	72 e2                	jb     80104086 <waitx+0x46>
    if(!havekids || curproc->killed){
801040a4:	85 c0                	test   %eax,%eax
801040a6:	0f 84 9f 00 00 00    	je     8010414b <waitx+0x10b>
801040ac:	8b 46 24             	mov    0x24(%esi),%eax
801040af:	85 c0                	test   %eax,%eax
801040b1:	0f 85 94 00 00 00    	jne    8010414b <waitx+0x10b>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
...
801040e2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040e9:	e8 12 2e 00 00       	call   80106f00 <freevm>
...
8010414b:	83 ec 0c             	sub    $0xc,%esp
      return -1;
8010414e:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104153:	68 20 2d 11 80       	push   $0x80112d20
80104158:	e8 63 05 00 00       	call   801046c0 <release>
      return -1;
8010415d:	83 c4 10             	add    $0x10,%esp
80104160:	eb e0                	jmp    80104142 <waitx+0x102>
...
8010417f:	e8 7c 04 00 00       	call   80104600 <acquire>
...
801041a7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041ae:	05 90 00 00 00       	add    $0x90,%eax
801041b3:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
801041c4:	c9                   	leave  
  release(&ptable.lock);
801041c5:	e9 f6 04 00 00       	jmp    801046c0 <release>
...
801041df:	e8 1c 04 00 00       	call   80104600 <acquire>
801041e4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801041e7:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801041ec:	eb 0e                	jmp    801041fc <kill+0x2c>
801041ee:	66 90                	xchg   %ax,%ax
801041f0:	05 90 00 00 00       	add    $0x90,%eax
801041f5:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
8010421d:	e8 9e 04 00 00       	call   801046c0 <release>
      return 0;
...
80104238:	e8 83 04 00 00       	call   801046c0 <release>
  return -1;
...
80104256:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104259:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
{
...
8010426b:	68 bf 7b 10 80       	push   $0x80107bbf
80104270:	e8 eb c3 ff ff       	call   80100660 <cprintf>
80104275:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104278:	81 c3 90 00 00 00    	add    $0x90,%ebx
8010427e:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
...
80104291:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104294:	ba 35 78 10 80       	mov    $0x80107835,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104299:	77 11                	ja     801042ac <procdump+0x5c>
8010429b:	8b 14 85 94 78 10 80 	mov    -0x7fef876c(,%eax,4),%edx
      state = "???";
801042a2:	b8 35 78 10 80       	mov    $0x80107835,%eax
...
801042b4:	68 39 78 10 80       	push   $0x80107839
...
801042db:	e8 00 02 00 00       	call   801044e0 <getcallerpcs>
...
801042f9:	68 61 72 10 80       	push   $0x80107261
...
8010432b:	e8 d0 02 00 00       	call   80104600 <acquire>
80104330:	83 c4 10             	add    $0x10,%esp
  struct proc* p;
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104333:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80104338:	eb 1e                	jmp    80104358 <modify_times+0x38>
...
80104343:	75 07                	jne    8010434c <modify_times+0x2c>
      {
          p -> sleep_time++;
80104345:	83 80 88 00 00 00 01 	addl   $0x1,0x88(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010434c:	05 90 00 00 00       	add    $0x90,%eax
80104351:	3d 54 51 11 80       	cmp    $0x80115154,%eax
80104356:	73 1b                	jae    80104373 <modify_times+0x53>
      if(p -> state == RUNNING)
80104358:	8b 50 0c             	mov    0xc(%eax),%edx
8010435b:	83 fa 04             	cmp    $0x4,%edx
8010435e:	75 e0                	jne    80104340 <modify_times+0x20>
          p -> run_time++;
80104360:	83 80 84 00 00 00 01 	addl   $0x1,0x84(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104367:	05 90 00 00 00       	add    $0x90,%eax
8010436c:	3d 54 51 11 80       	cmp    $0x80115154,%eax
80104371:	72 e5                	jb     80104358 <modify_times+0x38>
      }
    // } 
  } 
  release(&ptable.lock);
...
8010437b:	e8 40 03 00 00       	call   801046c0 <release>
...
8010439a:	68 ac 78 10 80       	push   $0x801078ac
...
801043df:	e8 1c 02 00 00       	call   80104600 <acquire>
  while (lk->locked) {
...
801043f5:	e8 86 fa ff ff       	call   80103e80 <sleep>
  while (lk->locked) {
...
80104403:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104409:	e8 12 f4 ff ff       	call   80103820 <myproc>
...
80104454:	e8 17 fd ff ff       	call   80104170 <wakeup>
  release(&lk->lk);
...
80104482:	e8 79 01 00 00       	call   80104600 <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80104487:	8b 03                	mov    (%ebx),%eax
80104489:	83 c4 10             	add    $0x10,%esp
8010448c:	85 c0                	test   %eax,%eax
8010448e:	74 13                	je     801044a3 <holdingsleep+0x33>
80104490:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80104493:	e8 88 f3 ff ff       	call   80103820 <myproc>
...
801044a7:	e8 14 02 00 00       	call   801046c0 <release>
  return r;
}
801044ac:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
8010454f:	e8 2c f2 ff ff       	call   80103780 <mycpu>
...
8010459c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801045a0:	e8 db f1 ff ff       	call   80103780 <mycpu>
...
801045b5:	68 b7 78 10 80       	push   $0x801078b7
801045ba:	e8 d1 bd ff ff       	call   80100390 <panic>
    panic("popcli");
801045bf:	83 ec 0c             	sub    $0xc,%esp
801045c2:	68 ce 78 10 80       	push   $0x801078ce
...
801045d8:	31 db                	xor    %ebx,%ebx
  pushcli();
801045da:	e8 51 ff ff ff       	call   80104530 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
801045df:	8b 06                	mov    (%esi),%eax
801045e1:	85 c0                	test   %eax,%eax
801045e3:	74 10                	je     801045f5 <holding+0x25>
801045e5:	8b 5e 08             	mov    0x8(%esi),%ebx
801045e8:	e8 93 f1 ff ff       	call   80103780 <mycpu>
801045ed:	39 c3                	cmp    %eax,%ebx
801045ef:	0f 94 c3             	sete   %bl
801045f2:	0f b6 db             	movzbl %bl,%ebx
  popcli();
801045f5:	e8 76 ff ff ff       	call   80104570 <popcli>
}
...
80104605:	e8 26 ff ff ff       	call   80104530 <pushcli>
  if(holding(lk))
8010460a:	8b 5d 08             	mov    0x8(%ebp),%ebx
8010460d:	83 ec 0c             	sub    $0xc,%esp
80104610:	53                   	push   %ebx
80104611:	e8 ba ff ff ff       	call   801045d0 <holding>
80104616:	83 c4 10             	add    $0x10,%esp
80104619:	85 c0                	test   %eax,%eax
8010461b:	0f 85 83 00 00 00    	jne    801046a4 <acquire+0xa4>
80104621:	89 c6                	mov    %eax,%esi
  asm volatile("lock; xchgl %0, %1" :
80104623:	ba 01 00 00 00       	mov    $0x1,%edx
80104628:	eb 09                	jmp    80104633 <acquire+0x33>
...
80104644:	e8 37 f1 ff ff       	call   80103780 <mycpu>
  getcallerpcs(&lk, lk->pcs);
80104649:	8d 53 0c             	lea    0xc(%ebx),%edx
  lk->cpu = mycpu();
8010464c:	89 43 08             	mov    %eax,0x8(%ebx)
  ebp = (uint*)v - 2;
8010464f:	89 e8                	mov    %ebp,%eax
80104651:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104658:	8d 88 00 00 00 80    	lea    -0x80000000(%eax),%ecx
8010465e:	81 f9 fe ff ff 7f    	cmp    $0x7ffffffe,%ecx
80104664:	77 1a                	ja     80104680 <acquire+0x80>
    pcs[i] = ebp[1];     // saved %eip
80104666:	8b 48 04             	mov    0x4(%eax),%ecx
80104669:	89 0c b2             	mov    %ecx,(%edx,%esi,4)
  for(i = 0; i < 10; i++){
8010466c:	83 c6 01             	add    $0x1,%esi
    ebp = (uint*)ebp[0]; // saved %ebp
8010466f:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80104671:	83 fe 0a             	cmp    $0xa,%esi
80104674:	75 e2                	jne    80104658 <acquire+0x58>
}
...
80104680:	8d 04 b2             	lea    (%edx,%esi,4),%eax
80104683:	83 c2 28             	add    $0x28,%edx
...
801046a7:	68 d5 78 10 80       	push   $0x801078d5
801046ac:	e8 df bc ff ff       	call   80100390 <panic>
801046b1:	eb 0d                	jmp    801046c0 <release>
801046b3:	90                   	nop
801046b4:	90                   	nop
801046b5:	90                   	nop
801046b6:	90                   	nop
...
801046cb:	e8 00 ff ff ff       	call   801045d0 <holding>
801046d0:	83 c4 10             	add    $0x10,%esp
801046d3:	85 c0                	test   %eax,%eax
801046d5:	74 22                	je     801046f9 <release+0x39>
  lk->pcs[0] = 0;
801046d7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
801046de:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
801046e5:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
801046ea:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
801046f0:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801046f3:	c9                   	leave  
  popcli();
801046f4:	e9 77 fe ff ff       	jmp    80104570 <popcli>
    panic("release");
801046f9:	83 ec 0c             	sub    $0xc,%esp
801046fc:	68 dd 78 10 80       	push   $0x801078dd
...
80104718:	8b 4d 10             	mov    0x10(%ebp),%ecx
  if ((int)dst%4 == 0 && n%4 == 0){
8010471b:	f6 c2 03             	test   $0x3,%dl
8010471e:	75 05                	jne    80104725 <memset+0x15>
80104720:	f6 c1 03             	test   $0x3,%cl
80104723:	74 13                	je     80104738 <memset+0x28>
  asm volatile("cld; rep stosb" :
80104725:	89 d7                	mov    %edx,%edi
80104727:	8b 45 0c             	mov    0xc(%ebp),%eax
8010472a:	fc                   	cld    
8010472b:	f3 aa                	rep stos %al,%es:(%edi)
    c &= 0xFF;
...
80104734:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    c &= 0xFF;
80104738:	0f b6 7d 0c          	movzbl 0xc(%ebp),%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010473c:	c1 e9 02             	shr    $0x2,%ecx
8010473f:	89 f8                	mov    %edi,%eax
80104741:	89 fb                	mov    %edi,%ebx
80104743:	c1 e0 18             	shl    $0x18,%eax
...
80104766:	8b 5d 10             	mov    0x10(%ebp),%ebx
80104769:	8b 75 08             	mov    0x8(%ebp),%esi
8010476c:	8b 7d 0c             	mov    0xc(%ebp),%edi
  const uchar *s1, *s2;

  s1 = v1;
  s2 = v2;
  while(n-- > 0){
8010476f:	85 db                	test   %ebx,%ebx
80104771:	74 29                	je     8010479c <memcmp+0x3c>
    if(*s1 != *s2)
80104773:	0f b6 16             	movzbl (%esi),%edx
80104776:	0f b6 0f             	movzbl (%edi),%ecx
80104779:	38 d1                	cmp    %dl,%cl
8010477b:	75 2b                	jne    801047a8 <memcmp+0x48>
8010477d:	b8 01 00 00 00       	mov    $0x1,%eax
80104782:	eb 14                	jmp    80104798 <memcmp+0x38>
80104784:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104788:	0f b6 14 06          	movzbl (%esi,%eax,1),%edx
8010478c:	83 c0 01             	add    $0x1,%eax
8010478f:	0f b6 4c 07 ff       	movzbl -0x1(%edi,%eax,1),%ecx
80104794:	38 ca                	cmp    %cl,%dl
80104796:	75 10                	jne    801047a8 <memcmp+0x48>
  while(n-- > 0){
80104798:	39 d8                	cmp    %ebx,%eax
8010479a:	75 ec                	jne    80104788 <memcmp+0x28>
      return *s1 - *s2;
    s1++, s2++;
  }
...
801047cb:	8b 75 10             	mov    0x10(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801047ce:	39 c3                	cmp    %eax,%ebx
801047d0:	73 26                	jae    801047f8 <memmove+0x38>
801047d2:	8d 0c 33             	lea    (%ebx,%esi,1),%ecx
801047d5:	39 c8                	cmp    %ecx,%eax
801047d7:	73 1f                	jae    801047f8 <memmove+0x38>
    s += n;
    d += n;
    while(n-- > 0)
801047d9:	85 f6                	test   %esi,%esi
801047db:	8d 56 ff             	lea    -0x1(%esi),%edx
...
801047f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    while(n-- > 0)
801047f8:	31 d2                	xor    %edx,%edx
801047fa:	85 f6                	test   %esi,%esi
801047fc:	74 f1                	je     801047ef <memmove+0x2f>
...
80104807:	83 c2 01             	add    $0x1,%edx
    while(n-- > 0)
8010480a:	39 d6                	cmp    %edx,%esi
8010480c:	75 f2                	jne    80104800 <memmove+0x40>
}
8010480e:	5b                   	pop    %ebx
8010480f:	5e                   	pop    %esi
80104810:	5d                   	pop    %ebp
...
80104835:	8b 7d 10             	mov    0x10(%ebp),%edi
...
80104843:	0f b6 01             	movzbl (%ecx),%eax
80104846:	0f b6 1e             	movzbl (%esi),%ebx
80104849:	84 c0                	test   %al,%al
8010484b:	74 37                	je     80104884 <strncmp+0x54>
8010484d:	38 c3                	cmp    %al,%bl
...
80104858:	0f b6 01             	movzbl (%ecx),%eax
8010485b:	84 c0                	test   %al,%al
8010485d:	74 21                	je     80104880 <strncmp+0x50>
8010485f:	0f b6 1a             	movzbl (%edx),%ebx
80104862:	89 d6                	mov    %edx,%esi
80104864:	38 d8                	cmp    %bl,%al
80104866:	75 1c                	jne    80104884 <strncmp+0x54>
    n--, p++, q++;
80104868:	8d 56 01             	lea    0x1(%esi),%edx
8010486b:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
8010486e:	39 fa                	cmp    %edi,%edx
...
80104967:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010496a:	e8 b1 ee ff ff       	call   80103820 <myproc>
...
801049a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801049aa:	e8 71 ee ff ff       	call   80103820 <myproc>
...
801049c5:	eb 39                	jmp    80104a00 <fetchstr+0x60>
...
80104a00:	31 c0                	xor    %eax,%eax
      return s - *pp;
80104a02:	eb dd                	jmp    801049e1 <fetchstr+0x41>
...
80104a15:	e8 06 ee ff ff       	call   80103820 <myproc>
80104a1a:	8b 40 18             	mov    0x18(%eax),%eax
80104a1d:	8b 55 08             	mov    0x8(%ebp),%edx
80104a20:	8b 40 44             	mov    0x44(%eax),%eax
80104a23:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a26:	e8 f5 ed ff ff       	call   80103820 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
80104a2b:	8b 00                	mov    (%eax),%eax
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a2d:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104a68:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104a6b:	e8 b0 ed ff ff       	call   80103820 <myproc>
...
80104a8c:	8b 16                	mov    (%esi),%edx
80104a8e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a91:	39 c2                	cmp    %eax,%edx
80104a93:	76 1b                	jbe    80104ab0 <argptr+0x50>
80104a95:	01 c3                	add    %eax,%ebx
80104a97:	39 da                	cmp    %ebx,%edx
80104a99:	72 15                	jb     80104ab0 <argptr+0x50>
    return -1;
  *pp = (char*)i;
80104a9b:	8b 55 0c             	mov    0xc(%ebp),%edx
80104a9e:	89 02                	mov    %eax,(%edx)
  return 0;
...
80104ab5:	eb eb                	jmp    80104aa2 <argptr+0x42>
...
80104ae2:	e8 b9 fe ff ff       	call   801049a0 <fetchstr>
...
80104b04:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b07:	e8 14 ed ff ff       	call   80103820 <myproc>
...
80104b1a:	77 1c                	ja     80104b38 <syscall+0x38>
80104b1c:	8b 14 85 20 79 10 80 	mov    -0x7fef86e0(,%eax,4),%edx
80104b23:	85 d2                	test   %edx,%edx
80104b25:	74 11                	je     80104b38 <syscall+0x38>
    curproc->tf->eax = syscalls[num]();
80104b27:	ff d2                	call   *%edx
80104b29:	8b 53 18             	mov    0x18(%ebx),%edx
80104b2c:	89 42 1c             	mov    %eax,0x1c(%edx)
  } else {
...
80104b38:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104b39:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104b3c:	50                   	push   %eax
80104b3d:	ff 73 10             	pushl  0x10(%ebx)
80104b40:	68 e5 78 10 80       	push   $0x801078e5
80104b45:	e8 16 bb ff ff       	call   80100660 <cprintf>
    curproc->tf->eax = -1;
80104b4a:	8b 43 18             	mov    0x18(%ebx),%eax
80104b4d:	83 c4 10             	add    $0x10,%esp
80104b50:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
80104b77:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104b7a:	e8 81 d3 ff ff       	call   80101f00 <nameiparent>
...
80104b9c:	e8 0f d0 ff ff       	call   80101bb0 <dirlookup>
...
80104bae:	e8 5d cd ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80104bb3:	89 3c 24             	mov    %edi,(%esp)
80104bb6:	e8 c5 ca ff ff       	call   80101680 <ilock>
...
80104bea:	e8 21 c9 ff ff       	call   80101510 <ialloc>
...
80104c21:	e8 aa c9 ff ff       	call   801015d0 <iupdate>
...
80104c38:	e8 e3 d1 ff ff       	call   80101e20 <dirlink>
...
80104c4c:	e8 bf cc ff ff       	call   80101910 <iunlockput>
  return ip;
...
80104c64:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104c66:	e8 a5 cc ff ff       	call   80101910 <iunlockput>
    return 0;
...
80104c89:	e8 42 c9 ff ff       	call   801015d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104c8e:	83 c4 0c             	add    $0xc,%esp
80104c91:	ff 77 04             	pushl  0x4(%edi)
80104c94:	68 9c 79 10 80       	push   $0x8010799c
80104c99:	57                   	push   %edi
80104c9a:	e8 81 d1 ff ff       	call   80101e20 <dirlink>
...
80104cac:	68 9b 79 10 80       	push   $0x8010799b
80104cb1:	57                   	push   %edi
80104cb2:	e8 69 d1 ff ff       	call   80101e20 <dirlink>
...
80104cc5:	68 8f 79 10 80       	push   $0x8010798f
...
80104cda:	68 9e 79 10 80       	push   $0x8010799e
80104cdf:	e8 ac b6 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104ce4:	83 ec 0c             	sub    $0xc,%esp
80104ce7:	68 80 79 10 80       	push   $0x80107980
...
80104d12:	e8 f9 fc ff ff       	call   80104a10 <argint>
...
80104d24:	e8 f7 ea ff ff       	call   80103820 <myproc>
...
80104d69:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104d6b:	e8 b0 ea ff ff       	call   80103820 <myproc>
...
80104d92:	e8 59 c0 ff ff       	call   80100df0 <filedup>
  return fd;
...
80104ddd:	e8 2e fc ff ff       	call   80104a10 <argint>
...
80104df5:	e8 66 fc ff ff       	call   80104a60 <argptr>
...
80104e0d:	e8 4e c1 ff ff       	call   80100f60 <fileread>
...
80104e4d:	e8 be fb ff ff       	call   80104a10 <argint>
...
80104e65:	e8 f6 fb ff ff       	call   80104a60 <argptr>
...
80104e7d:	e8 6e c1 ff ff       	call   80100ff0 <filewrite>
...
80104eb3:	78 2b                	js     80104ee0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104eb5:	e8 66 e9 ff ff       	call   80103820 <myproc>
...
80104f0f:	e8 4c fb ff ff       	call   80104a60 <argptr>
...
80104f24:	e8 e7 bf ff ff       	call   80100f10 <filestat>
...
80104f4f:	e8 6c fb ff ff       	call   80104ac0 <argstr>
...
80104f99:	e8 e2 c6 ff ff       	call   80101680 <ilock>
  if(ip->type == T_DIR){
...
80104fb8:	e8 13 c6 ff ff       	call   801015d0 <iupdate>
  iunlock(ip);
80104fbd:	89 1c 24             	mov    %ebx,(%esp)
80104fc0:	e8 9b c7 ff ff       	call   80101760 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104fc5:	58                   	pop    %eax
80104fc6:	5a                   	pop    %edx
80104fc7:	57                   	push   %edi
80104fc8:	ff 75 d0             	pushl  -0x30(%ebp)
80104fcb:	e8 30 cf ff ff       	call   80101f00 <nameiparent>
...
80104fdd:	e8 9e c6 ff ff       	call   80101680 <ilock>
...
80104ff3:	e8 28 ce ff ff       	call   80101e20 <dirlink>
...
80105003:	e8 08 c9 ff ff       	call   80101910 <iunlockput>
  iput(ip);
80105008:	89 1c 24             	mov    %ebx,(%esp)
8010500b:	e8 a0 c7 ff ff       	call   801017b0 <iput>
  end_op();
...
8010502c:	e8 df c8 ff ff       	call   80101910 <iunlockput>
    goto bad;
80105031:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80105034:	83 ec 0c             	sub    $0xc,%esp
80105037:	53                   	push   %ebx
80105038:	e8 43 c6 ff ff       	call   80101680 <ilock>
  ip->nlink--;
8010503d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105042:	89 1c 24             	mov    %ebx,(%esp)
80105045:	e8 86 c5 ff ff       	call   801015d0 <iupdate>
  iunlockput(ip);
8010504a:	89 1c 24             	mov    %ebx,(%esp)
8010504d:	e8 be c8 ff ff       	call   80101910 <iunlockput>
  end_op();
80105052:	e8 b9 db ff ff       	call   80102c10 <end_op>
  return -1;
...
8010506b:	e8 a0 c8 ff ff       	call   80101910 <iunlockput>
    end_op();
80105070:	e8 9b db ff ff       	call   80102c10 <end_op>
    return -1;
...
8010509f:	e8 1c fa ff ff       	call   80104ac0 <argstr>
...
801050af:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
801050b2:	e8 e9 da ff ff       	call   80102ba0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801050b7:	83 ec 08             	sub    $0x8,%esp
801050ba:	53                   	push   %ebx
801050bb:	ff 75 c0             	pushl  -0x40(%ebp)
801050be:	e8 3d ce ff ff       	call   80101f00 <nameiparent>
...
801050d4:	e8 a7 c5 ff ff       	call   80101680 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801050d9:	58                   	pop    %eax
801050da:	5a                   	pop    %edx
801050db:	68 9c 79 10 80       	push   $0x8010799c
801050e0:	53                   	push   %ebx
801050e1:	e8 aa ca ff ff       	call   80101b90 <namecmp>
...
801050f4:	68 9b 79 10 80       	push   $0x8010799b
801050f9:	53                   	push   %ebx
801050fa:	e8 91 ca ff ff       	call   80101b90 <namecmp>
...
80105113:	e8 98 ca ff ff       	call   80101bb0 <dirlookup>
...
80105129:	e8 52 c5 ff ff       	call   80101680 <ilock>
  if(ip->nlink < 1)
...
8010514e:	e8 bd f5 ff ff       	call   80104710 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010515d:	e8 fe c8 ff ff       	call   80101a60 <writei>
...
8010518a:	e8 41 c4 ff ff       	call   801015d0 <iupdate>
  iunlockput(ip);
8010518f:	89 1c 24             	mov    %ebx,(%esp)
80105192:	e8 79 c7 ff ff       	call   80101910 <iunlockput>
  end_op();
80105197:	e8 74 da ff ff       	call   80102c10 <end_op>
  return 0;
...
801051d4:	e8 87 c7 ff ff       	call   80101960 <readi>
...
801051ec:	e8 1f c7 ff ff       	call   80101910 <iunlockput>
    goto bad;
801051f1:	83 c4 10             	add    $0x10,%esp
  iunlockput(dp);
801051f4:	83 ec 0c             	sub    $0xc,%esp
801051f7:	56                   	push   %esi
801051f8:	e8 13 c7 ff ff       	call   80101910 <iunlockput>
  end_op();
801051fd:	e8 0e da ff ff       	call   80102c10 <end_op>
  return -1;
...
80105219:	e8 b2 c3 ff ff       	call   801015d0 <iupdate>
...
8010527f:	e8 3c f8 ff ff       	call   80104ac0 <argstr>
...
80105298:	e8 73 f7 ff ff       	call   80104a10 <argint>
...
801052a2:	0f 88 04 01 00 00    	js     801053ac <sys_open+0x13c>
  ...
  begin_op();
801052a8:	e8 f3 d8 ff ff       	call   80102ba0 <begin_op>
...
801052ef:	0f 84 a6 00 00 00    	je     8010539b <sys_open+0x12b>
  struct proc *curproc = myproc();
801052f5:	e8 26 e5 ff ff       	call   80103820 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010531c:	e8 3f c4 ff ff       	call   80101760 <iunlock>
  end_op();
...
8010537b:	0f 85 65 ff ff ff    	jne    801052e6 <sys_open+0x76>
      end_op();
80105381:	e8 8a d8 ff ff       	call   80102c10 <end_op>
      return -1;
...
801053bc:	e8 7f ba ff ff       	call   80100e40 <fileclose>
...
80105433:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105436:	e8 65 d7 ff ff       	call   80102ba0 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
80105459:	e8 b2 f5 ff ff       	call   80104a10 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010546e:	e8 9d f5 ff ff       	call   80104a10 <argint>
     argint(1, &major) < 0 ||
...
8010549e:	e8 6d c4 ff ff       	call   80101910 <iunlockput>
  end_op();
801054a3:	e8 68 d7 ff ff       	call   80102c10 <end_op>
  return 0;
...
801054cd:	89 c6                	mov    %eax,%esi
  ...
  begin_op();
801054cf:	e8 cc d6 ff ff       	call   80102ba0 <begin_op>
...
8010551d:	e8 8e c2 ff ff       	call   801017b0 <iput>
  end_op();
...
80105544:	e8 c7 c3 ff ff       	call   80101910 <iunlockput>
    end_op();
80105549:	e8 c2 d6 ff ff       	call   80102c10 <end_op>
    return -1;
...
801055a1:	e8 6a f4 ff ff       	call   80104a10 <argint>
...
801055c6:	e8 45 f1 ff ff       	call   80104710 <memset>
...
801055e8:	e8 b3 f3 ff ff       	call   801049a0 <fetchstr>
...
80105610:	e8 4b f3 ff ff       	call   80104960 <fetchint>
...
8010564b:	e8 c0 b3 ff ff       	call   80100a10 <exec>
...
80105671:	e8 ea f3 ff ff       	call   80104a60 <argptr>
...
8010568c:	e8 af db ff ff       	call   80103240 <pipealloc>
...
8010569f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801056a1:	e8 7a e1 ff ff       	call   80103820 <myproc>
...
801056c7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801056ca:	e8 51 e1 ff ff       	call   80103820 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105701:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105708:	e8 13 e1 ff ff       	call   80103820 <myproc>
...
8010571e:	e8 1d b7 ff ff       	call   80100e40 <fileclose>
    fileclose(wf);
80105723:	58                   	pop    %eax
80105724:	ff 75 e4             	pushl  -0x1c(%ebp)
80105727:	e8 14 b7 ff ff       	call   80100e40 <fileclose>
    return -1;
...
80105743:	5d                   	pop    %ebp
  return fork();
80105744:	e9 77 e2 ff ff       	jmp    801039c0 <fork>
...
80105753:	83 ec 08             	sub    $0x8,%esp
  exit();
80105756:	e8 95 e5 ff ff       	call   80103cf0 <exit>
...
80105763:	5d                   	pop    %ebp
  return wait();
80105764:	e9 d7 e7 ff ff       	jmp    80103f40 <wait>
...
8010577e:	e8 dd f2 ff ff       	call   80104a60 <argptr>
80105783:	83 c4 10             	add    $0x10,%esp
80105786:	85 c0                	test   %eax,%eax
80105788:	78 2e                	js     801057b8 <sys_waitx+0x48>
  {
    return -1;
  }
...
80105790:	6a 04                	push   $0x4
80105792:	50                   	push   %eax
80105793:	6a 01                	push   $0x1
80105795:	e8 c6 f2 ff ff       	call   80104a60 <argptr>
8010579a:	83 c4 10             	add    $0x10,%esp
8010579d:	85 c0                	test   %eax,%eax
8010579f:	78 17                	js     801057b8 <sys_waitx+0x48>
  {
    return -1;
  }
...
801057a7:	ff 75 f0             	pushl  -0x10(%ebp)
801057aa:	e8 91 e8 ff ff       	call   80104040 <waitx>
...
801057cc:	e8 3f f2 ff ff       	call   80104a10 <argint>
...
801057de:	e8 ed e9 ff ff       	call   801041d0 <kill>
...
8010581d:	e8 ee f1 ff ff       	call   80104a10 <argint>
...
80105836:	e8 05 e1 ff ff       	call   80103940 <growproc>
...
8010586d:	e8 9e f1 ff ff       	call   80104a10 <argint>
...
80105885:	e8 76 ed ff ff       	call   80104600 <acquire>
  ticks0 = ticks;
...
801058ad:	e8 ce e5 ff ff       	call   80103e80 <sleep>
  while(ticks - ticks0 < n){
...
801058d5:	e8 e6 ed ff ff       	call   801046c0 <release>
      return -1;
...
801058f8:	e8 c3 ed ff ff       	call   801046c0 <release>
  return 0;
...
8010594c:	e8 bf f0 ff ff       	call   80104a10 <argint>
80105951:	83 c4 10             	add    $0x10,%esp
80105954:	85 c0                	test   %eax,%eax
80105956:	78 28                	js     80105980 <sys_set_priority+0x40>
    return -1;
...
80105961:	e8 aa f0 ff ff       	call   80104a10 <argint>
80105966:	83 c4 10             	add    $0x10,%esp
80105969:	85 c0                	test   %eax,%eax
8010596b:	78 13                	js     80105980 <sys_set_priority+0x40>
    return -1;
...
80105976:	e8 65 e1 ff ff       	call   80103ae0 <set_priority>
...
801059c7:	c7 04 c5 a2 51 11 80 	movl   $0x8e000008,-0x7feeae5e(,%eax,8)
801059ce:	08 00 00 8e 
801059d2:	66 89 14 c5 a0 51 11 	mov    %dx,-0x7feeae60(,%eax,8)
801059d9:	80 
801059da:	c1 ea 10             	shr    $0x10,%edx
801059dd:	66 89 14 c5 a6 51 11 	mov    %dx,-0x7feeae5a(,%eax,8)
801059e4:	80 
  for(i = 0; i < 256; i++)
...
801059f4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059f7:	c7 05 a2 53 11 80 08 	movl   $0xef000008,0x801153a2
801059fe:	00 00 ef 
  initlock(&tickslock, "time");
80105a01:	68 e1 79 10 80       	push   $0x801079e1
80105a06:	68 60 51 11 80       	push   $0x80115160
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105a0b:	66 a3 a0 53 11 80    	mov    %ax,0x801153a0
80105a11:	c1 e8 10             	shr    $0x10,%eax
80105a14:	66 a3 a6 53 11 80    	mov    %ax,0x801153a6
  initlock(&tickslock, "time");
80105a1a:	e8 a1 ea ff ff       	call   801044c0 <initlock>
}
...
80105a3b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a3f:	b8 a0 51 11 80       	mov    $0x801151a0,%eax
...
80105a90:	e8 8b dd ff ff       	call   80103820 <myproc>
80105a95:	85 c0                	test   %eax,%eax
80105a97:	8b 5f 38             	mov    0x38(%edi),%ebx
80105a9a:	0f 84 19 02 00 00    	je     80105cb9 <trap+0x259>
80105aa0:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105aa4:	0f 84 0f 02 00 00    	je     80105cb9 <trap+0x259>
...
80105ab0:	e8 4b dd ff ff       	call   80103800 <cpuid>
...
80105ac9:	e8 52 dd ff ff       	call   80103820 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105af2:	e8 29 dd ff ff       	call   80103820 <myproc>
...
80105afe:	e8 1d dd ff ff       	call   80103820 <myproc>
80105b03:	85 c0                	test   %eax,%eax
80105b05:	74 1d                	je     80105b24 <trap+0xc4>
80105b07:	e8 14 dd ff ff       	call   80103820 <myproc>
...
80105b24:	e8 f7 dc ff ff       	call   80103820 <myproc>
...
80105b41:	e8 da dc ff ff       	call   80103820 <myproc>
...
80105b72:	0f 85 e8 00 00 00    	jne    80105c60 <trap+0x200>
    myproc()->tf = tf;
80105b78:	e8 a3 dc ff ff       	call   80103820 <myproc>
80105b7d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105b80:	e8 7b ef ff ff       	call   80104b00 <syscall>
    if(myproc()->killed)
80105b85:	e8 96 dc ff ff       	call   80103820 <myproc>
...
80105bbd:	e8 8e cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bc2:	e8 59 dc ff ff       	call   80103820 <myproc>
...
80105bf4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105bf8:	e8 63 02 00 00       	call   80105e60 <uartintr>
    lapiceoi();
80105bfd:	e8 4e cb ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c02:	e8 19 dc ff ff       	call   80103820 <myproc>
...
80105c1f:	e8 dc db ff ff       	call   80103800 <cpuid>
80105c24:	56                   	push   %esi
80105c25:	53                   	push   %ebx
80105c26:	50                   	push   %eax
80105c27:	68 ec 79 10 80       	push   $0x801079ec
...
80105c5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105c60:	e8 8b e0 ff ff       	call   80103cf0 <exit>
80105c65:	e9 0e ff ff ff       	jmp    80105b78 <trap+0x118>
80105c6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105c70:	e8 7b e0 ff ff       	call   80103cf0 <exit>
80105c75:	e9 aa fe ff ff       	jmp    80105b24 <trap+0xc4>
80105c7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105c80:	83 ec 0c             	sub    $0xc,%esp
80105c83:	68 60 51 11 80       	push   $0x80115160
80105c88:	e8 73 e9 ff ff       	call   80104600 <acquire>
      wakeup(&ticks);
80105c8d:	c7 04 24 a0 59 11 80 	movl   $0x801159a0,(%esp)
      ticks++;
80105c94:	83 05 a0 59 11 80 01 	addl   $0x1,0x801159a0
      wakeup(&ticks);
80105c9b:	e8 d0 e4 ff ff       	call   80104170 <wakeup>
      modify_times();
80105ca0:	e8 7b e6 ff ff       	call   80104320 <modify_times>
      release(&tickslock);      
80105ca5:	c7 04 24 60 51 11 80 	movl   $0x80115160,(%esp)
80105cac:	e8 0f ea ff ff       	call   801046c0 <release>
80105cb1:	83 c4 10             	add    $0x10,%esp
80105cb4:	e9 04 ff ff ff       	jmp    80105bbd <trap+0x15d>
80105cb9:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105cbc:	e8 3f db ff ff       	call   80103800 <cpuid>
80105cc1:	83 ec 0c             	sub    $0xc,%esp
80105cc4:	56                   	push   %esi
80105cc5:	53                   	push   %ebx
80105cc6:	50                   	push   %eax
80105cc7:	ff 77 30             	pushl  0x30(%edi)
80105cca:	68 10 7a 10 80       	push   $0x80107a10
80105ccf:	e8 8c a9 ff ff       	call   80100660 <cprintf>
      panic("trap");
80105cd4:	83 c4 14             	add    $0x14,%esp
80105cd7:	68 e6 79 10 80       	push   $0x801079e6
80105cdc:	e8 af a6 ff ff       	call   80100390 <panic>
...
80105d45:	e8 26 ca ff ff       	call   80102770 <microdelay>
...
80105ddc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ddf:	bb 08 7b 10 80       	mov    $0x80107b08,%ebx
  ioapicenable(IRQ_COM1, 0);
80105de4:	6a 00                	push   $0x0
80105de6:	6a 04                	push   $0x4
80105de8:	e8 e3 c4 ff ff       	call   801022d0 <ioapicenable>
...
80105e77:	6a 00                	push   $0x0
  jmp alltraps
80105e79:	e9 09 fb ff ff       	jmp    80105987 <alltraps>
...
80105e80:	6a 01                	push   $0x1
  jmp alltraps
80105e82:	e9 00 fb ff ff       	jmp    80105987 <alltraps>
...
80105e89:	6a 02                	push   $0x2
  jmp alltraps
80105e8b:	e9 f7 fa ff ff       	jmp    80105987 <alltraps>
...
80105e92:	6a 03                	push   $0x3
  jmp alltraps
80105e94:	e9 ee fa ff ff       	jmp    80105987 <alltraps>
...
80105ea4:	6a 05                	push   $0x5
  jmp alltraps
80105ea6:	e9 dc fa ff ff       	jmp    80105987 <alltraps>
...
80105ec6:	6a 09                	push   $0x9
  jmp alltraps
80105ec8:	e9 ba fa ff ff       	jmp    80105987 <alltraps>
...
80105ecd:	6a 0a                	push   $0xa
  jmp alltraps
80105ecf:	e9 b3 fa ff ff       	jmp    80105987 <alltraps>
...
80105edb:	6a 0c                	push   $0xc
  jmp alltraps
80105edd:	e9 a5 fa ff ff       	jmp    80105987 <alltraps>
...
80105ee9:	6a 0e                	push   $0xe
  jmp alltraps
80105eeb:	e9 97 fa ff ff       	jmp    80105987 <alltraps>
...
80105f02:	6a 11                	push   $0x11
  jmp alltraps
80105f04:	e9 7e fa ff ff       	jmp    80105987 <alltraps>
...
80105f0b:	6a 12                	push   $0x12
  jmp alltraps
80105f0d:	e9 75 fa ff ff       	jmp    80105987 <alltraps>
...
80105f14:	6a 13                	push   $0x13
  jmp alltraps
80105f16:	e9 6c fa ff ff       	jmp    80105987 <alltraps>
...
80105f1d:	6a 14                	push   $0x14
  jmp alltraps
80105f1f:	e9 63 fa ff ff       	jmp    80105987 <alltraps>
...
80105f26:	6a 15                	push   $0x15
  jmp alltraps
80105f28:	e9 5a fa ff ff       	jmp    80105987 <alltraps>
...
80105f2f:	6a 16                	push   $0x16
  jmp alltraps
80105f31:	e9 51 fa ff ff       	jmp    80105987 <alltraps>
...
80105f38:	6a 17                	push   $0x17
  jmp alltraps
80105f3a:	e9 48 fa ff ff       	jmp    80105987 <alltraps>
...
80105f41:	6a 18                	push   $0x18
  jmp alltraps
80105f43:	e9 3f fa ff ff       	jmp    80105987 <alltraps>
...
80105f4a:	6a 19                	push   $0x19
  jmp alltraps
80105f4c:	e9 36 fa ff ff       	jmp    80105987 <alltraps>
...
80105f53:	6a 1a                	push   $0x1a
  jmp alltraps
80105f55:	e9 2d fa ff ff       	jmp    80105987 <alltraps>
...
80105f5c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f5e:	e9 24 fa ff ff       	jmp    80105987 <alltraps>
...
80105f65:	6a 1c                	push   $0x1c
  jmp alltraps
80105f67:	e9 1b fa ff ff       	jmp    80105987 <alltraps>
...
80105f6e:	6a 1d                	push   $0x1d
  jmp alltraps
80105f70:	e9 12 fa ff ff       	jmp    80105987 <alltraps>
...
80105f77:	6a 1e                	push   $0x1e
  jmp alltraps
80105f79:	e9 09 fa ff ff       	jmp    80105987 <alltraps>
...
80105f80:	6a 1f                	push   $0x1f
  jmp alltraps
80105f82:	e9 00 fa ff ff       	jmp    80105987 <alltraps>
...
80105f89:	6a 20                	push   $0x20
  jmp alltraps
80105f8b:	e9 f7 f9 ff ff       	jmp    80105987 <alltraps>
...
80105f92:	6a 21                	push   $0x21
  jmp alltraps
80105f94:	e9 ee f9 ff ff       	jmp    80105987 <alltraps>
...
80105f9b:	6a 22                	push   $0x22
  jmp alltraps
80105f9d:	e9 e5 f9 ff ff       	jmp    80105987 <alltraps>
...
80105fa4:	6a 23                	push   $0x23
  jmp alltraps
80105fa6:	e9 dc f9 ff ff       	jmp    80105987 <alltraps>
...
80105fad:	6a 24                	push   $0x24
  jmp alltraps
80105faf:	e9 d3 f9 ff ff       	jmp    80105987 <alltraps>
...
80105fb6:	6a 25                	push   $0x25
  jmp alltraps
80105fb8:	e9 ca f9 ff ff       	jmp    80105987 <alltraps>
...
80105fbf:	6a 26                	push   $0x26
  jmp alltraps
80105fc1:	e9 c1 f9 ff ff       	jmp    80105987 <alltraps>
...
80105fc8:	6a 27                	push   $0x27
  jmp alltraps
80105fca:	e9 b8 f9 ff ff       	jmp    80105987 <alltraps>
...
80105fd1:	6a 28                	push   $0x28
  jmp alltraps
80105fd3:	e9 af f9 ff ff       	jmp    80105987 <alltraps>
...
80105fda:	6a 29                	push   $0x29
  jmp alltraps
80105fdc:	e9 a6 f9 ff ff       	jmp    80105987 <alltraps>
...
80105fe3:	6a 2a                	push   $0x2a
  jmp alltraps
80105fe5:	e9 9d f9 ff ff       	jmp    80105987 <alltraps>
...
80105fec:	6a 2b                	push   $0x2b
  jmp alltraps
80105fee:	e9 94 f9 ff ff       	jmp    80105987 <alltraps>
...
80105ff5:	6a 2c                	push   $0x2c
  jmp alltraps
80105ff7:	e9 8b f9 ff ff       	jmp    80105987 <alltraps>
...
80105ffe:	6a 2d                	push   $0x2d
  jmp alltraps
80106000:	e9 82 f9 ff ff       	jmp    80105987 <alltraps>
...
80106007:	6a 2e                	push   $0x2e
  jmp alltraps
80106009:	e9 79 f9 ff ff       	jmp    80105987 <alltraps>
...
80106010:	6a 2f                	push   $0x2f
  jmp alltraps
80106012:	e9 70 f9 ff ff       	jmp    80105987 <alltraps>
...
80106019:	6a 30                	push   $0x30
  jmp alltraps
8010601b:	e9 67 f9 ff ff       	jmp    80105987 <alltraps>
...
80106022:	6a 31                	push   $0x31
  jmp alltraps
80106024:	e9 5e f9 ff ff       	jmp    80105987 <alltraps>
...
8010602b:	6a 32                	push   $0x32
  jmp alltraps
8010602d:	e9 55 f9 ff ff       	jmp    80105987 <alltraps>
...
80106034:	6a 33                	push   $0x33
  jmp alltraps
80106036:	e9 4c f9 ff ff       	jmp    80105987 <alltraps>
...
8010603d:	6a 34                	push   $0x34
  jmp alltraps
8010603f:	e9 43 f9 ff ff       	jmp    80105987 <alltraps>
...
80106046:	6a 35                	push   $0x35
  jmp alltraps
80106048:	e9 3a f9 ff ff       	jmp    80105987 <alltraps>
...
8010604f:	6a 36                	push   $0x36
  jmp alltraps
80106051:	e9 31 f9 ff ff       	jmp    80105987 <alltraps>
...
80106058:	6a 37                	push   $0x37
  jmp alltraps
8010605a:	e9 28 f9 ff ff       	jmp    80105987 <alltraps>
...
80106061:	6a 38                	push   $0x38
  jmp alltraps
80106063:	e9 1f f9 ff ff       	jmp    80105987 <alltraps>
...
8010606a:	6a 39                	push   $0x39
  jmp alltraps
8010606c:	e9 16 f9 ff ff       	jmp    80105987 <alltraps>
...
80106073:	6a 3a                	push   $0x3a
  jmp alltraps
80106075:	e9 0d f9 ff ff       	jmp    80105987 <alltraps>
...
8010607c:	6a 3b                	push   $0x3b
  jmp alltraps
8010607e:	e9 04 f9 ff ff       	jmp    80105987 <alltraps>
...
80106085:	6a 3c                	push   $0x3c
  jmp alltraps
80106087:	e9 fb f8 ff ff       	jmp    80105987 <alltraps>
...
8010608e:	6a 3d                	push   $0x3d
  jmp alltraps
80106090:	e9 f2 f8 ff ff       	jmp    80105987 <alltraps>
...
80106097:	6a 3e                	push   $0x3e
  jmp alltraps
80106099:	e9 e9 f8 ff ff       	jmp    80105987 <alltraps>
...
801060a0:	6a 3f                	push   $0x3f
  jmp alltraps
801060a2:	e9 e0 f8 ff ff       	jmp    80105987 <alltraps>
...
801060a9:	6a 40                	push   $0x40
  jmp alltraps
801060ab:	e9 d7 f8 ff ff       	jmp    80105987 <alltraps>
...
801060b2:	6a 41                	push   $0x41
  jmp alltraps
801060b4:	e9 ce f8 ff ff       	jmp    80105987 <alltraps>
...
801060bb:	6a 42                	push   $0x42
  jmp alltraps
801060bd:	e9 c5 f8 ff ff       	jmp    80105987 <alltraps>
...
801060c4:	6a 43                	push   $0x43
  jmp alltraps
801060c6:	e9 bc f8 ff ff       	jmp    80105987 <alltraps>
...
801060cd:	6a 44                	push   $0x44
  jmp alltraps
801060cf:	e9 b3 f8 ff ff       	jmp    80105987 <alltraps>
...
801060d6:	6a 45                	push   $0x45
  jmp alltraps
801060d8:	e9 aa f8 ff ff       	jmp    80105987 <alltraps>
...
801060df:	6a 46                	push   $0x46
  jmp alltraps
801060e1:	e9 a1 f8 ff ff       	jmp    80105987 <alltraps>
...
801060e8:	6a 47                	push   $0x47
  jmp alltraps
801060ea:	e9 98 f8 ff ff       	jmp    80105987 <alltraps>
...
801060f1:	6a 48                	push   $0x48
  jmp alltraps
801060f3:	e9 8f f8 ff ff       	jmp    80105987 <alltraps>
...
801060fa:	6a 49                	push   $0x49
  jmp alltraps
801060fc:	e9 86 f8 ff ff       	jmp    80105987 <alltraps>
...
80106103:	6a 4a                	push   $0x4a
  jmp alltraps
80106105:	e9 7d f8 ff ff       	jmp    80105987 <alltraps>
...
8010610c:	6a 4b                	push   $0x4b
  jmp alltraps
8010610e:	e9 74 f8 ff ff       	jmp    80105987 <alltraps>
...
80106115:	6a 4c                	push   $0x4c
  jmp alltraps
80106117:	e9 6b f8 ff ff       	jmp    80105987 <alltraps>
...
8010611e:	6a 4d                	push   $0x4d
  jmp alltraps
80106120:	e9 62 f8 ff ff       	jmp    80105987 <alltraps>
...
80106127:	6a 4e                	push   $0x4e
  jmp alltraps
80106129:	e9 59 f8 ff ff       	jmp    80105987 <alltraps>
...
80106130:	6a 4f                	push   $0x4f
  jmp alltraps
80106132:	e9 50 f8 ff ff       	jmp    80105987 <alltraps>
...
80106139:	6a 50                	push   $0x50
  jmp alltraps
8010613b:	e9 47 f8 ff ff       	jmp    80105987 <alltraps>
...
80106142:	6a 51                	push   $0x51
  jmp alltraps
80106144:	e9 3e f8 ff ff       	jmp    80105987 <alltraps>
...
8010614b:	6a 52                	push   $0x52
  jmp alltraps
8010614d:	e9 35 f8 ff ff       	jmp    80105987 <alltraps>
...
80106154:	6a 53                	push   $0x53
  jmp alltraps
80106156:	e9 2c f8 ff ff       	jmp    80105987 <alltraps>
...
8010615d:	6a 54                	push   $0x54
  jmp alltraps
8010615f:	e9 23 f8 ff ff       	jmp    80105987 <alltraps>
...
80106166:	6a 55                	push   $0x55
  jmp alltraps
80106168:	e9 1a f8 ff ff       	jmp    80105987 <alltraps>
...
8010616f:	6a 56                	push   $0x56
  jmp alltraps
80106171:	e9 11 f8 ff ff       	jmp    80105987 <alltraps>
...
80106178:	6a 57                	push   $0x57
  jmp alltraps
8010617a:	e9 08 f8 ff ff       	jmp    80105987 <alltraps>
...
80106181:	6a 58                	push   $0x58
  jmp alltraps
80106183:	e9 ff f7 ff ff       	jmp    80105987 <alltraps>
...
8010618a:	6a 59                	push   $0x59
  jmp alltraps
8010618c:	e9 f6 f7 ff ff       	jmp    80105987 <alltraps>
...
80106193:	6a 5a                	push   $0x5a
  jmp alltraps
80106195:	e9 ed f7 ff ff       	jmp    80105987 <alltraps>
...
8010619c:	6a 5b                	push   $0x5b
  jmp alltraps
8010619e:	e9 e4 f7 ff ff       	jmp    80105987 <alltraps>
...
801061a5:	6a 5c                	push   $0x5c
  jmp alltraps
801061a7:	e9 db f7 ff ff       	jmp    80105987 <alltraps>
...
801061ae:	6a 5d                	push   $0x5d
  jmp alltraps
801061b0:	e9 d2 f7 ff ff       	jmp    80105987 <alltraps>
...
801061b7:	6a 5e                	push   $0x5e
  jmp alltraps
801061b9:	e9 c9 f7 ff ff       	jmp    80105987 <alltraps>
...
801061c0:	6a 5f                	push   $0x5f
  jmp alltraps
801061c2:	e9 c0 f7 ff ff       	jmp    80105987 <alltraps>
...
801061c9:	6a 60                	push   $0x60
  jmp alltraps
801061cb:	e9 b7 f7 ff ff       	jmp    80105987 <alltraps>
...
801061d2:	6a 61                	push   $0x61
  jmp alltraps
801061d4:	e9 ae f7 ff ff       	jmp    80105987 <alltraps>
...
801061db:	6a 62                	push   $0x62
  jmp alltraps
801061dd:	e9 a5 f7 ff ff       	jmp    80105987 <alltraps>
...
801061e4:	6a 63                	push   $0x63
  jmp alltraps
801061e6:	e9 9c f7 ff ff       	jmp    80105987 <alltraps>
...
801061ed:	6a 64                	push   $0x64
  jmp alltraps
801061ef:	e9 93 f7 ff ff       	jmp    80105987 <alltraps>
...
801061f6:	6a 65                	push   $0x65
  jmp alltraps
801061f8:	e9 8a f7 ff ff       	jmp    80105987 <alltraps>
...
801061ff:	6a 66                	push   $0x66
  jmp alltraps
80106201:	e9 81 f7 ff ff       	jmp    80105987 <alltraps>
...
80106208:	6a 67                	push   $0x67
  jmp alltraps
8010620a:	e9 78 f7 ff ff       	jmp    80105987 <alltraps>
...
80106211:	6a 68                	push   $0x68
  jmp alltraps
80106213:	e9 6f f7 ff ff       	jmp    80105987 <alltraps>
...
8010621a:	6a 69                	push   $0x69
  jmp alltraps
8010621c:	e9 66 f7 ff ff       	jmp    80105987 <alltraps>
...
80106223:	6a 6a                	push   $0x6a
  jmp alltraps
80106225:	e9 5d f7 ff ff       	jmp    80105987 <alltraps>
...
8010622c:	6a 6b                	push   $0x6b
  jmp alltraps
8010622e:	e9 54 f7 ff ff       	jmp    80105987 <alltraps>
...
80106235:	6a 6c                	push   $0x6c
  jmp alltraps
80106237:	e9 4b f7 ff ff       	jmp    80105987 <alltraps>
...
8010623e:	6a 6d                	push   $0x6d
  jmp alltraps
80106240:	e9 42 f7 ff ff       	jmp    80105987 <alltraps>
...
80106247:	6a 6e                	push   $0x6e
  jmp alltraps
80106249:	e9 39 f7 ff ff       	jmp    80105987 <alltraps>
...
80106250:	6a 6f                	push   $0x6f
  jmp alltraps
80106252:	e9 30 f7 ff ff       	jmp    80105987 <alltraps>
...
80106259:	6a 70                	push   $0x70
  jmp alltraps
8010625b:	e9 27 f7 ff ff       	jmp    80105987 <alltraps>
...
80106262:	6a 71                	push   $0x71
  jmp alltraps
80106264:	e9 1e f7 ff ff       	jmp    80105987 <alltraps>
...
8010626b:	6a 72                	push   $0x72
  jmp alltraps
8010626d:	e9 15 f7 ff ff       	jmp    80105987 <alltraps>
...
80106274:	6a 73                	push   $0x73
  jmp alltraps
80106276:	e9 0c f7 ff ff       	jmp    80105987 <alltraps>
...
8010627d:	6a 74                	push   $0x74
  jmp alltraps
8010627f:	e9 03 f7 ff ff       	jmp    80105987 <alltraps>
...
80106286:	6a 75                	push   $0x75
  jmp alltraps
80106288:	e9 fa f6 ff ff       	jmp    80105987 <alltraps>
...
8010628f:	6a 76                	push   $0x76
  jmp alltraps
80106291:	e9 f1 f6 ff ff       	jmp    80105987 <alltraps>
...
80106298:	6a 77                	push   $0x77
  jmp alltraps
8010629a:	e9 e8 f6 ff ff       	jmp    80105987 <alltraps>
...
801062a1:	6a 78                	push   $0x78
  jmp alltraps
801062a3:	e9 df f6 ff ff       	jmp    80105987 <alltraps>
...
801062aa:	6a 79                	push   $0x79
  jmp alltraps
801062ac:	e9 d6 f6 ff ff       	jmp    80105987 <alltraps>
...
801062b3:	6a 7a                	push   $0x7a
  jmp alltraps
801062b5:	e9 cd f6 ff ff       	jmp    80105987 <alltraps>
...
801062bc:	6a 7b                	push   $0x7b
  jmp alltraps
801062be:	e9 c4 f6 ff ff       	jmp    80105987 <alltraps>
...
801062c5:	6a 7c                	push   $0x7c
  jmp alltraps
801062c7:	e9 bb f6 ff ff       	jmp    80105987 <alltraps>
...
801062ce:	6a 7d                	push   $0x7d
  jmp alltraps
801062d0:	e9 b2 f6 ff ff       	jmp    80105987 <alltraps>
...
801062d7:	6a 7e                	push   $0x7e
  jmp alltraps
801062d9:	e9 a9 f6 ff ff       	jmp    80105987 <alltraps>
...
801062e0:	6a 7f                	push   $0x7f
  jmp alltraps
801062e2:	e9 a0 f6 ff ff       	jmp    80105987 <alltraps>
...
801062e9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801062ee:	e9 94 f6 ff ff       	jmp    80105987 <alltraps>
...
801062f5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801062fa:	e9 88 f6 ff ff       	jmp    80105987 <alltraps>
...
80106301:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106306:	e9 7c f6 ff ff       	jmp    80105987 <alltraps>
...
8010630d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106312:	e9 70 f6 ff ff       	jmp    80105987 <alltraps>
...
80106319:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010631e:	e9 64 f6 ff ff       	jmp    80105987 <alltraps>
...
80106325:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010632a:	e9 58 f6 ff ff       	jmp    80105987 <alltraps>
...
80106331:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106336:	e9 4c f6 ff ff       	jmp    80105987 <alltraps>
...
8010633d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106342:	e9 40 f6 ff ff       	jmp    80105987 <alltraps>
...
80106349:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010634e:	e9 34 f6 ff ff       	jmp    80105987 <alltraps>
...
80106355:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010635a:	e9 28 f6 ff ff       	jmp    80105987 <alltraps>
...
80106361:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106366:	e9 1c f6 ff ff       	jmp    80105987 <alltraps>
...
8010636d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106372:	e9 10 f6 ff ff       	jmp    80105987 <alltraps>
...
80106379:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010637e:	e9 04 f6 ff ff       	jmp    80105987 <alltraps>
...
80106385:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010638a:	e9 f8 f5 ff ff       	jmp    80105987 <alltraps>
...
80106391:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106396:	e9 ec f5 ff ff       	jmp    80105987 <alltraps>
...
8010639d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801063a2:	e9 e0 f5 ff ff       	jmp    80105987 <alltraps>
...
801063a9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801063ae:	e9 d4 f5 ff ff       	jmp    80105987 <alltraps>
...
801063b5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801063ba:	e9 c8 f5 ff ff       	jmp    80105987 <alltraps>
...
801063c1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801063c6:	e9 bc f5 ff ff       	jmp    80105987 <alltraps>
...
801063cd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801063d2:	e9 b0 f5 ff ff       	jmp    80105987 <alltraps>
...
801063d9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801063de:	e9 a4 f5 ff ff       	jmp    80105987 <alltraps>
...
801063e5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801063ea:	e9 98 f5 ff ff       	jmp    80105987 <alltraps>
...
801063f1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801063f6:	e9 8c f5 ff ff       	jmp    80105987 <alltraps>
...
801063fd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106402:	e9 80 f5 ff ff       	jmp    80105987 <alltraps>
...
80106409:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010640e:	e9 74 f5 ff ff       	jmp    80105987 <alltraps>
...
80106415:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010641a:	e9 68 f5 ff ff       	jmp    80105987 <alltraps>
...
80106421:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106426:	e9 5c f5 ff ff       	jmp    80105987 <alltraps>
...
8010642d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106432:	e9 50 f5 ff ff       	jmp    80105987 <alltraps>
...
80106439:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010643e:	e9 44 f5 ff ff       	jmp    80105987 <alltraps>
...
80106445:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010644a:	e9 38 f5 ff ff       	jmp    80105987 <alltraps>
...
80106451:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106456:	e9 2c f5 ff ff       	jmp    80105987 <alltraps>
...
8010645d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106462:	e9 20 f5 ff ff       	jmp    80105987 <alltraps>
...
80106469:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010646e:	e9 14 f5 ff ff       	jmp    80105987 <alltraps>
...
80106475:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010647a:	e9 08 f5 ff ff       	jmp    80105987 <alltraps>
...
80106481:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106486:	e9 fc f4 ff ff       	jmp    80105987 <alltraps>
...
8010648d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106492:	e9 f0 f4 ff ff       	jmp    80105987 <alltraps>
...
80106499:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010649e:	e9 e4 f4 ff ff       	jmp    80105987 <alltraps>
...
801064a5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801064aa:	e9 d8 f4 ff ff       	jmp    80105987 <alltraps>
...
801064b1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801064b6:	e9 cc f4 ff ff       	jmp    80105987 <alltraps>
...
801064bd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801064c2:	e9 c0 f4 ff ff       	jmp    80105987 <alltraps>
...
801064c9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801064ce:	e9 b4 f4 ff ff       	jmp    80105987 <alltraps>
...
801064d5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801064da:	e9 a8 f4 ff ff       	jmp    80105987 <alltraps>
...
801064e1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801064e6:	e9 9c f4 ff ff       	jmp    80105987 <alltraps>
...
801064ed:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801064f2:	e9 90 f4 ff ff       	jmp    80105987 <alltraps>
...
801064f9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801064fe:	e9 84 f4 ff ff       	jmp    80105987 <alltraps>
...
80106505:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010650a:	e9 78 f4 ff ff       	jmp    80105987 <alltraps>
...
80106511:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106516:	e9 6c f4 ff ff       	jmp    80105987 <alltraps>
...
8010651d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106522:	e9 60 f4 ff ff       	jmp    80105987 <alltraps>
...
80106529:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010652e:	e9 54 f4 ff ff       	jmp    80105987 <alltraps>
...
80106535:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010653a:	e9 48 f4 ff ff       	jmp    80105987 <alltraps>
...
80106541:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106546:	e9 3c f4 ff ff       	jmp    80105987 <alltraps>
...
8010654d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106552:	e9 30 f4 ff ff       	jmp    80105987 <alltraps>
...
80106559:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010655e:	e9 24 f4 ff ff       	jmp    80105987 <alltraps>
...
80106565:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010656a:	e9 18 f4 ff ff       	jmp    80105987 <alltraps>
...
80106571:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106576:	e9 0c f4 ff ff       	jmp    80105987 <alltraps>
...
8010657d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106582:	e9 00 f4 ff ff       	jmp    80105987 <alltraps>
...
80106589:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010658e:	e9 f4 f3 ff ff       	jmp    80105987 <alltraps>
...
80106595:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010659a:	e9 e8 f3 ff ff       	jmp    80105987 <alltraps>
...
801065a1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801065a6:	e9 dc f3 ff ff       	jmp    80105987 <alltraps>
...
801065ad:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801065b2:	e9 d0 f3 ff ff       	jmp    80105987 <alltraps>
...
801065b9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801065be:	e9 c4 f3 ff ff       	jmp    80105987 <alltraps>
...
801065c5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801065ca:	e9 b8 f3 ff ff       	jmp    80105987 <alltraps>
...
801065d1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801065d6:	e9 ac f3 ff ff       	jmp    80105987 <alltraps>
...
801065dd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801065e2:	e9 a0 f3 ff ff       	jmp    80105987 <alltraps>
...
801065e9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801065ee:	e9 94 f3 ff ff       	jmp    80105987 <alltraps>
...
801065f5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801065fa:	e9 88 f3 ff ff       	jmp    80105987 <alltraps>
...
80106601:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106606:	e9 7c f3 ff ff       	jmp    80105987 <alltraps>
...
8010660d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106612:	e9 70 f3 ff ff       	jmp    80105987 <alltraps>
...
80106619:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010661e:	e9 64 f3 ff ff       	jmp    80105987 <alltraps>
...
80106625:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010662a:	e9 58 f3 ff ff       	jmp    80105987 <alltraps>
...
80106631:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106636:	e9 4c f3 ff ff       	jmp    80105987 <alltraps>
...
8010663d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106642:	e9 40 f3 ff ff       	jmp    80105987 <alltraps>
...
80106649:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010664e:	e9 34 f3 ff ff       	jmp    80105987 <alltraps>
...
80106655:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010665a:	e9 28 f3 ff ff       	jmp    80105987 <alltraps>
...
80106661:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106666:	e9 1c f3 ff ff       	jmp    80105987 <alltraps>
...
8010666d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106672:	e9 10 f3 ff ff       	jmp    80105987 <alltraps>
...
80106679:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010667e:	e9 04 f3 ff ff       	jmp    80105987 <alltraps>
...
80106685:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010668a:	e9 f8 f2 ff ff       	jmp    80105987 <alltraps>
...
80106691:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106696:	e9 ec f2 ff ff       	jmp    80105987 <alltraps>
...
8010669d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801066a2:	e9 e0 f2 ff ff       	jmp    80105987 <alltraps>
...
801066a9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801066ae:	e9 d4 f2 ff ff       	jmp    80105987 <alltraps>
...
801066b5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801066ba:	e9 c8 f2 ff ff       	jmp    80105987 <alltraps>
...
801066c1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801066c6:	e9 bc f2 ff ff       	jmp    80105987 <alltraps>
...
801066cd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801066d2:	e9 b0 f2 ff ff       	jmp    80105987 <alltraps>
...
801066d9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801066de:	e9 a4 f2 ff ff       	jmp    80105987 <alltraps>
...
801066e5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801066ea:	e9 98 f2 ff ff       	jmp    80105987 <alltraps>
...
801066f1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801066f6:	e9 8c f2 ff ff       	jmp    80105987 <alltraps>
...
801066fd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106702:	e9 80 f2 ff ff       	jmp    80105987 <alltraps>
...
80106709:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010670e:	e9 74 f2 ff ff       	jmp    80105987 <alltraps>
...
80106715:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010671a:	e9 68 f2 ff ff       	jmp    80105987 <alltraps>
...
80106721:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106726:	e9 5c f2 ff ff       	jmp    80105987 <alltraps>
...
8010672d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106732:	e9 50 f2 ff ff       	jmp    80105987 <alltraps>
...
80106739:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010673e:	e9 44 f2 ff ff       	jmp    80105987 <alltraps>
...
80106745:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010674a:	e9 38 f2 ff ff       	jmp    80105987 <alltraps>
...
80106751:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106756:	e9 2c f2 ff ff       	jmp    80105987 <alltraps>
...
8010675d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106762:	e9 20 f2 ff ff       	jmp    80105987 <alltraps>
...
80106769:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010676e:	e9 14 f2 ff ff       	jmp    80105987 <alltraps>
...
80106775:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010677a:	e9 08 f2 ff ff       	jmp    80105987 <alltraps>
...
80106781:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106786:	e9 fc f1 ff ff       	jmp    80105987 <alltraps>
...
8010678d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106792:	e9 f0 f1 ff ff       	jmp    80105987 <alltraps>
...
80106799:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010679e:	e9 e4 f1 ff ff       	jmp    80105987 <alltraps>
...
801067a5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801067aa:	e9 d8 f1 ff ff       	jmp    80105987 <alltraps>
...
801067b1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801067b6:	e9 cc f1 ff ff       	jmp    80105987 <alltraps>
...
801067bd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801067c2:	e9 c0 f1 ff ff       	jmp    80105987 <alltraps>
...
801067c9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801067ce:	e9 b4 f1 ff ff       	jmp    80105987 <alltraps>
...
801067d5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801067da:	e9 a8 f1 ff ff       	jmp    80105987 <alltraps>
...
801067e1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801067e6:	e9 9c f1 ff ff       	jmp    80105987 <alltraps>
...
801067ed:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801067f2:	e9 90 f1 ff ff       	jmp    80105987 <alltraps>
...
801067f9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801067fe:	e9 84 f1 ff ff       	jmp    80105987 <alltraps>
...
80106805:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010680a:	e9 78 f1 ff ff       	jmp    80105987 <alltraps>
...
80106811:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106816:	e9 6c f1 ff ff       	jmp    80105987 <alltraps>
...
8010681d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106822:	e9 60 f1 ff ff       	jmp    80105987 <alltraps>
...
80106829:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010682e:	e9 54 f1 ff ff       	jmp    80105987 <alltraps>
...
80106835:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010683a:	e9 48 f1 ff ff       	jmp    80105987 <alltraps>
...
80106841:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106846:	e9 3c f1 ff ff       	jmp    80105987 <alltraps>
...
8010684d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106852:	e9 30 f1 ff ff       	jmp    80105987 <alltraps>
...
80106859:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010685e:	e9 24 f1 ff ff       	jmp    80105987 <alltraps>
...
80106865:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010686a:	e9 18 f1 ff ff       	jmp    80105987 <alltraps>
...
80106871:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106876:	e9 0c f1 ff ff       	jmp    80105987 <alltraps>
...
8010687d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106882:	e9 00 f1 ff ff       	jmp    80105987 <alltraps>
...
80106889:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010688e:	e9 f4 f0 ff ff       	jmp    80105987 <alltraps>
...
80106895:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010689a:	e9 e8 f0 ff ff       	jmp    80105987 <alltraps>
...
801068a1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801068a6:	e9 dc f0 ff ff       	jmp    80105987 <alltraps>
...
801068ad:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801068b2:	e9 d0 f0 ff ff       	jmp    80105987 <alltraps>
...
801068b9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801068be:	e9 c4 f0 ff ff       	jmp    80105987 <alltraps>
...
801068c5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801068ca:	e9 b8 f0 ff ff       	jmp    80105987 <alltraps>
...
801068d1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801068d6:	e9 ac f0 ff ff       	jmp    80105987 <alltraps>
...
801068dd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801068e2:	e9 a0 f0 ff ff       	jmp    80105987 <alltraps>
...
80106934:	e8 87 bb ff ff       	call   801024c0 <kalloc>
...
8010694a:	e8 c1 dd ff ff       	call   80104710 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
801069ed:	68 10 7b 10 80       	push   $0x80107b10
...
80106a44:	e8 c7 b8 ff ff       	call   80102310 <kfree>
      *pte = 0;
...
80106aa3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106aa6:	e8 55 cd ff ff       	call   80103800 <cpuid>
...
80106b30:	a1 a4 59 11 80       	mov    0x801159a4,%eax
{
...
80106b74:	0f 84 c2 00 00 00    	je     80106c3c <switchuvm+0xec>
  pushcli();
80106b7a:	e8 b1 d9 ff ff       	call   80104530 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b7f:	e8 fc cb ff ff       	call   80103780 <mycpu>
80106b84:	89 c6                	mov    %eax,%esi
80106b86:	e8 f5 cb ff ff       	call   80103780 <mycpu>
80106b8b:	89 c7                	mov    %eax,%edi
80106b8d:	e8 ee cb ff ff       	call   80103780 <mycpu>
80106b92:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106b95:	83 c7 08             	add    $0x8,%edi
80106b98:	e8 e3 cb ff ff       	call   80103780 <mycpu>
...
80106c8f:	e8 7c da ff ff       	call   80104710 <memset>
...
80106cc0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106cc1:	e9 fa da ff ff       	jmp    801047c0 <memmove>
    panic("inituvm: more than a page");
80106cc6:	83 ec 0c             	sub    $0xc,%esp
80106cc9:	68 55 7b 10 80       	push   $0x80107b55
...
80106deb:	e8 20 d9 ff ff       	call   80104710 <memset>
...
80106e2d:	68 8d 7b 10 80       	push   $0x80107b8d
...
80106e63:	68 a5 7b 10 80       	push   $0x80107ba5
...
80106fa0:	e8 6b d7 ff ff       	call   80104710 <memset>
...
8010700b:	a3 a4 59 11 80       	mov    %eax,0x801159a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107090:	e8 2b d7 ff ff       	call   801047c0 <memmove>
...
80107129:	68 f6 7b 10 80       	push   $0x80107bf6
8010712e:	e8 5d 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107133:	83 ec 0c             	sub    $0xc,%esp
80107136:	68 dc 7b 10 80       	push   $0x80107bdc
...
801071bf:	e8 fc d5 ff ff       	call   801047c0 <memmove>
    len -= n;
    buf += n;
