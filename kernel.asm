...
801021b9:	e8 32 1c 00 00       	call   80103df0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102bc5:	e8 26 12 00 00       	call   80103df0 <sleep>
...
80102e62:	e8 e9 2a 00 00       	call   80105950 <idtinit>
...
80102ee9:	e8 62 08 00 00       	call   80103750 <pinit>
  tvinit();        // trap vectors
80102eee:	e8 dd 29 00 00       	call   801058d0 <tvinit>
  binit();         // buffer cache
...
8010345d:	e8 8e 09 00 00       	call   80103df0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103545:	e8 a6 08 00 00       	call   80103df0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010367f:	e8 ac 0f 00 00       	call   80104630 <release>
...
801036a1:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
801036a4:	c7 40 14 c2 58 10 80 	movl   $0x801058c2,0x14(%eax)
  p->context = (struct context*)sp;
...
801036b3:	e8 c8 0f 00 00       	call   80104680 <memset>
...
80103760:	e8 cb 0c 00 00       	call   80104430 <initlock>
}
...
801037dd:	68 0c 77 10 80       	push   $0x8010770c
...
80103814:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103817:	e8 84 0c 00 00       	call   801044a0 <pushcli>
  c = mycpu();
8010381c:	e8 4f ff ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103821:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103827:	e8 b4 0c 00 00       	call   801044e0 <popcli>
}
...
80103853:	e8 c8 35 00 00       	call   80106e20 <setupkvm>
...
80103871:	e8 8a 32 00 00       	call   80106b00 <inituvm>
...
80103886:	e8 f5 0d 00 00       	call   80104680 <memset>
...
80103935:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103938:	e8 63 0b 00 00       	call   801044a0 <pushcli>
  c = mycpu();
8010393d:	e8 2e fe ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103942:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103948:	e8 93 0b 00 00       	call   801044e0 <popcli>
  if(n > 0){
...
8010395c:	e8 8f 30 00 00       	call   801069f0 <switchuvm>
  return 0;
...
8010397a:	e8 c1 32 00 00       	call   80106c40 <allocuvm>
...
8010399a:	e8 d1 33 00 00       	call   80106d70 <deallocuvm>
...
801039b6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801039b9:	e8 e2 0a 00 00       	call   801044a0 <pushcli>
  c = mycpu();
801039be:	e8 ad fd ff ff       	call   80103770 <mycpu>
  p = c->proc;
801039c3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039c9:	e8 12 0b 00 00       	call   801044e0 <popcli>
  if((np = allocproc()) == 0){
...
801039e8:	e8 03 35 00 00       	call   80106ef0 <copyuvm>
...
80103afb:	e8 70 0a 00 00       	call   80104570 <acquire>
...
80103b42:	74 46                	je     80103b8a <scheduler+0xba>
      cprintf("Core = %d, pid = %d\n", c -> apicid, proc_with_min_start_time -> pid);
80103b44:	83 ec 04             	sub    $0x4,%esp
80103b47:	ff 77 10             	pushl  0x10(%edi)
80103b4a:	0f b6 03             	movzbl (%ebx),%eax
80103b4d:	50                   	push   %eax
80103b4e:	68 50 76 10 80       	push   $0x80107650
80103b53:	e8 08 cb ff ff       	call   80100660 <cprintf>
      c->proc = proc_with_min_start_time;
80103b58:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(proc_with_min_start_time);
80103b5e:	89 3c 24             	mov    %edi,(%esp)
80103b61:	e8 8a 2e 00 00       	call   801069f0 <switchuvm>
      proc_with_min_start_time->state = RUNNING;
80103b66:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), proc_with_min_start_time->context);
80103b6d:	58                   	pop    %eax
80103b6e:	5a                   	pop    %edx
80103b6f:	ff 77 1c             	pushl  0x1c(%edi)
80103b72:	56                   	push   %esi
80103b73:	e8 43 0d 00 00       	call   801048bb <swtch>
      switchkvm();
80103b78:	e8 53 2e 00 00       	call   801069d0 <switchkvm>
      c->proc = 0;
80103b7d:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103b84:	00 00 00 
80103b87:	83 c4 10             	add    $0x10,%esp
    release(&ptable.lock);
80103b8a:	83 ec 0c             	sub    $0xc,%esp
80103b8d:	68 20 2d 11 80       	push   $0x80112d20
80103b92:	e8 99 0a 00 00       	call   80104630 <release>
  for(;;){
80103b97:	83 c4 10             	add    $0x10,%esp
80103b9a:	e9 51 ff ff ff       	jmp    80103af0 <scheduler+0x20>
80103b9f:	90                   	nop
...
80103be7:	75 41                	jne    80103c2a <sched+0x8a>
  intena = mycpu()->intena;
80103be9:	e8 82 fb ff ff       	call   80103770 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103bee:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103bf1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103bf7:	e8 74 fb ff ff       	call   80103770 <mycpu>
80103bfc:	83 ec 08             	sub    $0x8,%esp
80103bff:	ff 70 04             	pushl  0x4(%eax)
80103c02:	53                   	push   %ebx
80103c03:	e8 b3 0c 00 00       	call   801048bb <swtch>
  mycpu()->intena = intena;
80103c08:	e8 63 fb ff ff       	call   80103770 <mycpu>
}
...
80103c66:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c69:	e8 32 08 00 00       	call   801044a0 <pushcli>
  c = mycpu();
80103c6e:	e8 fd fa ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103c73:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c79:	e8 62 08 00 00       	call   801044e0 <popcli>
  if(curproc == initproc)
...
80103cd2:	e8 99 08 00 00       	call   80104570 <acquire>
...
80103ced:	3d 54 50 11 80       	cmp    $0x80115054,%eax
...
80103d0b:	3d 54 50 11 80       	cmp    $0x80115054,%eax
...
80103d26:	81 fa 54 50 11 80    	cmp    $0x80115054,%edx
...
80103d68:	a1 a0 58 11 80       	mov    0x801158a0,%eax
...
80103d82:	68 b2 76 10 80       	push   $0x801076b2
80103d87:	e8 04 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d8c:	83 ec 0c             	sub    $0xc,%esp
80103d8f:	68 a5 76 10 80       	push   $0x801076a5
80103d94:	e8 f7 c5 ff ff       	call   80100390 <panic>
...
80103dac:	e8 bf 07 00 00       	call   80104570 <acquire>
  pushcli();
80103db1:	e8 ea 06 00 00       	call   801044a0 <pushcli>
  c = mycpu();
80103db6:	e8 b5 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103dbb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103dc1:	e8 1a 07 00 00       	call   801044e0 <popcli>
...
80103dd9:	e8 52 08 00 00       	call   80104630 <release>
}
...
80103dfc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103dff:	e8 9c 06 00 00       	call   801044a0 <pushcli>
  c = mycpu();
80103e04:	e8 67 f9 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103e09:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e0f:	e8 cc 06 00 00       	call   801044e0 <popcli>
  if(p == 0)
...
80103e30:	e8 3b 07 00 00       	call   80104570 <acquire>
    release(lk);
80103e35:	89 34 24             	mov    %esi,(%esp)
80103e38:	e8 f3 07 00 00       	call   80104630 <release>
  p->chan = chan;
...
80103e5a:	e8 d1 07 00 00       	call   80104630 <release>
    acquire(lk);
...
80103e6b:	5d                   	pop    %ebp
    acquire(lk);
80103e6c:	e9 ff 06 00 00       	jmp    80104570 <acquire>
...
80103e99:	68 c4 76 10 80       	push   $0x801076c4
80103e9e:	e8 ed c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103ea3:	83 ec 0c             	sub    $0xc,%esp
80103ea6:	68 be 76 10 80       	push   $0x801076be
...
80103eb4:	53                   	push   %ebx
  pushcli();
80103eb5:	e8 e6 05 00 00       	call   801044a0 <pushcli>
  c = mycpu();
80103eba:	e8 b1 f8 ff ff       	call   80103770 <mycpu>
  p = c->proc;
80103ebf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ec5:	e8 16 06 00 00       	call   801044e0 <popcli>
  acquire(&ptable.lock);
80103eca:	83 ec 0c             	sub    $0xc,%esp
80103ecd:	68 20 2d 11 80       	push   $0x80112d20
80103ed2:	e8 99 06 00 00       	call   80104570 <acquire>
...
80103f3e:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103f41:	e8 ca e3 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
80103f46:	5a                   	pop    %edx
...
80103f4a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f51:	e8 4a 2e 00 00       	call   80106da0 <freevm>
        release(&ptable.lock);
...
80103f76:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f7d:	e8 ae 06 00 00       	call   80104630 <release>
        return pid;
...
80103f9b:	e8 90 06 00 00       	call   80104630 <release>
      return -1;
...
80104012:	72 e2                	jb     80103ff6 <waitx+0x46>
    if(!havekids || curproc->killed){
80104014:	85 c0                	test   %eax,%eax
80104016:	0f 84 9f 00 00 00    	je     801040bb <waitx+0x10b>
8010401c:	8b 46 24             	mov    0x24(%esi),%eax
8010401f:	85 c0                	test   %eax,%eax
80104021:	0f 85 94 00 00 00    	jne    801040bb <waitx+0x10b>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80104027:	83 ec 08             	sub    $0x8,%esp
8010402a:	68 20 2d 11 80       	push   $0x80112d20
8010402f:	56                   	push   %esi
80104030:	e8 bb fd ff ff       	call   80103df0 <sleep>
    havekids = 0;
80104035:	83 c4 10             	add    $0x10,%esp
80104038:	eb a0                	jmp    80103fda <waitx+0x2a>
...
80104046:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104049:	e8 c2 e2 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
8010404e:	5a                   	pop    %edx
...
80104052:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104059:	e8 42 2d 00 00       	call   80106da0 <freevm>
        *rtime = p->run_time; // Assignment
8010405e:	8b 93 84 00 00 00    	mov    0x84(%ebx),%edx
80104064:	8b 45 0c             	mov    0xc(%ebp),%eax
        p->pid = 0;
80104067:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
8010406e:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80104075:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80104079:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
...
8010408f:	2b 53 7c             	sub    0x7c(%ebx),%edx
80104092:	2b 93 88 00 00 00    	sub    0x88(%ebx),%edx
80104098:	8b 45 08             	mov    0x8(%ebp),%eax
8010409b:	2b 93 84 00 00 00    	sub    0x84(%ebx),%edx
801040a1:	89 10                	mov    %edx,(%eax)
        release(&ptable.lock);
...
801040bb:	83 ec 0c             	sub    $0xc,%esp
      return -1;
801040be:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801040c3:	68 20 2d 11 80       	push   $0x80112d20
801040c8:	e8 63 05 00 00       	call   80104630 <release>
      return -1;
801040cd:	83 c4 10             	add    $0x10,%esp
801040d0:	eb e0                	jmp    801040b2 <waitx+0x102>
...
80104134:	c9                   	leave  
  release(&ptable.lock);
80104135:	e9 f6 04 00 00       	jmp    80104630 <release>
...
8010414f:	e8 1c 04 00 00       	call   80104570 <acquire>
...
8010418d:	e8 9e 04 00 00       	call   80104630 <release>
      return 0;
...
801041a8:	e8 83 04 00 00       	call   80104630 <release>
  return -1;
...
80104201:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104204:	ba d5 76 10 80       	mov    $0x801076d5,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104209:	77 11                	ja     8010421c <procdump+0x5c>
8010420b:	8b 14 85 34 77 10 80 	mov    -0x7fef88cc(,%eax,4),%edx
      state = "???";
80104212:	b8 d5 76 10 80       	mov    $0x801076d5,%eax
...
80104224:	68 d9 76 10 80       	push   $0x801076d9
...
8010424b:	e8 00 02 00 00       	call   80104450 <getcallerpcs>
...
80104269:	68 01 71 10 80       	push   $0x80107101
...
80104290 <modify_times>:

void modify_times()
{
80104290:	55                   	push   %ebp
80104291:	89 e5                	mov    %esp,%ebp
80104293:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);
80104296:	68 20 2d 11 80       	push   $0x80112d20
8010429b:	e8 d0 02 00 00       	call   80104570 <acquire>
801042a0:	83 c4 10             	add    $0x10,%esp
  struct proc* p;
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042a3:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801042a8:	eb 1e                	jmp    801042c8 <modify_times+0x38>
...
801042b0:	83 fa 02             	cmp    $0x2,%edx
801042b3:	75 07                	jne    801042bc <modify_times+0x2c>
      {
          p -> sleep_time++;
801042b5:	83 80 88 00 00 00 01 	addl   $0x1,0x88(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042bc:	05 8c 00 00 00       	add    $0x8c,%eax
801042c1:	3d 54 50 11 80       	cmp    $0x80115054,%eax
801042c6:	73 1b                	jae    801042e3 <modify_times+0x53>
      if(p -> state == RUNNING)
801042c8:	8b 50 0c             	mov    0xc(%eax),%edx
801042cb:	83 fa 04             	cmp    $0x4,%edx
801042ce:	75 e0                	jne    801042b0 <modify_times+0x20>
          p -> run_time++;
801042d0:	83 80 84 00 00 00 01 	addl   $0x1,0x84(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042d7:	05 8c 00 00 00       	add    $0x8c,%eax
801042dc:	3d 54 50 11 80       	cmp    $0x80115054,%eax
801042e1:	72 e5                	jb     801042c8 <modify_times+0x38>
      }
    // } 
  } 
  release(&ptable.lock);
...
801042eb:	e8 40 03 00 00       	call   80104630 <release>
...
8010430a:	68 4c 77 10 80       	push   $0x8010774c
...
80104365:	e8 86 fa ff ff       	call   80103df0 <sleep>
  while (lk->locked) {
...
80104373:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104379:	e8 92 f4 ff ff       	call   80103810 <myproc>
...
801043c4:	e8 17 fd ff ff       	call   801040e0 <wakeup>
  release(&lk->lk);
...
80104403:	e8 08 f4 ff ff       	call   80103810 <myproc>
...
801044bf:	e8 ac f2 ff ff       	call   80103770 <mycpu>
801044c4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801044ca:	e8 a1 f2 ff ff       	call   80103770 <mycpu>
...
8010450c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104510:	e8 5b f2 ff ff       	call   80103770 <mycpu>
...
80104525:	68 57 77 10 80       	push   $0x80107757
8010452a:	e8 61 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010452f:	83 ec 0c             	sub    $0xc,%esp
80104532:	68 6e 77 10 80       	push   $0x8010776e
...
80104558:	e8 13 f2 ff ff       	call   80103770 <mycpu>
...
801045b4:	e8 b7 f1 ff ff       	call   80103770 <mycpu>
...
80104617:	68 75 77 10 80       	push   $0x80107775
...
8010466c:	68 7d 77 10 80       	push   $0x8010777d
...
80104985:	e8 86 ee ff ff       	call   80103810 <myproc>
...
80104993:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104996:	e8 75 ee ff ff       	call   80103810 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801049d8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801049db:	e8 30 ee ff ff       	call   80103810 <myproc>
...
80104a74:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104a77:	e8 94 ed ff ff       	call   80103810 <myproc>
...
80104a8c:	8b 14 85 c0 77 10 80 	mov    -0x7fef8840(,%eax,4),%edx
...
80104ab0:	68 85 77 10 80       	push   $0x80107785
...
80104c04:	68 38 78 10 80       	push   $0x80107838
...
80104c1c:	68 37 78 10 80       	push   $0x80107837
...
80104c35:	68 2b 78 10 80       	push   $0x8010782b
...
80104c4a:	68 3a 78 10 80       	push   $0x8010783a
80104c4f:	e8 3c b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c54:	83 ec 0c             	sub    $0xc,%esp
80104c57:	68 1c 78 10 80       	push   $0x8010781c
...
80104c94:	e8 77 eb ff ff       	call   80103810 <myproc>
...
80104cd9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104cdb:	e8 30 eb ff ff       	call   80103810 <myproc>
...
80105049:	58                   	pop    %eax
8010504a:	5a                   	pop    %edx
8010504b:	68 38 78 10 80       	push   $0x80107838
...
80105064:	68 37 78 10 80       	push   $0x80107837
...
8010525f:	0f 84 a6 00 00 00    	je     8010530b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105265:	e8 a6 e5 ff ff       	call   80103810 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010560f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105611:	e8 fa e1 ff ff       	call   80103810 <myproc>
...
80105637:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010563a:	e8 d1 e1 ff ff       	call   80103810 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056c3:	83 ec 08             	sub    $0x8,%esp
  exit();
801056c6:	e8 95 e5 ff ff       	call   80103c60 <exit>
...
801056d3:	5d                   	pop    %ebp
  return wait();
801056d4:	e9 d7 e7 ff ff       	jmp    80103eb0 <wait>
...
801056ee:	e8 dd f2 ff ff       	call   801049d0 <argptr>
801056f3:	83 c4 10             	add    $0x10,%esp
801056f6:	85 c0                	test   %eax,%eax
801056f8:	78 2e                	js     80105728 <sys_waitx+0x48>
  {
    return -1;
  }
...
80105700:	6a 04                	push   $0x4
80105702:	50                   	push   %eax
80105703:	6a 01                	push   $0x1
80105705:	e8 c6 f2 ff ff       	call   801049d0 <argptr>
8010570a:	83 c4 10             	add    $0x10,%esp
8010570d:	85 c0                	test   %eax,%eax
8010570f:	78 17                	js     80105728 <sys_waitx+0x48>
  {
    return -1;
  }
...
80105717:	ff 75 f0             	pushl  -0x10(%ebp)
8010571a:	e8 91 e8 ff ff       	call   80103fb0 <waitx>
...
8010573c:	e8 3f f2 ff ff       	call   80104980 <argint>
...
8010574e:	e8 ed e9 ff ff       	call   80104140 <kill>
...
801057f5:	e8 76 ed ff ff       	call   80104570 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057fa:	8b 55 f4             	mov    -0xc(%ebp),%edx
801057fd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105800:	8b 1d a0 58 11 80    	mov    0x801158a0,%ebx
  while(ticks - ticks0 < n){
...
80105818:	68 a0 58 11 80       	push   $0x801158a0
8010581d:	e8 ce e5 ff ff       	call   80103df0 <sleep>
  while(ticks - ticks0 < n){
80105822:	a1 a0 58 11 80       	mov    0x801158a0,%eax
...
80105840:	68 60 50 11 80       	push   $0x80115060
...
80105863:	68 60 50 11 80       	push   $0x80115060
...
80105884:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105887:	68 60 50 11 80       	push   $0x80115060
8010588c:	e8 df ec ff ff       	call   80104570 <acquire>
  xticks = ticks;
80105891:	8b 1d a0 58 11 80    	mov    0x801158a0,%ebx
  release(&tickslock);
80105897:	c7 04 24 60 50 11 80 	movl   $0x80115060,(%esp)
...
801058e7:	c7 04 c5 a2 50 11 80 	movl   $0x8e000008,-0x7feeaf5e(,%eax,8)
801058ee:	08 00 00 8e 
801058f2:	66 89 14 c5 a0 50 11 	mov    %dx,-0x7feeaf60(,%eax,8)
801058f9:	80 
801058fa:	c1 ea 10             	shr    $0x10,%edx
801058fd:	66 89 14 c5 a6 50 11 	mov    %dx,-0x7feeaf5a(,%eax,8)
80105904:	80 
  for(i = 0; i < 256; i++)
...
80105914:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105917:	c7 05 a2 52 11 80 08 	movl   $0xef000008,0x801152a2
8010591e:	00 00 ef 
  initlock(&tickslock, "time");
80105921:	68 7d 78 10 80       	push   $0x8010787d
80105926:	68 60 50 11 80       	push   $0x80115060
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010592b:	66 a3 a0 52 11 80    	mov    %ax,0x801152a0
80105931:	c1 e8 10             	shr    $0x10,%eax
80105934:	66 a3 a6 52 11 80    	mov    %ax,0x801152a6
  initlock(&tickslock, "time");
8010593a:	e8 f1 ea ff ff       	call   80104430 <initlock>
}
...
8010595b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010595f:	b8 a0 50 11 80       	mov    $0x801150a0,%eax
...
80105992:	0f 84 b8 00 00 00    	je     80105a50 <trap+0xd0>
    if(myproc()->killed)
      exit();
    return;
  }
...
801059a0:	ff 24 85 24 79 10 80 	jmp    *-0x7fef86dc(,%eax,4)
...
801059b0:	e8 5b de ff ff       	call   80103810 <myproc>
801059b5:	85 c0                	test   %eax,%eax
801059b7:	8b 5f 38             	mov    0x38(%edi),%ebx
801059ba:	0f 84 a2 01 00 00    	je     80105b62 <trap+0x1e2>
801059c0:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
801059c4:	0f 84 98 01 00 00    	je     80105b62 <trap+0x1e2>
...
801059d0:	e8 1b de ff ff       	call   801037f0 <cpuid>
...
801059e9:	e8 22 de ff ff       	call   80103810 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105a05:	68 e0 78 10 80       	push   $0x801078e0
...
80105a1e:	e8 ed dd ff ff       	call   80103810 <myproc>
80105a23:	85 c0                	test   %eax,%eax
80105a25:	74 19                	je     80105a40 <trap+0xc0>
80105a27:	e8 e4 dd ff ff       	call   80103810 <myproc>
80105a2c:	8b 40 24             	mov    0x24(%eax),%eax
80105a2f:	85 c0                	test   %eax,%eax
80105a31:	74 0d                	je     80105a40 <trap+0xc0>
80105a33:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105a37:	83 e0 03             	and    $0x3,%eax
80105a3a:	66 83 f8 03          	cmp    $0x3,%ax
80105a3e:	74 39                	je     80105a79 <trap+0xf9>
...
80105a40:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105a43:	5b                   	pop    %ebx
80105a44:	5e                   	pop    %esi
80105a45:	5f                   	pop    %edi
80105a46:	5d                   	pop    %ebp
...
80105a55:	8b 48 24             	mov    0x24(%eax),%ecx
80105a58:	85 c9                	test   %ecx,%ecx
80105a5a:	0f 85 f8 00 00 00    	jne    80105b58 <trap+0x1d8>
    myproc()->tf = tf;
80105a60:	e8 ab dd ff ff       	call   80103810 <myproc>
80105a65:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105a68:	e8 03 f0 ff ff       	call   80104a70 <syscall>
    if(myproc()->killed)
80105a6d:	e8 9e dd ff ff       	call   80103810 <myproc>
80105a72:	8b 50 24             	mov    0x24(%eax),%edx
80105a75:	85 d2                	test   %edx,%edx
80105a77:	74 c7                	je     80105a40 <trap+0xc0>
}
...
80105a7f:	5d                   	pop    %ebp
      exit();
80105a80:	e9 db e1 ff ff       	jmp    80103c60 <exit>
80105a85:	8d 76 00             	lea    0x0(%esi),%esi
    ideintr();
80105a88:	e8 f3 c5 ff ff       	call   80102080 <ideintr>
    lapiceoi();
80105a8d:	e8 be cc ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a92:	e8 79 dd ff ff       	call   80103810 <myproc>
80105a97:	85 c0                	test   %eax,%eax
80105a99:	75 8c                	jne    80105a27 <trap+0xa7>
80105a9b:	eb a3                	jmp    80105a40 <trap+0xc0>
80105a9d:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105aa0:	e8 4b dd ff ff       	call   801037f0 <cpuid>
80105aa5:	85 c0                	test   %eax,%eax
80105aa7:	75 e4                	jne    80105a8d <trap+0x10d>
      acquire(&tickslock);
80105aa9:	83 ec 0c             	sub    $0xc,%esp
80105aac:	68 60 50 11 80       	push   $0x80115060
80105ab1:	e8 ba ea ff ff       	call   80104570 <acquire>
      wakeup(&ticks);
80105ab6:	c7 04 24 a0 58 11 80 	movl   $0x801158a0,(%esp)
      ticks++;
80105abd:	83 05 a0 58 11 80 01 	addl   $0x1,0x801158a0
      wakeup(&ticks);
80105ac4:	e8 17 e6 ff ff       	call   801040e0 <wakeup>
      modify_times();
80105ac9:	e8 c2 e7 ff ff       	call   80104290 <modify_times>
      release(&tickslock);      
80105ace:	c7 04 24 60 50 11 80 	movl   $0x80115060,(%esp)
80105ad5:	e8 56 eb ff ff       	call   80104630 <release>
80105ada:	83 c4 10             	add    $0x10,%esp
80105add:	eb ae                	jmp    80105a8d <trap+0x10d>
80105adf:	90                   	nop
    kbdintr();
80105ae0:	e8 2b cb ff ff       	call   80102610 <kbdintr>
    lapiceoi();
80105ae5:	e8 66 cc ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105aea:	e8 21 dd ff ff       	call   80103810 <myproc>
80105aef:	85 c0                	test   %eax,%eax
80105af1:	0f 85 30 ff ff ff    	jne    80105a27 <trap+0xa7>
80105af7:	e9 44 ff ff ff       	jmp    80105a40 <trap+0xc0>
80105afc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105b00:	e8 fb 01 00 00       	call   80105d00 <uartintr>
    lapiceoi();
80105b05:	e8 46 cc ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b0a:	e8 01 dd ff ff       	call   80103810 <myproc>
80105b0f:	85 c0                	test   %eax,%eax
80105b11:	0f 85 10 ff ff ff    	jne    80105a27 <trap+0xa7>
80105b17:	e9 24 ff ff ff       	jmp    80105a40 <trap+0xc0>
80105b1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105b20:	0f b7 5f 3c          	movzwl 0x3c(%edi),%ebx
80105b24:	8b 77 38             	mov    0x38(%edi),%esi
80105b27:	e8 c4 dc ff ff       	call   801037f0 <cpuid>
80105b2c:	56                   	push   %esi
80105b2d:	53                   	push   %ebx
80105b2e:	50                   	push   %eax
80105b2f:	68 88 78 10 80       	push   $0x80107888
80105b34:	e8 27 ab ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105b39:	e8 12 cc ff ff       	call   80102750 <lapiceoi>
    break;
80105b3e:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b41:	e8 ca dc ff ff       	call   80103810 <myproc>
80105b46:	85 c0                	test   %eax,%eax
80105b48:	0f 85 d9 fe ff ff    	jne    80105a27 <trap+0xa7>
80105b4e:	e9 ed fe ff ff       	jmp    80105a40 <trap+0xc0>
80105b53:	90                   	nop
80105b54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      exit();
80105b58:	e8 03 e1 ff ff       	call   80103c60 <exit>
80105b5d:	e9 fe fe ff ff       	jmp    80105a60 <trap+0xe0>
80105b62:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105b65:	e8 86 dc ff ff       	call   801037f0 <cpuid>
80105b6a:	83 ec 0c             	sub    $0xc,%esp
80105b6d:	56                   	push   %esi
80105b6e:	53                   	push   %ebx
80105b6f:	50                   	push   %eax
80105b70:	ff 77 30             	pushl  0x30(%edi)
80105b73:	68 ac 78 10 80       	push   $0x801078ac
80105b78:	e8 e3 aa ff ff       	call   80100660 <cprintf>
      panic("trap");
80105b7d:	83 c4 14             	add    $0x14,%esp
80105b80:	68 82 78 10 80       	push   $0x80107882
...
80105c7c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c7f:	bb a4 79 10 80       	mov    $0x801079a4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105d17:	6a 00                	push   $0x0
  jmp alltraps
80105d19:	e9 8c fb ff ff       	jmp    801058aa <alltraps>
...
80105d20:	6a 01                	push   $0x1
  jmp alltraps
80105d22:	e9 83 fb ff ff       	jmp    801058aa <alltraps>
...
80105d29:	6a 02                	push   $0x2
  jmp alltraps
80105d2b:	e9 7a fb ff ff       	jmp    801058aa <alltraps>
...
80105d32:	6a 03                	push   $0x3
  jmp alltraps
80105d34:	e9 71 fb ff ff       	jmp    801058aa <alltraps>
...
80105d3b:	6a 04                	push   $0x4
  jmp alltraps
80105d3d:	e9 68 fb ff ff       	jmp    801058aa <alltraps>
...
80105d44:	6a 05                	push   $0x5
  jmp alltraps
80105d46:	e9 5f fb ff ff       	jmp    801058aa <alltraps>
...
80105d4d:	6a 06                	push   $0x6
  jmp alltraps
80105d4f:	e9 56 fb ff ff       	jmp    801058aa <alltraps>
...
80105d56:	6a 07                	push   $0x7
  jmp alltraps
80105d58:	e9 4d fb ff ff       	jmp    801058aa <alltraps>
...
80105d5d:	6a 08                	push   $0x8
  jmp alltraps
80105d5f:	e9 46 fb ff ff       	jmp    801058aa <alltraps>
...
80105d66:	6a 09                	push   $0x9
  jmp alltraps
80105d68:	e9 3d fb ff ff       	jmp    801058aa <alltraps>
...
80105d6d:	6a 0a                	push   $0xa
  jmp alltraps
80105d6f:	e9 36 fb ff ff       	jmp    801058aa <alltraps>
...
80105d74:	6a 0b                	push   $0xb
  jmp alltraps
80105d76:	e9 2f fb ff ff       	jmp    801058aa <alltraps>
...
80105d7b:	6a 0c                	push   $0xc
  jmp alltraps
80105d7d:	e9 28 fb ff ff       	jmp    801058aa <alltraps>
...
80105d82:	6a 0d                	push   $0xd
  jmp alltraps
80105d84:	e9 21 fb ff ff       	jmp    801058aa <alltraps>
...
80105d89:	6a 0e                	push   $0xe
  jmp alltraps
80105d8b:	e9 1a fb ff ff       	jmp    801058aa <alltraps>
...
80105d92:	6a 0f                	push   $0xf
  jmp alltraps
80105d94:	e9 11 fb ff ff       	jmp    801058aa <alltraps>
...
80105d9b:	6a 10                	push   $0x10
  jmp alltraps
80105d9d:	e9 08 fb ff ff       	jmp    801058aa <alltraps>
...
80105da2:	6a 11                	push   $0x11
  jmp alltraps
80105da4:	e9 01 fb ff ff       	jmp    801058aa <alltraps>
...
80105dab:	6a 12                	push   $0x12
  jmp alltraps
80105dad:	e9 f8 fa ff ff       	jmp    801058aa <alltraps>
...
80105db4:	6a 13                	push   $0x13
  jmp alltraps
80105db6:	e9 ef fa ff ff       	jmp    801058aa <alltraps>
...
80105dbd:	6a 14                	push   $0x14
  jmp alltraps
80105dbf:	e9 e6 fa ff ff       	jmp    801058aa <alltraps>
...
80105dc6:	6a 15                	push   $0x15
  jmp alltraps
80105dc8:	e9 dd fa ff ff       	jmp    801058aa <alltraps>
...
80105dcf:	6a 16                	push   $0x16
  jmp alltraps
80105dd1:	e9 d4 fa ff ff       	jmp    801058aa <alltraps>
...
80105dd8:	6a 17                	push   $0x17
  jmp alltraps
80105dda:	e9 cb fa ff ff       	jmp    801058aa <alltraps>
...
80105de1:	6a 18                	push   $0x18
  jmp alltraps
80105de3:	e9 c2 fa ff ff       	jmp    801058aa <alltraps>
...
80105dea:	6a 19                	push   $0x19
  jmp alltraps
80105dec:	e9 b9 fa ff ff       	jmp    801058aa <alltraps>
...
80105df3:	6a 1a                	push   $0x1a
  jmp alltraps
80105df5:	e9 b0 fa ff ff       	jmp    801058aa <alltraps>
...
80105dfc:	6a 1b                	push   $0x1b
  jmp alltraps
80105dfe:	e9 a7 fa ff ff       	jmp    801058aa <alltraps>
...
80105e05:	6a 1c                	push   $0x1c
  jmp alltraps
80105e07:	e9 9e fa ff ff       	jmp    801058aa <alltraps>
...
80105e0e:	6a 1d                	push   $0x1d
  jmp alltraps
80105e10:	e9 95 fa ff ff       	jmp    801058aa <alltraps>
...
80105e17:	6a 1e                	push   $0x1e
  jmp alltraps
80105e19:	e9 8c fa ff ff       	jmp    801058aa <alltraps>
...
80105e20:	6a 1f                	push   $0x1f
  jmp alltraps
80105e22:	e9 83 fa ff ff       	jmp    801058aa <alltraps>
...
80105e29:	6a 20                	push   $0x20
  jmp alltraps
80105e2b:	e9 7a fa ff ff       	jmp    801058aa <alltraps>
...
80105e32:	6a 21                	push   $0x21
  jmp alltraps
80105e34:	e9 71 fa ff ff       	jmp    801058aa <alltraps>
...
80105e3b:	6a 22                	push   $0x22
  jmp alltraps
80105e3d:	e9 68 fa ff ff       	jmp    801058aa <alltraps>
...
80105e44:	6a 23                	push   $0x23
  jmp alltraps
80105e46:	e9 5f fa ff ff       	jmp    801058aa <alltraps>
...
80105e4d:	6a 24                	push   $0x24
  jmp alltraps
80105e4f:	e9 56 fa ff ff       	jmp    801058aa <alltraps>
...
80105e56:	6a 25                	push   $0x25
  jmp alltraps
80105e58:	e9 4d fa ff ff       	jmp    801058aa <alltraps>
...
80105e5f:	6a 26                	push   $0x26
  jmp alltraps
80105e61:	e9 44 fa ff ff       	jmp    801058aa <alltraps>
...
80105e68:	6a 27                	push   $0x27
  jmp alltraps
80105e6a:	e9 3b fa ff ff       	jmp    801058aa <alltraps>
...
80105e71:	6a 28                	push   $0x28
  jmp alltraps
80105e73:	e9 32 fa ff ff       	jmp    801058aa <alltraps>
...
80105e7a:	6a 29                	push   $0x29
  jmp alltraps
80105e7c:	e9 29 fa ff ff       	jmp    801058aa <alltraps>
...
80105e83:	6a 2a                	push   $0x2a
  jmp alltraps
80105e85:	e9 20 fa ff ff       	jmp    801058aa <alltraps>
...
80105e8c:	6a 2b                	push   $0x2b
  jmp alltraps
80105e8e:	e9 17 fa ff ff       	jmp    801058aa <alltraps>
...
80105e95:	6a 2c                	push   $0x2c
  jmp alltraps
80105e97:	e9 0e fa ff ff       	jmp    801058aa <alltraps>
...
80105e9e:	6a 2d                	push   $0x2d
  jmp alltraps
80105ea0:	e9 05 fa ff ff       	jmp    801058aa <alltraps>
...
80105ea7:	6a 2e                	push   $0x2e
  jmp alltraps
80105ea9:	e9 fc f9 ff ff       	jmp    801058aa <alltraps>
...
80105eb0:	6a 2f                	push   $0x2f
  jmp alltraps
80105eb2:	e9 f3 f9 ff ff       	jmp    801058aa <alltraps>
...
80105eb9:	6a 30                	push   $0x30
  jmp alltraps
80105ebb:	e9 ea f9 ff ff       	jmp    801058aa <alltraps>
...
80105ec2:	6a 31                	push   $0x31
  jmp alltraps
80105ec4:	e9 e1 f9 ff ff       	jmp    801058aa <alltraps>
...
80105ecb:	6a 32                	push   $0x32
  jmp alltraps
80105ecd:	e9 d8 f9 ff ff       	jmp    801058aa <alltraps>
...
80105ed4:	6a 33                	push   $0x33
  jmp alltraps
80105ed6:	e9 cf f9 ff ff       	jmp    801058aa <alltraps>
...
80105edd:	6a 34                	push   $0x34
  jmp alltraps
80105edf:	e9 c6 f9 ff ff       	jmp    801058aa <alltraps>
...
80105ee6:	6a 35                	push   $0x35
  jmp alltraps
80105ee8:	e9 bd f9 ff ff       	jmp    801058aa <alltraps>
...
80105eef:	6a 36                	push   $0x36
  jmp alltraps
80105ef1:	e9 b4 f9 ff ff       	jmp    801058aa <alltraps>
...
80105ef8:	6a 37                	push   $0x37
  jmp alltraps
80105efa:	e9 ab f9 ff ff       	jmp    801058aa <alltraps>
...
80105f01:	6a 38                	push   $0x38
  jmp alltraps
80105f03:	e9 a2 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f0a:	6a 39                	push   $0x39
  jmp alltraps
80105f0c:	e9 99 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f13:	6a 3a                	push   $0x3a
  jmp alltraps
80105f15:	e9 90 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f1c:	6a 3b                	push   $0x3b
  jmp alltraps
80105f1e:	e9 87 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f25:	6a 3c                	push   $0x3c
  jmp alltraps
80105f27:	e9 7e f9 ff ff       	jmp    801058aa <alltraps>
...
80105f2e:	6a 3d                	push   $0x3d
  jmp alltraps
80105f30:	e9 75 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f37:	6a 3e                	push   $0x3e
  jmp alltraps
80105f39:	e9 6c f9 ff ff       	jmp    801058aa <alltraps>
...
80105f40:	6a 3f                	push   $0x3f
  jmp alltraps
80105f42:	e9 63 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f49:	6a 40                	push   $0x40
  jmp alltraps
80105f4b:	e9 5a f9 ff ff       	jmp    801058aa <alltraps>
...
80105f52:	6a 41                	push   $0x41
  jmp alltraps
80105f54:	e9 51 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f5b:	6a 42                	push   $0x42
  jmp alltraps
80105f5d:	e9 48 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f64:	6a 43                	push   $0x43
  jmp alltraps
80105f66:	e9 3f f9 ff ff       	jmp    801058aa <alltraps>
...
80105f6d:	6a 44                	push   $0x44
  jmp alltraps
80105f6f:	e9 36 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f76:	6a 45                	push   $0x45
  jmp alltraps
80105f78:	e9 2d f9 ff ff       	jmp    801058aa <alltraps>
...
80105f7f:	6a 46                	push   $0x46
  jmp alltraps
80105f81:	e9 24 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f88:	6a 47                	push   $0x47
  jmp alltraps
80105f8a:	e9 1b f9 ff ff       	jmp    801058aa <alltraps>
...
80105f91:	6a 48                	push   $0x48
  jmp alltraps
80105f93:	e9 12 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f9a:	6a 49                	push   $0x49
  jmp alltraps
80105f9c:	e9 09 f9 ff ff       	jmp    801058aa <alltraps>
...
80105fa3:	6a 4a                	push   $0x4a
  jmp alltraps
80105fa5:	e9 00 f9 ff ff       	jmp    801058aa <alltraps>
...
80105fac:	6a 4b                	push   $0x4b
  jmp alltraps
80105fae:	e9 f7 f8 ff ff       	jmp    801058aa <alltraps>
...
80105fb5:	6a 4c                	push   $0x4c
  jmp alltraps
80105fb7:	e9 ee f8 ff ff       	jmp    801058aa <alltraps>
...
80105fbe:	6a 4d                	push   $0x4d
  jmp alltraps
80105fc0:	e9 e5 f8 ff ff       	jmp    801058aa <alltraps>
...
80105fc7:	6a 4e                	push   $0x4e
  jmp alltraps
80105fc9:	e9 dc f8 ff ff       	jmp    801058aa <alltraps>
...
80105fd0:	6a 4f                	push   $0x4f
  jmp alltraps
80105fd2:	e9 d3 f8 ff ff       	jmp    801058aa <alltraps>
...
80105fd9:	6a 50                	push   $0x50
  jmp alltraps
80105fdb:	e9 ca f8 ff ff       	jmp    801058aa <alltraps>
...
80105fe2:	6a 51                	push   $0x51
  jmp alltraps
80105fe4:	e9 c1 f8 ff ff       	jmp    801058aa <alltraps>
...
80105feb:	6a 52                	push   $0x52
  jmp alltraps
80105fed:	e9 b8 f8 ff ff       	jmp    801058aa <alltraps>
...
80105ff4:	6a 53                	push   $0x53
  jmp alltraps
80105ff6:	e9 af f8 ff ff       	jmp    801058aa <alltraps>
...
80105ffd:	6a 54                	push   $0x54
  jmp alltraps
80105fff:	e9 a6 f8 ff ff       	jmp    801058aa <alltraps>
...
80106006:	6a 55                	push   $0x55
  jmp alltraps
80106008:	e9 9d f8 ff ff       	jmp    801058aa <alltraps>
...
8010600f:	6a 56                	push   $0x56
  jmp alltraps
80106011:	e9 94 f8 ff ff       	jmp    801058aa <alltraps>
...
80106018:	6a 57                	push   $0x57
  jmp alltraps
8010601a:	e9 8b f8 ff ff       	jmp    801058aa <alltraps>
...
80106021:	6a 58                	push   $0x58
  jmp alltraps
80106023:	e9 82 f8 ff ff       	jmp    801058aa <alltraps>
...
8010602a:	6a 59                	push   $0x59
  jmp alltraps
8010602c:	e9 79 f8 ff ff       	jmp    801058aa <alltraps>
...
80106033:	6a 5a                	push   $0x5a
  jmp alltraps
80106035:	e9 70 f8 ff ff       	jmp    801058aa <alltraps>
...
8010603c:	6a 5b                	push   $0x5b
  jmp alltraps
8010603e:	e9 67 f8 ff ff       	jmp    801058aa <alltraps>
...
80106045:	6a 5c                	push   $0x5c
  jmp alltraps
80106047:	e9 5e f8 ff ff       	jmp    801058aa <alltraps>
...
8010604e:	6a 5d                	push   $0x5d
  jmp alltraps
80106050:	e9 55 f8 ff ff       	jmp    801058aa <alltraps>
...
80106057:	6a 5e                	push   $0x5e
  jmp alltraps
80106059:	e9 4c f8 ff ff       	jmp    801058aa <alltraps>
...
80106060:	6a 5f                	push   $0x5f
  jmp alltraps
80106062:	e9 43 f8 ff ff       	jmp    801058aa <alltraps>
...
80106069:	6a 60                	push   $0x60
  jmp alltraps
8010606b:	e9 3a f8 ff ff       	jmp    801058aa <alltraps>
...
80106072:	6a 61                	push   $0x61
  jmp alltraps
80106074:	e9 31 f8 ff ff       	jmp    801058aa <alltraps>
...
8010607b:	6a 62                	push   $0x62
  jmp alltraps
8010607d:	e9 28 f8 ff ff       	jmp    801058aa <alltraps>
...
80106084:	6a 63                	push   $0x63
  jmp alltraps
80106086:	e9 1f f8 ff ff       	jmp    801058aa <alltraps>
...
8010608d:	6a 64                	push   $0x64
  jmp alltraps
8010608f:	e9 16 f8 ff ff       	jmp    801058aa <alltraps>
...
80106096:	6a 65                	push   $0x65
  jmp alltraps
80106098:	e9 0d f8 ff ff       	jmp    801058aa <alltraps>
...
8010609f:	6a 66                	push   $0x66
  jmp alltraps
801060a1:	e9 04 f8 ff ff       	jmp    801058aa <alltraps>
...
801060a8:	6a 67                	push   $0x67
  jmp alltraps
801060aa:	e9 fb f7 ff ff       	jmp    801058aa <alltraps>
...
801060b1:	6a 68                	push   $0x68
  jmp alltraps
801060b3:	e9 f2 f7 ff ff       	jmp    801058aa <alltraps>
...
801060ba:	6a 69                	push   $0x69
  jmp alltraps
801060bc:	e9 e9 f7 ff ff       	jmp    801058aa <alltraps>
...
801060c3:	6a 6a                	push   $0x6a
  jmp alltraps
801060c5:	e9 e0 f7 ff ff       	jmp    801058aa <alltraps>
...
801060cc:	6a 6b                	push   $0x6b
  jmp alltraps
801060ce:	e9 d7 f7 ff ff       	jmp    801058aa <alltraps>
...
801060d5:	6a 6c                	push   $0x6c
  jmp alltraps
801060d7:	e9 ce f7 ff ff       	jmp    801058aa <alltraps>
...
801060de:	6a 6d                	push   $0x6d
  jmp alltraps
801060e0:	e9 c5 f7 ff ff       	jmp    801058aa <alltraps>
...
801060e7:	6a 6e                	push   $0x6e
  jmp alltraps
801060e9:	e9 bc f7 ff ff       	jmp    801058aa <alltraps>
...
801060f0:	6a 6f                	push   $0x6f
  jmp alltraps
801060f2:	e9 b3 f7 ff ff       	jmp    801058aa <alltraps>
...
801060f9:	6a 70                	push   $0x70
  jmp alltraps
801060fb:	e9 aa f7 ff ff       	jmp    801058aa <alltraps>
...
80106102:	6a 71                	push   $0x71
  jmp alltraps
80106104:	e9 a1 f7 ff ff       	jmp    801058aa <alltraps>
...
8010610b:	6a 72                	push   $0x72
  jmp alltraps
8010610d:	e9 98 f7 ff ff       	jmp    801058aa <alltraps>
...
80106114:	6a 73                	push   $0x73
  jmp alltraps
80106116:	e9 8f f7 ff ff       	jmp    801058aa <alltraps>
...
8010611d:	6a 74                	push   $0x74
  jmp alltraps
8010611f:	e9 86 f7 ff ff       	jmp    801058aa <alltraps>
...
80106126:	6a 75                	push   $0x75
  jmp alltraps
80106128:	e9 7d f7 ff ff       	jmp    801058aa <alltraps>
...
8010612f:	6a 76                	push   $0x76
  jmp alltraps
80106131:	e9 74 f7 ff ff       	jmp    801058aa <alltraps>
...
80106138:	6a 77                	push   $0x77
  jmp alltraps
8010613a:	e9 6b f7 ff ff       	jmp    801058aa <alltraps>
...
80106141:	6a 78                	push   $0x78
  jmp alltraps
80106143:	e9 62 f7 ff ff       	jmp    801058aa <alltraps>
...
8010614a:	6a 79                	push   $0x79
  jmp alltraps
8010614c:	e9 59 f7 ff ff       	jmp    801058aa <alltraps>
...
80106153:	6a 7a                	push   $0x7a
  jmp alltraps
80106155:	e9 50 f7 ff ff       	jmp    801058aa <alltraps>
...
8010615c:	6a 7b                	push   $0x7b
  jmp alltraps
8010615e:	e9 47 f7 ff ff       	jmp    801058aa <alltraps>
...
80106165:	6a 7c                	push   $0x7c
  jmp alltraps
80106167:	e9 3e f7 ff ff       	jmp    801058aa <alltraps>
...
8010616e:	6a 7d                	push   $0x7d
  jmp alltraps
80106170:	e9 35 f7 ff ff       	jmp    801058aa <alltraps>
...
80106177:	6a 7e                	push   $0x7e
  jmp alltraps
80106179:	e9 2c f7 ff ff       	jmp    801058aa <alltraps>
...
80106180:	6a 7f                	push   $0x7f
  jmp alltraps
80106182:	e9 23 f7 ff ff       	jmp    801058aa <alltraps>
...
80106189:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010618e:	e9 17 f7 ff ff       	jmp    801058aa <alltraps>
...
80106195:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010619a:	e9 0b f7 ff ff       	jmp    801058aa <alltraps>
...
801061a1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801061a6:	e9 ff f6 ff ff       	jmp    801058aa <alltraps>
...
801061ad:	68 83 00 00 00       	push   $0x83
  jmp alltraps
801061b2:	e9 f3 f6 ff ff       	jmp    801058aa <alltraps>
...
801061b9:	68 84 00 00 00       	push   $0x84
  jmp alltraps
801061be:	e9 e7 f6 ff ff       	jmp    801058aa <alltraps>
...
801061c5:	68 85 00 00 00       	push   $0x85
  jmp alltraps
801061ca:	e9 db f6 ff ff       	jmp    801058aa <alltraps>
...
801061d1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801061d6:	e9 cf f6 ff ff       	jmp    801058aa <alltraps>
...
801061dd:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801061e2:	e9 c3 f6 ff ff       	jmp    801058aa <alltraps>
...
801061e9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801061ee:	e9 b7 f6 ff ff       	jmp    801058aa <alltraps>
...
801061f5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801061fa:	e9 ab f6 ff ff       	jmp    801058aa <alltraps>
...
80106201:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106206:	e9 9f f6 ff ff       	jmp    801058aa <alltraps>
...
8010620d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106212:	e9 93 f6 ff ff       	jmp    801058aa <alltraps>
...
80106219:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010621e:	e9 87 f6 ff ff       	jmp    801058aa <alltraps>
...
80106225:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010622a:	e9 7b f6 ff ff       	jmp    801058aa <alltraps>
...
80106231:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106236:	e9 6f f6 ff ff       	jmp    801058aa <alltraps>
...
8010623d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106242:	e9 63 f6 ff ff       	jmp    801058aa <alltraps>
...
80106249:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010624e:	e9 57 f6 ff ff       	jmp    801058aa <alltraps>
...
80106255:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010625a:	e9 4b f6 ff ff       	jmp    801058aa <alltraps>
...
80106261:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106266:	e9 3f f6 ff ff       	jmp    801058aa <alltraps>
...
8010626d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106272:	e9 33 f6 ff ff       	jmp    801058aa <alltraps>
...
80106279:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010627e:	e9 27 f6 ff ff       	jmp    801058aa <alltraps>
...
80106285:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010628a:	e9 1b f6 ff ff       	jmp    801058aa <alltraps>
...
80106291:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106296:	e9 0f f6 ff ff       	jmp    801058aa <alltraps>
...
8010629d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801062a2:	e9 03 f6 ff ff       	jmp    801058aa <alltraps>
...
801062a9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801062ae:	e9 f7 f5 ff ff       	jmp    801058aa <alltraps>
...
801062b5:	68 99 00 00 00       	push   $0x99
  jmp alltraps
801062ba:	e9 eb f5 ff ff       	jmp    801058aa <alltraps>
...
801062c1:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
801062c6:	e9 df f5 ff ff       	jmp    801058aa <alltraps>
...
801062cd:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801062d2:	e9 d3 f5 ff ff       	jmp    801058aa <alltraps>
...
801062d9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801062de:	e9 c7 f5 ff ff       	jmp    801058aa <alltraps>
...
801062e5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801062ea:	e9 bb f5 ff ff       	jmp    801058aa <alltraps>
...
801062f1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801062f6:	e9 af f5 ff ff       	jmp    801058aa <alltraps>
...
801062fd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106302:	e9 a3 f5 ff ff       	jmp    801058aa <alltraps>
...
80106309:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010630e:	e9 97 f5 ff ff       	jmp    801058aa <alltraps>
...
80106315:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010631a:	e9 8b f5 ff ff       	jmp    801058aa <alltraps>
...
80106321:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106326:	e9 7f f5 ff ff       	jmp    801058aa <alltraps>
...
8010632d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106332:	e9 73 f5 ff ff       	jmp    801058aa <alltraps>
...
80106339:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010633e:	e9 67 f5 ff ff       	jmp    801058aa <alltraps>
...
80106345:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010634a:	e9 5b f5 ff ff       	jmp    801058aa <alltraps>
...
80106351:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106356:	e9 4f f5 ff ff       	jmp    801058aa <alltraps>
...
8010635d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106362:	e9 43 f5 ff ff       	jmp    801058aa <alltraps>
...
80106369:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010636e:	e9 37 f5 ff ff       	jmp    801058aa <alltraps>
...
80106375:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010637a:	e9 2b f5 ff ff       	jmp    801058aa <alltraps>
...
80106381:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106386:	e9 1f f5 ff ff       	jmp    801058aa <alltraps>
...
8010638d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106392:	e9 13 f5 ff ff       	jmp    801058aa <alltraps>
...
80106399:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010639e:	e9 07 f5 ff ff       	jmp    801058aa <alltraps>
...
801063a5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801063aa:	e9 fb f4 ff ff       	jmp    801058aa <alltraps>
...
801063b1:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
801063b6:	e9 ef f4 ff ff       	jmp    801058aa <alltraps>
...
801063bd:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
801063c2:	e9 e3 f4 ff ff       	jmp    801058aa <alltraps>
...
801063c9:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
801063ce:	e9 d7 f4 ff ff       	jmp    801058aa <alltraps>
...
801063d5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801063da:	e9 cb f4 ff ff       	jmp    801058aa <alltraps>
...
801063e1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801063e6:	e9 bf f4 ff ff       	jmp    801058aa <alltraps>
...
801063ed:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801063f2:	e9 b3 f4 ff ff       	jmp    801058aa <alltraps>
...
801063f9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801063fe:	e9 a7 f4 ff ff       	jmp    801058aa <alltraps>
...
80106405:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010640a:	e9 9b f4 ff ff       	jmp    801058aa <alltraps>
...
80106411:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106416:	e9 8f f4 ff ff       	jmp    801058aa <alltraps>
...
8010641d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106422:	e9 83 f4 ff ff       	jmp    801058aa <alltraps>
...
80106429:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010642e:	e9 77 f4 ff ff       	jmp    801058aa <alltraps>
...
80106435:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010643a:	e9 6b f4 ff ff       	jmp    801058aa <alltraps>
...
80106441:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106446:	e9 5f f4 ff ff       	jmp    801058aa <alltraps>
...
8010644d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106452:	e9 53 f4 ff ff       	jmp    801058aa <alltraps>
...
80106459:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010645e:	e9 47 f4 ff ff       	jmp    801058aa <alltraps>
...
80106465:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010646a:	e9 3b f4 ff ff       	jmp    801058aa <alltraps>
...
80106471:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106476:	e9 2f f4 ff ff       	jmp    801058aa <alltraps>
...
8010647d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106482:	e9 23 f4 ff ff       	jmp    801058aa <alltraps>
...
80106489:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010648e:	e9 17 f4 ff ff       	jmp    801058aa <alltraps>
...
80106495:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010649a:	e9 0b f4 ff ff       	jmp    801058aa <alltraps>
...
801064a1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801064a6:	e9 ff f3 ff ff       	jmp    801058aa <alltraps>
...
801064ad:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
801064b2:	e9 f3 f3 ff ff       	jmp    801058aa <alltraps>
...
801064b9:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
801064be:	e9 e7 f3 ff ff       	jmp    801058aa <alltraps>
...
801064c5:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
801064ca:	e9 db f3 ff ff       	jmp    801058aa <alltraps>
...
801064d1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801064d6:	e9 cf f3 ff ff       	jmp    801058aa <alltraps>
...
801064dd:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801064e2:	e9 c3 f3 ff ff       	jmp    801058aa <alltraps>
...
801064e9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801064ee:	e9 b7 f3 ff ff       	jmp    801058aa <alltraps>
...
801064f5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801064fa:	e9 ab f3 ff ff       	jmp    801058aa <alltraps>
...
80106501:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106506:	e9 9f f3 ff ff       	jmp    801058aa <alltraps>
...
8010650d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106512:	e9 93 f3 ff ff       	jmp    801058aa <alltraps>
...
80106519:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010651e:	e9 87 f3 ff ff       	jmp    801058aa <alltraps>
...
80106525:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010652a:	e9 7b f3 ff ff       	jmp    801058aa <alltraps>
...
80106531:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106536:	e9 6f f3 ff ff       	jmp    801058aa <alltraps>
...
8010653d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106542:	e9 63 f3 ff ff       	jmp    801058aa <alltraps>
...
80106549:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010654e:	e9 57 f3 ff ff       	jmp    801058aa <alltraps>
...
80106555:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010655a:	e9 4b f3 ff ff       	jmp    801058aa <alltraps>
...
80106561:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106566:	e9 3f f3 ff ff       	jmp    801058aa <alltraps>
...
8010656d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106572:	e9 33 f3 ff ff       	jmp    801058aa <alltraps>
...
80106579:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010657e:	e9 27 f3 ff ff       	jmp    801058aa <alltraps>
...
80106585:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010658a:	e9 1b f3 ff ff       	jmp    801058aa <alltraps>
...
80106591:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106596:	e9 0f f3 ff ff       	jmp    801058aa <alltraps>
...
8010659d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801065a2:	e9 03 f3 ff ff       	jmp    801058aa <alltraps>
...
801065a9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801065ae:	e9 f7 f2 ff ff       	jmp    801058aa <alltraps>
...
801065b5:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
801065ba:	e9 eb f2 ff ff       	jmp    801058aa <alltraps>
...
801065c1:	68 da 00 00 00       	push   $0xda
  jmp alltraps
801065c6:	e9 df f2 ff ff       	jmp    801058aa <alltraps>
...
801065cd:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801065d2:	e9 d3 f2 ff ff       	jmp    801058aa <alltraps>
...
801065d9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801065de:	e9 c7 f2 ff ff       	jmp    801058aa <alltraps>
...
801065e5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801065ea:	e9 bb f2 ff ff       	jmp    801058aa <alltraps>
...
801065f1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801065f6:	e9 af f2 ff ff       	jmp    801058aa <alltraps>
...
801065fd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106602:	e9 a3 f2 ff ff       	jmp    801058aa <alltraps>
...
80106609:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010660e:	e9 97 f2 ff ff       	jmp    801058aa <alltraps>
...
80106615:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010661a:	e9 8b f2 ff ff       	jmp    801058aa <alltraps>
...
80106621:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106626:	e9 7f f2 ff ff       	jmp    801058aa <alltraps>
...
8010662d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106632:	e9 73 f2 ff ff       	jmp    801058aa <alltraps>
...
80106639:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010663e:	e9 67 f2 ff ff       	jmp    801058aa <alltraps>
...
80106645:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010664a:	e9 5b f2 ff ff       	jmp    801058aa <alltraps>
...
80106651:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106656:	e9 4f f2 ff ff       	jmp    801058aa <alltraps>
...
8010665d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106662:	e9 43 f2 ff ff       	jmp    801058aa <alltraps>
...
80106669:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010666e:	e9 37 f2 ff ff       	jmp    801058aa <alltraps>
...
80106675:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010667a:	e9 2b f2 ff ff       	jmp    801058aa <alltraps>
...
80106681:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106686:	e9 1f f2 ff ff       	jmp    801058aa <alltraps>
...
8010668d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106692:	e9 13 f2 ff ff       	jmp    801058aa <alltraps>
...
80106699:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010669e:	e9 07 f2 ff ff       	jmp    801058aa <alltraps>
...
801066a5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801066aa:	e9 fb f1 ff ff       	jmp    801058aa <alltraps>
...
801066b1:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
801066b6:	e9 ef f1 ff ff       	jmp    801058aa <alltraps>
...
801066bd:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
801066c2:	e9 e3 f1 ff ff       	jmp    801058aa <alltraps>
...
801066c9:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
801066ce:	e9 d7 f1 ff ff       	jmp    801058aa <alltraps>
...
801066d5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801066da:	e9 cb f1 ff ff       	jmp    801058aa <alltraps>
...
801066e1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801066e6:	e9 bf f1 ff ff       	jmp    801058aa <alltraps>
...
801066ed:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801066f2:	e9 b3 f1 ff ff       	jmp    801058aa <alltraps>
...
801066f9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801066fe:	e9 a7 f1 ff ff       	jmp    801058aa <alltraps>
...
80106705:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010670a:	e9 9b f1 ff ff       	jmp    801058aa <alltraps>
...
80106711:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106716:	e9 8f f1 ff ff       	jmp    801058aa <alltraps>
...
8010671d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106722:	e9 83 f1 ff ff       	jmp    801058aa <alltraps>
...
80106729:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010672e:	e9 77 f1 ff ff       	jmp    801058aa <alltraps>
...
80106735:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010673a:	e9 6b f1 ff ff       	jmp    801058aa <alltraps>
...
80106741:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106746:	e9 5f f1 ff ff       	jmp    801058aa <alltraps>
...
8010674d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106752:	e9 53 f1 ff ff       	jmp    801058aa <alltraps>
...
80106759:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010675e:	e9 47 f1 ff ff       	jmp    801058aa <alltraps>
...
80106765:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010676a:	e9 3b f1 ff ff       	jmp    801058aa <alltraps>
...
80106771:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106776:	e9 2f f1 ff ff       	jmp    801058aa <alltraps>
...
8010677d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106782:	e9 23 f1 ff ff       	jmp    801058aa <alltraps>
...
801067ea:	e8 91 de ff ff       	call   80104680 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010688d:	68 ac 79 10 80       	push   $0x801079ac
...
80106943:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106946:	e8 a5 ce ff ff       	call   801037f0 <cpuid>
...
801069d0:	a1 a4 58 11 80       	mov    0x801158a4,%eax
{
...
80106a14:	0f 84 c2 00 00 00    	je     80106adc <switchuvm+0xec>
  pushcli();
80106a1a:	e8 81 da ff ff       	call   801044a0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106a1f:	e8 4c cd ff ff       	call   80103770 <mycpu>
80106a24:	89 c6                	mov    %eax,%esi
80106a26:	e8 45 cd ff ff       	call   80103770 <mycpu>
...
80106a38:	e8 33 cd ff ff       	call   80103770 <mycpu>
...
80106b2f:	e8 4c db ff ff       	call   80104680 <memset>
...
80106b69:	68 f1 79 10 80       	push   $0x801079f1
...
80106c8b:	e8 f0 d9 ff ff       	call   80104680 <memset>
...
80106ccd:	68 29 7a 10 80       	push   $0x80107a29
...
80106d03:	68 41 7a 10 80       	push   $0x80107a41
...
80106e0c:	68 5d 7a 10 80       	push   $0x80107a5d
...
80106e40:	e8 3b d8 ff ff       	call   80104680 <memset>
...
80106eab:	a3 a4 58 11 80       	mov    %eax,0x801158a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106edf:	68 6e 7a 10 80       	push   $0x80107a6e
...
80106f30:	e8 fb d7 ff ff       	call   80104730 <memmove>
...
80106fc9:	68 92 7a 10 80       	push   $0x80107a92
80106fce:	e8 bd 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80106fd3:	83 ec 0c             	sub    $0xc,%esp
80106fd6:	68 78 7a 10 80       	push   $0x80107a78
...
8010705f:	e8 cc d6 ff ff       	call   80104730 <memmove>
    len -= n;
    buf += n;
