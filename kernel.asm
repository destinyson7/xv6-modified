...
80100d34:	e8 47 5d 00 00       	call   80106a80 <switchuvm>
  freevm(oldpgdir);
80100d39:	89 3c 24             	mov    %edi,(%esp)
80100d3c:	e8 ef 60 00 00       	call   80106e30 <freevm>
  return 0;
...
80101173:	68 1f 72 10 80       	push   $0x8010721f
...
80101224:	68 32 72 10 80       	push   $0x80107232
...
80101265:	e8 26 34 00 00       	call   80104690 <memset>
  log_write(bp);
...
801012aa:	e8 d1 32 00 00       	call   80104580 <acquire>
...
8010130f:	e8 2c 33 00 00       	call   80104640 <release>
...
8010133a:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
8010133d:	e8 fe 32 00 00       	call   80104640 <release>
      return ip;
...
80101352:	68 48 72 10 80       	push   $0x80107248
...
80101427:	68 58 72 10 80       	push   $0x80107258
...
80101461:	e8 da 32 00 00       	call   80104740 <memmove>
  brelse(bp);
...
8010148c:	68 6b 72 10 80       	push   $0x8010726b
...
801014a3:	68 72 72 10 80       	push   $0x80107272
801014a8:	53                   	push   %ebx
801014a9:	81 c3 90 00 00 00    	add    $0x90,%ebx
801014af:	e8 5c 2e 00 00       	call   80104310 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801014f9:	68 d8 72 10 80       	push   $0x801072d8
...
8010158e:	e8 fd 30 00 00       	call   80104690 <memset>
      dip->type = type;
...
801015c3:	68 78 72 10 80       	push   $0x80107278
...
80101631:	e8 0a 31 00 00       	call   80104740 <memmove>
  log_write(bp);
...
8010165f:	e8 1c 2f 00 00       	call   80104580 <acquire>
  ip->ref++;
80101664:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101668:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010166f:	e8 cc 2f 00 00       	call   80104640 <release>
}
...
801016a2:	e8 a9 2c 00 00       	call   80104350 <acquiresleep>
  if(ip->valid == 0){
...
80101718:	e8 23 30 00 00       	call   80104740 <memmove>
    brelse(bp);
...
8010173d:	68 90 72 10 80       	push   $0x80107290
80101742:	e8 49 ec ff ff       	call   80100390 <panic>
    panic("ilock");
80101747:	83 ec 0c             	sub    $0xc,%esp
8010174a:	68 8a 72 10 80       	push   $0x8010728a
...
80101773:	e8 78 2c 00 00       	call   801043f0 <holdingsleep>
...
8010178e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010178f:	e9 1c 2c 00 00       	jmp    801043b0 <releasesleep>
    panic("iunlock");
80101794:	83 ec 0c             	sub    $0xc,%esp
80101797:	68 9f 72 10 80       	push   $0x8010729f
...
801017c0:	e8 8b 2b 00 00       	call   80104350 <acquiresleep>
...
801017da:	e8 d1 2b 00 00       	call   801043b0 <releasesleep>
  acquire(&icache.lock);
801017df:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801017e6:	e8 95 2d 00 00       	call   80104580 <acquire>
  ip->ref--;
...
801017ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101800:	e9 3b 2e 00 00       	jmp    80104640 <release>
80101805:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101808:	83 ec 0c             	sub    $0xc,%esp
8010180b:	68 e0 09 11 80       	push   $0x801109e0
80101810:	e8 6b 2d 00 00       	call   80104580 <acquire>
    int r = ip->ref;
80101815:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101818:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
8010181f:	e8 1c 2e 00 00       	call   80104640 <release>
    if(r == 1){
...
80101a05:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a07:	e8 34 2d 00 00       	call   80104740 <memmove>
    brelse(bp);
...
80101b03:	e8 38 2c 00 00       	call   80104740 <memmove>
    log_write(bp);
...
80101b9e:	e8 0d 2c 00 00       	call   801047b0 <strncmp>
}
80101ba3:	c9                   	leave  
80101ba4:	c3                   	ret    
...
80101bfd:	e8 ae 2b 00 00       	call   801047b0 <strncmp>
      continue;
...
80101c42:	68 b9 72 10 80       	push   $0x801072b9
80101c47:	e8 44 e7 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101c4c:	83 ec 0c             	sub    $0xc,%esp
80101c4f:	68 a7 72 10 80       	push   $0x801072a7
...
80101c89:	e8 f2 28 00 00       	call   80104580 <acquire>
  ip->ref++;
80101c8e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c92:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101c99:	e8 a2 29 00 00       	call   80104640 <release>
...
80101cf5:	e8 46 2a 00 00       	call   80104740 <memmove>
    path++;
...
80101d88:	e8 b3 29 00 00       	call   80104740 <memmove>
    name[len] = 0;
...
80101e7d:	e8 8e 29 00 00       	call   80104810 <strncpy>
  de.inum = inum;
...
80101ebb:	68 c8 72 10 80       	push   $0x801072c8
80101ec0:	e8 cb e4 ff ff       	call   80100390 <panic>
    panic("dirlink");
80101ec5:	83 ec 0c             	sub    $0xc,%esp
80101ec8:	68 c2 78 10 80       	push   $0x801078c2
...
80101fdb:	68 34 73 10 80       	push   $0x80107334
80101fe0:	e8 ab e3 ff ff       	call   80100390 <panic>
    panic("idestart");
80101fe5:	83 ec 0c             	sub    $0xc,%esp
80101fe8:	68 2b 73 10 80       	push   $0x8010732b
...
80102006:	68 46 73 10 80       	push   $0x80107346
8010200b:	68 80 a5 10 80       	push   $0x8010a580
80102010:	e8 2b 24 00 00       	call   80104440 <initlock>
...
8010208e:	e8 ed 24 00 00       	call   80104580 <acquire>
...
8010210f:	e8 2c 25 00 00       	call   80104640 <release>
...
8010212e:	e8 bd 22 00 00       	call   801043f0 <holdingsleep>
...
80102168:	e8 13 24 00 00       	call   80104580 <acquire>
...
801021fa:	68 60 73 10 80       	push   $0x80107360
801021ff:	e8 8c e1 ff ff       	call   80100390 <panic>
    panic("iderw: buf not locked");
80102204:	83 ec 0c             	sub    $0xc,%esp
80102207:	68 4a 73 10 80       	push   $0x8010734a
8010220c:	e8 7f e1 ff ff       	call   80100390 <panic>
    panic("iderw: ide disk 1 not present");
80102211:	83 ec 0c             	sub    $0xc,%esp
80102214:	68 75 73 10 80       	push   $0x80107375
...
80102267:	68 94 73 10 80       	push   $0x80107394
...
80102342:	e8 49 23 00 00       	call   80104690 <memset>
...
8010237a:	c9                   	leave  
    release(&kmem.lock);
8010237b:	e9 c0 22 00 00       	jmp    80104640 <release>
    acquire(&kmem.lock);
80102380:	83 ec 0c             	sub    $0xc,%esp
80102383:	68 40 26 11 80       	push   $0x80112640
80102388:	e8 f3 21 00 00       	call   80104580 <acquire>
8010238d:	83 c4 10             	add    $0x10,%esp
80102390:	eb c2                	jmp    80102354 <kfree+0x44>
    panic("kfree");
80102392:	83 ec 0c             	sub    $0xc,%esp
80102395:	68 c6 73 10 80       	push   $0x801073c6
...
801023fb:	68 cc 73 10 80       	push   $0x801073cc
80102400:	68 40 26 11 80       	push   $0x80112640
80102405:	e8 36 20 00 00       	call   80104440 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024f3:	e8 88 20 00 00       	call   80104580 <acquire>
  r = kmem.freelist;
...
80102521:	e8 1a 21 00 00       	call   80104640 <release>
  return (char*)r;
...
80102573:	0f b6 82 00 75 10 80 	movzbl -0x7fef8b00(%edx),%eax
8010257a:	09 c1                	or     %eax,%ecx
  shift ^= togglecode[data];
8010257c:	0f b6 82 00 74 10 80 	movzbl -0x7fef8c00(%edx),%eax
...
80102590:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
80102593:	8b 04 85 e0 73 10 80 	mov    -0x7fef8c20(,%eax,4),%eax
...
801025b5:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801025b8:	0f b6 82 00 75 10 80 	movzbl -0x7fef8b00(%edx),%eax
...
80102937:	e8 a4 1d 00 00       	call   801046e0 <memcmp>
...
80102a64:	e8 d7 1c 00 00       	call   80104740 <memmove>
...
80102b0a:	68 00 76 10 80       	push   $0x80107600
80102b0f:	68 80 26 11 80       	push   $0x80112680
80102b14:	e8 27 19 00 00       	call   80104440 <initlock>
  readsb(dev, &sb);
80102b19:	58                   	pop    %eax
...
80102bab:	e8 d0 19 00 00       	call   80104580 <acquire>
...
80102bfc:	e8 3f 1a 00 00       	call   80104640 <release>
      break;
    }
  }
}
...
80102c1e:	e8 5d 19 00 00       	call   80104580 <acquire>
  log.outstanding -= 1;
...
80102c5c:	e8 df 19 00 00       	call   80104640 <release>
}
...
80102cb6:	e8 85 1a 00 00       	call   80104740 <memmove>
...
80102cff:	e8 7c 18 00 00       	call   80104580 <acquire>
    wakeup(&log);
...
80102d21:	e8 1a 19 00 00       	call   80104640 <release>
...
80102d4c:	e8 ef 18 00 00       	call   80104640 <release>
...
80102d5f:	68 04 76 10 80       	push   $0x80107604
...
80102dae:	e8 cd 17 00 00       	call   80104580 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dfc:	c9                   	leave  
  release(&log.lock);
80102dfd:	e9 3e 18 00 00       	jmp    80104640 <release>
...
80102e29:	68 13 76 10 80       	push   $0x80107613
80102e2e:	e8 5d d5 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102e33:	83 ec 0c             	sub    $0xc,%esp
80102e36:	68 29 76 10 80       	push   $0x80107629
...
80102e58:	68 44 76 10 80       	push   $0x80107644
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 d5 3b 00 00       	call   80106a60 <switchkvm>
  seginit();
80102e8b:	e8 40 3b 00 00       	call   801069d0 <seginit>
  lapicinit();
...
80102ec1:	e8 6a 40 00 00       	call   80106f30 <kvmalloc>
  mpinit();        // detect other processors
80102ec6:	e8 75 01 00 00       	call   80103040 <mpinit>
  lapicinit();     // interrupt controller
80102ecb:	e8 60 f7 ff ff       	call   80102630 <lapicinit>
  seginit();       // segment descriptors
80102ed0:	e8 fb 3a 00 00       	call   801069d0 <seginit>
  picinit();       // disable pic
...
80102ee4:	e8 b7 2d 00 00       	call   80105ca0 <uartinit>
  pinit();         // process table
...
80102f14:	e8 27 18 00 00       	call   80104740 <memmove>
...
80102fee:	68 58 76 10 80       	push   $0x80107658
80102ff3:	56                   	push   %esi
80102ff4:	e8 e7 16 00 00       	call   801046e0 <memcmp>
...
801030ac:	68 75 76 10 80       	push   $0x80107675
801030b1:	56                   	push   %esi
801030b2:	e8 29 16 00 00       	call   801046e0 <memcmp>
...
80103140:	ff 24 95 9c 76 10 80 	jmp    *-0x7fef8964(,%edx,4)
...
801031f3:	68 5d 76 10 80       	push   $0x8010765d
801031f8:	e8 93 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
801031fd:	83 ec 0c             	sub    $0xc,%esp
80103200:	68 7c 76 10 80       	push   $0x8010767c
...
80103301:	e8 3a 11 00 00       	call   80104440 <initlock>
  (*f0)->type = FD_PIPE;
...
8010335f:	e8 1c 12 00 00       	call   80104580 <acquire>
  if(writable){
...
801033a3:	5d                   	pop    %ebp
    release(&p->lock);
801033a4:	e9 97 12 00 00       	jmp    80104640 <release>
...
801033d4:	e8 67 12 00 00       	call   80104640 <release>
    kfree((char*)p);
...
801033fd:	e8 7e 11 00 00       	call   80104580 <acquire>
  for(i = 0; i < n; i++){
...
801034eb:	e8 50 11 00 00       	call   80104640 <release>
  return n;
...
80103510:	e8 6b 10 00 00       	call   80104580 <acquire>
...
8010357e:	e8 bd 10 00 00       	call   80104640 <release>
      return -1;
...
801035df:	e8 5c 10 00 00       	call   80104640 <release>
  return i;
...
80103611:	e8 6a 0f 00 00       	call   80104580 <acquire>
...
80103689:	e8 b2 0f 00 00       	call   80104640 <release>
...
801036ab:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
801036ae:	c7 40 14 d2 58 10 80 	movl   $0x801058d2,0x14(%eax)
  p->context = (struct context*)sp;
...
801036bd:	e8 ce 0f 00 00       	call   80104690 <memset>
...
801036ea:	e8 51 0f 00 00       	call   80104640 <release>
}
...
8010371b:	e8 20 0f 00 00       	call   80104640 <release>
...
80103766:	68 b5 76 10 80       	push   $0x801076b5
8010376b:	68 20 2d 11 80       	push   $0x80112d20
80103770:	e8 cb 0c 00 00       	call   80104440 <initlock>
}
...
80103824:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103827:	e8 84 0c 00 00       	call   801044b0 <pushcli>
  c = mycpu();
8010382c:	e8 4f ff ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103831:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103837:	e8 b4 0c 00 00       	call   801044f0 <popcli>
}
...
80103863:	e8 48 36 00 00       	call   80106eb0 <setupkvm>
...
80103881:	e8 0a 33 00 00       	call   80106b90 <inituvm>
...
80103896:	e8 f5 0d 00 00       	call   80104690 <memset>
...
801038ef:	68 e5 76 10 80       	push   $0x801076e5
801038f4:	50                   	push   %eax
801038f5:	e8 76 0f 00 00       	call   80104870 <safestrcpy>
  p->cwd = namei("/");
801038fa:	c7 04 24 ee 76 10 80 	movl   $0x801076ee,(%esp)
...
80103933:	68 cc 76 10 80       	push   $0x801076cc
...
80103945:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103948:	e8 63 0b 00 00       	call   801044b0 <pushcli>
  c = mycpu();
8010394d:	e8 2e fe ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103952:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103958:	e8 93 0b 00 00       	call   801044f0 <popcli>
  if(n > 0){
...
8010396c:	e8 0f 31 00 00       	call   80106a80 <switchuvm>
  return 0;
...
8010398a:	e8 41 33 00 00       	call   80106cd0 <allocuvm>
...
801039aa:	e8 51 34 00 00       	call   80106e00 <deallocuvm>
...
801039c6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801039c9:	e8 e2 0a 00 00       	call   801044b0 <pushcli>
  c = mycpu();
801039ce:	e8 ad fd ff ff       	call   80103780 <mycpu>
  p = c->proc;
801039d3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039d9:	e8 12 0b 00 00       	call   801044f0 <popcli>
  if((np = allocproc()) == 0){
...
801039f8:	e8 83 35 00 00       	call   80106f80 <copyuvm>
...
80103a71:	e8 fa 0d 00 00       	call   80104870 <safestrcpy>
  pid = np->pid;
80103a76:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a79:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a80:	e8 fb 0a 00 00       	call   80104580 <acquire>
  np->state = RUNNABLE;
...
80103b0b:	e8 70 0a 00 00       	call   80104580 <acquire>
...
80103b20:	8b 97 8c 00 00 00    	mov    0x8c(%edi),%edx
80103b26:	39 90 8c 00 00 00    	cmp    %edx,0x8c(%eax)
...
80103b5a:	74 33                	je     80103b8f <scheduler+0xaf>
...
80103b66:	e8 15 2f 00 00       	call   80106a80 <switchuvm>
      proc_with_highest_priority->state = RUNNING;
80103b6b:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), proc_with_highest_priority->context);
80103b72:	58                   	pop    %eax
80103b73:	5a                   	pop    %edx
80103b74:	ff 77 1c             	pushl  0x1c(%edi)
80103b77:	56                   	push   %esi
80103b78:	e8 4e 0d 00 00       	call   801048cb <swtch>
      switchkvm();
80103b7d:	e8 de 2e 00 00       	call   80106a60 <switchkvm>
      c->proc = 0;
...
80103b97:	e8 a4 0a 00 00       	call   80104640 <release>
  for(;;){
80103b9c:	83 c4 10             	add    $0x10,%esp
80103b9f:	e9 5c ff ff ff       	jmp    80103b00 <scheduler+0x20>
...
80103c13:	e8 b3 0c 00 00       	call   801048cb <swtch>
  mycpu()->intena = intena;
...
80103c76:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c79:	e8 32 08 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103c7e:	e8 fd fa ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103c83:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c89:	e8 62 08 00 00       	call   801044f0 <popcli>
  if(curproc == initproc)
...
80103ce2:	e8 99 08 00 00       	call   80104580 <acquire>
...
80103cfd:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
80103d1b:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
80103d36:	81 fa 54 51 11 80    	cmp    $0x80115154,%edx
...
80103d5d:	3d 54 51 11 80       	cmp    $0x80115154,%eax
...
80103d78:	a1 a0 59 11 80       	mov    0x801159a0,%eax
...
80103d92:	68 3d 77 10 80       	push   $0x8010773d
80103d97:	e8 f4 c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d9c:	83 ec 0c             	sub    $0xc,%esp
80103d9f:	68 30 77 10 80       	push   $0x80107730
...
80103dbc:	e8 bf 07 00 00       	call   80104580 <acquire>
  pushcli();
80103dc1:	e8 ea 06 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103dc6:	e8 b5 f9 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103dcb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103dd1:	e8 1a 07 00 00       	call   801044f0 <popcli>
...
80103e0c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103e0f:	e8 9c 06 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103e14:	e8 67 f9 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103e19:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e1f:	e8 cc 06 00 00       	call   801044f0 <popcli>
  if(p == 0)
...
80103e40:	e8 3b 07 00 00       	call   80104580 <acquire>
    release(lk);
80103e45:	89 34 24             	mov    %esi,(%esp)
80103e48:	e8 f3 07 00 00       	call   80104640 <release>
  p->chan = chan;
...
80103e6a:	e8 d1 07 00 00       	call   80104640 <release>
    acquire(lk);
...
80103e7b:	5d                   	pop    %ebp
    acquire(lk);
80103e7c:	e9 ff 06 00 00       	jmp    80104580 <acquire>
...
80103ea9:	68 4f 77 10 80       	push   $0x8010774f
80103eae:	e8 dd c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103eb3:	83 ec 0c             	sub    $0xc,%esp
80103eb6:	68 49 77 10 80       	push   $0x80107749
...
80103ec4:	53                   	push   %ebx
  pushcli();
80103ec5:	e8 e6 05 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103eca:	e8 b1 f8 ff ff       	call   80103780 <mycpu>
  p = c->proc;
...
80103ee2:	e8 99 06 00 00       	call   80104580 <acquire>
...
80103ef8:	81 c3 90 00 00 00    	add    $0x90,%ebx
80103efe:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
...
80103f0f:	74 37                	je     80103f48 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f11:	81 c3 90 00 00 00    	add    $0x90,%ebx
      havekids = 1;
80103f17:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f1c:	81 fb 54 51 11 80    	cmp    $0x80115154,%ebx
...
80103f5a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f61:	e8 ca 2e 00 00       	call   80106e30 <freevm>
        release(&ptable.lock);
...
80103f86:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f8d:	e8 ae 06 00 00       	call   80104640 <release>
        return pid;
...
80103fab:	e8 90 06 00 00       	call   80104640 <release>
      return -1;
...
80103fc4:	53                   	push   %ebx
  pushcli();
80103fc5:	e8 e6 04 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103fca:	e8 b1 f7 ff ff       	call   80103780 <mycpu>
  p = c->proc;
80103fcf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103fd5:	e8 16 05 00 00       	call   801044f0 <popcli>
  acquire(&ptable.lock);
80103fda:	83 ec 0c             	sub    $0xc,%esp
80103fdd:	68 20 2d 11 80       	push   $0x80112d20
80103fe2:	e8 99 05 00 00       	call   80104580 <acquire>
...
80104026:	0f 84 9f 00 00 00    	je     801040cb <waitx+0x10b>
8010402c:	8b 46 24             	mov    0x24(%esi),%eax
8010402f:	85 c0                	test   %eax,%eax
80104031:	0f 85 94 00 00 00    	jne    801040cb <waitx+0x10b>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
...
80104056:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104059:	e8 b2 e2 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
8010405e:	5a                   	pop    %edx
...
80104062:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104069:	e8 c2 2d 00 00       	call   80106e30 <freevm>
        *rtime = p->run_time; // Assignment
8010406e:	8b 93 84 00 00 00    	mov    0x84(%ebx),%edx
80104074:	8b 45 0c             	mov    0xc(%ebp),%eax
        p->pid = 0;
80104077:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
8010407e:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80104085:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80104089:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80104090:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        *rtime = p->run_time; // Assignment
80104097:	89 10                	mov    %edx,(%eax)
        *wtime = (p->end_time - p->start_time) - (p->run_time + p->sleep_time); // Assignment
80104099:	8b 93 80 00 00 00    	mov    0x80(%ebx),%edx
8010409f:	2b 53 7c             	sub    0x7c(%ebx),%edx
801040a2:	2b 93 88 00 00 00    	sub    0x88(%ebx),%edx
801040a8:	8b 45 08             	mov    0x8(%ebp),%eax
801040ab:	2b 93 84 00 00 00    	sub    0x84(%ebx),%edx
...
801040cb:	83 ec 0c             	sub    $0xc,%esp
      return -1;
801040ce:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801040d3:	68 20 2d 11 80       	push   $0x80112d20
801040d8:	e8 63 05 00 00       	call   80104640 <release>
      return -1;
801040dd:	83 c4 10             	add    $0x10,%esp
801040e0:	eb e0                	jmp    801040c2 <waitx+0x102>
...
801040ff:	e8 7c 04 00 00       	call   80104580 <acquire>
...
80104144:	c9                   	leave  
  release(&ptable.lock);
80104145:	e9 f6 04 00 00       	jmp    80104640 <release>
...
8010419d:	e8 9e 04 00 00       	call   80104640 <release>
      return 0;
...
801041b8:	e8 83 04 00 00       	call   80104640 <release>
  return -1;
...
801041eb:	68 db 7a 10 80       	push   $0x80107adb
...
80104211:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104214:	ba 60 77 10 80       	mov    $0x80107760,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104219:	77 11                	ja     8010422c <procdump+0x5c>
8010421b:	8b 14 85 c0 77 10 80 	mov    -0x7fef8840(,%eax,4),%edx
      state = "???";
80104222:	b8 60 77 10 80       	mov    $0x80107760,%eax
...
80104234:	68 64 77 10 80       	push   $0x80107764
...
8010425b:	e8 00 02 00 00       	call   80104460 <getcallerpcs>
...
80104279:	68 a1 71 10 80       	push   $0x801071a1
...
801042ab:	e8 d0 02 00 00       	call   80104580 <acquire>
801042b0:	83 c4 10             	add    $0x10,%esp
  struct proc* p;
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042b3:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
801042b8:	eb 1e                	jmp    801042d8 <modify_times+0x38>
...
801042c0:	83 fa 02             	cmp    $0x2,%edx
801042c3:	75 07                	jne    801042cc <modify_times+0x2c>
      {
          p -> sleep_time++;
...
801042d6:	73 1b                	jae    801042f3 <modify_times+0x53>
      if(p -> state == RUNNING)
801042d8:	8b 50 0c             	mov    0xc(%eax),%edx
801042db:	83 fa 04             	cmp    $0x4,%edx
801042de:	75 e0                	jne    801042c0 <modify_times+0x20>
          p -> run_time++;
801042e0:	83 80 84 00 00 00 01 	addl   $0x1,0x84(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042e7:	05 90 00 00 00       	add    $0x90,%eax
801042ec:	3d 54 51 11 80       	cmp    $0x80115154,%eax
801042f1:	72 e5                	jb     801042d8 <modify_times+0x38>
      }
    // } 
  } 
  release(&ptable.lock);
...
801042fb:	e8 40 03 00 00       	call   80104640 <release>
...
8010431a:	68 d8 77 10 80       	push   $0x801077d8
...
80104375:	e8 86 fa ff ff       	call   80103e00 <sleep>
  while (lk->locked) {
...
80104383:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104389:	e8 92 f4 ff ff       	call   80103820 <myproc>
...
801043d4:	e8 17 fd ff ff       	call   801040f0 <wakeup>
  release(&lk->lk);
...
80104413:	e8 08 f4 ff ff       	call   80103820 <myproc>
...
801044b9:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
801044ba:	e8 c1 f2 ff ff       	call   80103780 <mycpu>
...
801044cf:	e8 ac f2 ff ff       	call   80103780 <mycpu>
...
8010451c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104520:	e8 5b f2 ff ff       	call   80103780 <mycpu>
...
80104535:	68 e3 77 10 80       	push   $0x801077e3
8010453a:	e8 51 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010453f:	83 ec 0c             	sub    $0xc,%esp
80104542:	68 fa 77 10 80       	push   $0x801077fa
...
80104568:	e8 13 f2 ff ff       	call   80103780 <mycpu>
...
801045c4:	e8 b7 f1 ff ff       	call   80103780 <mycpu>
...
80104627:	68 01 78 10 80       	push   $0x80107801
...
8010467c:	68 09 78 10 80       	push   $0x80107809
...
801048e7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801048ea:	e8 31 ef ff ff       	call   80103820 <myproc>
...
80104995:	e8 86 ee ff ff       	call   80103820 <myproc>
...
801049a3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049a6:	e8 75 ee ff ff       	call   80103820 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
801049e8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801049eb:	e8 30 ee ff ff       	call   80103820 <myproc>
...
80104a84:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104a87:	e8 94 ed ff ff       	call   80103820 <myproc>
...
80104a9c:	8b 14 85 40 78 10 80 	mov    -0x7fef87c0(,%eax,4),%edx
...
80104ac0:	68 11 78 10 80       	push   $0x80107811
...
80104af7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104afa:	e8 01 d4 ff ff       	call   80101f00 <nameiparent>
...
80104b10:	e8 6b cb ff ff       	call   80101680 <ilock>
...
80104b1c:	e8 8f d0 ff ff       	call   80101bb0 <dirlookup>
...
80104b2e:	e8 dd cd ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80104b33:	89 3c 24             	mov    %edi,(%esp)
80104b36:	e8 45 cb ff ff       	call   80101680 <ilock>
...
80104b6a:	e8 a1 c9 ff ff       	call   80101510 <ialloc>
...
80104ba1:	e8 2a ca ff ff       	call   801015d0 <iupdate>
...
80104bb8:	e8 63 d2 ff ff       	call   80101e20 <dirlink>
...
80104bcc:	e8 3f cd ff ff       	call   80101910 <iunlockput>
  return ip;
...
80104be4:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
80104be6:	e8 25 cd ff ff       	call   80101910 <iunlockput>
    return 0;
...
80104c09:	e8 c2 c9 ff ff       	call   801015d0 <iupdate>
...
80104c1a:	e8 01 d2 ff ff       	call   80101e20 <dirlink>
...
80104c32:	e8 e9 d1 ff ff       	call   80101e20 <dirlink>
...
80104c45:	68 ab 78 10 80       	push   $0x801078ab
...
80104c5a:	68 ba 78 10 80       	push   $0x801078ba
80104c5f:	e8 2c b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c64:	83 ec 0c             	sub    $0xc,%esp
80104c67:	68 9c 78 10 80       	push   $0x8010789c
...
80104ca4:	e8 77 eb ff ff       	call   80103820 <myproc>
...
80104e33:	78 2b                	js     80104e60 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104e35:	e8 e6 e9 ff ff       	call   80103820 <myproc>
...
80104ef2:	0f 88 e2 00 00 00    	js     80104fda <sys_link+0x11a>
  begin_op();
80104ef8:	e8 a3 dc ff ff       	call   80102ba0 <begin_op>
  if((ip = namei(old)) == 0){
80104efd:	83 ec 0c             	sub    $0xc,%esp
80104f00:	ff 75 d4             	pushl  -0x2c(%ebp)
80104f03:	e8 d8 cf ff ff       	call   80101ee0 <namei>
...
80104f38:	e8 93 c6 ff ff       	call   801015d0 <iupdate>
  iunlock(ip);
80104f3d:	89 1c 24             	mov    %ebx,(%esp)
80104f40:	e8 1b c8 ff ff       	call   80101760 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104f45:	58                   	pop    %eax
80104f46:	5a                   	pop    %edx
80104f47:	57                   	push   %edi
80104f48:	ff 75 d0             	pushl  -0x30(%ebp)
80104f4b:	e8 b0 cf ff ff       	call   80101f00 <nameiparent>
...
80104f73:	e8 a8 ce ff ff       	call   80101e20 <dirlink>
...
80104f83:	e8 88 c9 ff ff       	call   80101910 <iunlockput>
  iput(ip);
80104f88:	89 1c 24             	mov    %ebx,(%esp)
80104f8b:	e8 20 c8 ff ff       	call   801017b0 <iput>
  end_op();
...
80104ffd:	eb 9b                	jmp    80104f9a <sys_link+0xda>
    end_op();
80104fff:	e8 0c dc ff ff       	call   80102c10 <end_op>
    return -1;
...
8010502f:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80105032:	e8 69 db ff ff       	call   80102ba0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105037:	83 ec 08             	sub    $0x8,%esp
8010503a:	53                   	push   %ebx
8010503b:	ff 75 c0             	pushl  -0x40(%ebp)
8010503e:	e8 bd ce ff ff       	call   80101f00 <nameiparent>
...
80105054:	e8 27 c6 ff ff       	call   80101680 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105059:	58                   	pop    %eax
8010505a:	5a                   	pop    %edx
8010505b:	68 b8 78 10 80       	push   $0x801078b8
80105060:	53                   	push   %ebx
80105061:	e8 2a cb ff ff       	call   80101b90 <namecmp>
...
80105074:	68 b7 78 10 80       	push   $0x801078b7
80105079:	53                   	push   %ebx
8010507a:	e8 11 cb ff ff       	call   80101b90 <namecmp>
...
80105093:	e8 18 cb ff ff       	call   80101bb0 <dirlookup>
...
801050dd:	e8 7e c9 ff ff       	call   80101a60 <writei>
...
801050fd:	e8 0e c8 ff ff       	call   80101910 <iunlockput>
  ip->nlink--;
80105102:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105107:	89 1c 24             	mov    %ebx,(%esp)
8010510a:	e8 c1 c4 ff ff       	call   801015d0 <iupdate>
  iunlockput(ip);
8010510f:	89 1c 24             	mov    %ebx,(%esp)
80105112:	e8 f9 c7 ff ff       	call   80101910 <iunlockput>
  end_op();
80105117:	e8 f4 da ff ff       	call   80102c10 <end_op>
  return 0;
...
80105154:	e8 07 c8 ff ff       	call   80101960 <readi>
...
80105178:	e8 93 c7 ff ff       	call   80101910 <iunlockput>
  end_op();
8010517d:	e8 8e da ff ff       	call   80102c10 <end_op>
  return -1;
...
80105222:	0f 88 04 01 00 00    	js     8010532c <sys_open+0x13c>
  ...
  begin_op();
80105228:	e8 73 d9 ff ff       	call   80102ba0 <begin_op>
...
8010523d:	e8 9e cc ff ff       	call   80101ee0 <namei>
...
80105253:	e8 28 c4 ff ff       	call   80101680 <ilock>
...
8010526f:	0f 84 a6 00 00 00    	je     8010531b <sys_open+0x12b>
  struct proc *curproc = myproc();
80105275:	e8 a6 e5 ff ff       	call   80103820 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
8010529c:	e8 bf c4 ff ff       	call   80101760 <iunlock>
  end_op();
801052a1:	e8 6a d9 ff ff       	call   80102c10 <end_op>
...
8010531f:	e8 ec c5 ff ff       	call   80101910 <iunlockput>
    end_op();
80105324:	e8 e7 d8 ff ff       	call   80102c10 <end_op>
    return -1;
...
80105353:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105356:	e8 45 d8 ff ff       	call   80102ba0 <begin_op>
...
8010541e:	e8 ed c4 ff ff       	call   80101910 <iunlockput>
  end_op();
80105423:	e8 e8 d7 ff ff       	call   80102c10 <end_op>
  return 0;
...
8010542f:	90                   	nop
    end_op();
80105430:	e8 db d7 ff ff       	call   80102c10 <end_op>
    return -1;
...
80105445:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105448:	e8 d3 e3 ff ff       	call   80103820 <myproc>
8010544d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010544f:	e8 4c d7 ff ff       	call   80102ba0 <begin_op>
...
8010546f:	e8 6c ca ff ff       	call   80101ee0 <namei>
...
80105481:	e8 fa c1 ff ff       	call   80101680 <ilock>
  if(ip->type != T_DIR){
...
80105494:	e8 c7 c2 ff ff       	call   80101760 <iunlock>
  iput(curproc->cwd);
80105499:	58                   	pop    %eax
8010549a:	ff 76 68             	pushl  0x68(%esi)
8010549d:	e8 0e c3 ff ff       	call   801017b0 <iput>
  end_op();
801054a2:	e8 69 d7 ff ff       	call   80102c10 <end_op>
  curproc->cwd = ip;
...
801054c4:	e8 47 c4 ff ff       	call   80101910 <iunlockput>
    end_op();
801054c9:	e8 42 d7 ff ff       	call   80102c10 <end_op>
    return -1;
...
8010560c:	e8 2f dc ff ff       	call   80103240 <pipealloc>
...
8010561f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105621:	e8 fa e1 ff ff       	call   80103820 <myproc>
...
80105647:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010564a:	e8 d1 e1 ff ff       	call   80103820 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105681:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105688:	e8 93 e1 ff ff       	call   80103820 <myproc>
...
801056c3:	5d                   	pop    %ebp
  return fork();
801056c4:	e9 f7 e2 ff ff       	jmp    801039c0 <fork>
...
801056d3:	83 ec 08             	sub    $0x8,%esp
  exit();
801056d6:	e8 95 e5 ff ff       	call   80103c70 <exit>
...
801056e3:	5d                   	pop    %ebp
  return wait();
801056e4:	e9 d7 e7 ff ff       	jmp    80103ec0 <wait>
...
801056f9:	6a 04                	push   $0x4
801056fb:	50                   	push   %eax
801056fc:	6a 00                	push   $0x0
801056fe:	e8 dd f2 ff ff       	call   801049e0 <argptr>
80105703:	83 c4 10             	add    $0x10,%esp
80105706:	85 c0                	test   %eax,%eax
80105708:	78 2e                	js     80105738 <sys_waitx+0x48>
  {
    return -1;
  }
...
80105710:	6a 04                	push   $0x4
80105712:	50                   	push   %eax
80105713:	6a 01                	push   $0x1
80105715:	e8 c6 f2 ff ff       	call   801049e0 <argptr>
8010571a:	83 c4 10             	add    $0x10,%esp
8010571d:	85 c0                	test   %eax,%eax
8010571f:	78 17                	js     80105738 <sys_waitx+0x48>
  {
    return -1;
  }
...
8010572a:	e8 91 e8 ff ff       	call   80103fc0 <waitx>
...
8010575e:	e8 ed e9 ff ff       	call   80104150 <kill>
...
801057a7:	78 27                	js     801057d0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801057a9:	e8 72 e0 ff ff       	call   80103820 <myproc>
  if(growproc(n) < 0)
...
801057b6:	e8 85 e1 ff ff       	call   80103940 <growproc>
...
80105800:	68 60 51 11 80       	push   $0x80115160
80105805:	e8 76 ed ff ff       	call   80104580 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010580a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010580d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105810:	8b 1d a0 59 11 80    	mov    0x801159a0,%ebx
  while(ticks - ticks0 < n){
...
80105823:	68 60 51 11 80       	push   $0x80115160
80105828:	68 a0 59 11 80       	push   $0x801159a0
8010582d:	e8 ce e5 ff ff       	call   80103e00 <sleep>
  while(ticks - ticks0 < n){
80105832:	a1 a0 59 11 80       	mov    0x801159a0,%eax
...
80105850:	68 60 51 11 80       	push   $0x80115160
...
80105873:	68 60 51 11 80       	push   $0x80115160
...
80105894:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105897:	68 60 51 11 80       	push   $0x80115160
8010589c:	e8 df ec ff ff       	call   80104580 <acquire>
  xticks = ticks;
801058a1:	8b 1d a0 59 11 80    	mov    0x801159a0,%ebx
  release(&tickslock);
801058a7:	c7 04 24 60 51 11 80 	movl   $0x80115160,(%esp)
801058ae:	e8 8d ed ff ff       	call   80104640 <release>
  return xticks;
}
...
801058f7:	c7 04 c5 a2 51 11 80 	movl   $0x8e000008,-0x7feeae5e(,%eax,8)
801058fe:	08 00 00 8e 
80105902:	66 89 14 c5 a0 51 11 	mov    %dx,-0x7feeae60(,%eax,8)
80105909:	80 
8010590a:	c1 ea 10             	shr    $0x10,%edx
8010590d:	66 89 14 c5 a6 51 11 	mov    %dx,-0x7feeae5a(,%eax,8)
80105914:	80 
  for(i = 0; i < 256; i++)
...
80105924:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105927:	c7 05 a2 53 11 80 08 	movl   $0xef000008,0x801153a2
8010592e:	00 00 ef 
  initlock(&tickslock, "time");
80105931:	68 fd 78 10 80       	push   $0x801078fd
80105936:	68 60 51 11 80       	push   $0x80115160
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010593b:	66 a3 a0 53 11 80    	mov    %ax,0x801153a0
80105941:	c1 e8 10             	shr    $0x10,%eax
80105944:	66 a3 a6 53 11 80    	mov    %ax,0x801153a6
  initlock(&tickslock, "time");
...
8010596b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010596f:	b8 a0 51 11 80       	mov    $0x801151a0,%eax
...
801059c0:	e8 5b de ff ff       	call   80103820 <myproc>
801059c5:	85 c0                	test   %eax,%eax
801059c7:	8b 5f 38             	mov    0x38(%edi),%ebx
801059ca:	0f 84 19 02 00 00    	je     80105be9 <trap+0x259>
801059d0:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
801059d4:	0f 84 0f 02 00 00    	je     80105be9 <trap+0x259>
...
801059e0:	e8 1b de ff ff       	call   80103800 <cpuid>
...
80105a22:	e8 f9 dd ff ff       	call   80103820 <myproc>
...
80105a2e:	e8 ed dd ff ff       	call   80103820 <myproc>
80105a33:	85 c0                	test   %eax,%eax
80105a35:	74 1d                	je     80105a54 <trap+0xc4>
80105a37:	e8 e4 dd ff ff       	call   80103820 <myproc>
...
80105a54:	e8 c7 dd ff ff       	call   80103820 <myproc>
80105a59:	85 c0                	test   %eax,%eax
80105a5b:	74 0b                	je     80105a68 <trap+0xd8>
80105a5d:	e8 be dd ff ff       	call   80103820 <myproc>
...
80105a71:	e8 aa dd ff ff       	call   80103820 <myproc>
...
80105aa2:	0f 85 e8 00 00 00    	jne    80105b90 <trap+0x200>
    myproc()->tf = tf;
80105aa8:	e8 73 dd ff ff       	call   80103820 <myproc>
80105aad:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105ab0:	e8 cb ef ff ff       	call   80104a80 <syscall>
    if(myproc()->killed)
80105ab5:	e8 66 dd ff ff       	call   80103820 <myproc>
...
80105b0d:	e8 3e cc ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b12:	e8 09 dd ff ff       	call   80103820 <myproc>
...
80105b24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105b28:	e8 63 02 00 00       	call   80105d90 <uartintr>
    lapiceoi();
80105b2d:	e8 1e cc ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b32:	e8 e9 dc ff ff       	call   80103820 <myproc>
...
80105b4f:	e8 ac dc ff ff       	call   80103800 <cpuid>
...
80105b66:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b69:	e8 b2 dc ff ff       	call   80103820 <myproc>
...
80105b8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105b90:	e8 db e0 ff ff       	call   80103c70 <exit>
80105b95:	e9 0e ff ff ff       	jmp    80105aa8 <trap+0x118>
80105b9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105ba0:	e8 cb e0 ff ff       	call   80103c70 <exit>
80105ba5:	e9 aa fe ff ff       	jmp    80105a54 <trap+0xc4>
80105baa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105bb0:	83 ec 0c             	sub    $0xc,%esp
80105bb3:	68 60 51 11 80       	push   $0x80115160
80105bb8:	e8 c3 e9 ff ff       	call   80104580 <acquire>
      wakeup(&ticks);
80105bbd:	c7 04 24 a0 59 11 80 	movl   $0x801159a0,(%esp)
      ticks++;
80105bc4:	83 05 a0 59 11 80 01 	addl   $0x1,0x801159a0
      wakeup(&ticks);
80105bcb:	e8 20 e5 ff ff       	call   801040f0 <wakeup>
      modify_times();
80105bd0:	e8 cb e6 ff ff       	call   801042a0 <modify_times>
      release(&tickslock);      
80105bd5:	c7 04 24 60 51 11 80 	movl   $0x80115160,(%esp)
80105bdc:	e8 5f ea ff ff       	call   80104640 <release>
80105be1:	83 c4 10             	add    $0x10,%esp
80105be4:	e9 04 ff ff ff       	jmp    80105aed <trap+0x15d>
80105be9:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105bec:	e8 0f dc ff ff       	call   80103800 <cpuid>
80105bf1:	83 ec 0c             	sub    $0xc,%esp
80105bf4:	56                   	push   %esi
80105bf5:	53                   	push   %ebx
80105bf6:	50                   	push   %eax
80105bf7:	ff 77 30             	pushl  0x30(%edi)
80105bfa:	68 2c 79 10 80       	push   $0x8010792c
80105bff:	e8 5c aa ff ff       	call   80100660 <cprintf>
      panic("trap");
80105c04:	83 c4 14             	add    $0x14,%esp
80105c07:	68 02 79 10 80       	push   $0x80107902
80105c0c:	e8 7f a7 ff ff       	call   80100390 <panic>
...
80105c75:	e8 f6 ca ff ff       	call   80102770 <microdelay>
...
80105d0c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d0f:	bb 24 7a 10 80       	mov    $0x80107a24,%ebx
  ioapicenable(IRQ_COM1, 0);
80105d14:	6a 00                	push   $0x0
80105d16:	6a 04                	push   $0x4
80105d18:	e8 b3 c5 ff ff       	call   801022d0 <ioapicenable>
...
80106864:	e8 57 bc ff ff       	call   801024c0 <kalloc>
...
8010687a:	e8 11 de ff ff       	call   80104690 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
8010691d:	68 2c 7a 10 80       	push   $0x80107a2c
...
80106974:	e8 97 b9 ff ff       	call   80102310 <kfree>
      *pte = 0;
...
801069d3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069d6:	e8 25 ce ff ff       	call   80103800 <cpuid>
...
80106a60:	a1 a4 59 11 80       	mov    0x801159a4,%eax
{
...
80106aa4:	0f 84 c2 00 00 00    	je     80106b6c <switchuvm+0xec>
  pushcli();
80106aaa:	e8 01 da ff ff       	call   801044b0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106aaf:	e8 cc cc ff ff       	call   80103780 <mycpu>
80106ab4:	89 c6                	mov    %eax,%esi
80106ab6:	e8 c5 cc ff ff       	call   80103780 <mycpu>
...
80106ac8:	e8 b3 cc ff ff       	call   80103780 <mycpu>
...
80106bab:	77 49                	ja     80106bf6 <inituvm+0x66>
  mem = kalloc();
80106bad:	e8 0e b9 ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106bbf:	e8 cc da ff ff       	call   80104690 <memset>
...
80106bf0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106bf1:	e9 4a db ff ff       	jmp    80104740 <memmove>
    panic("inituvm: more than a page");
80106bf6:	83 ec 0c             	sub    $0xc,%esp
80106bf9:	68 71 7a 10 80       	push   $0x80107a71
...
80106c81:	e8 da ac ff ff       	call   80101960 <readi>
...
80106d49:	0f 86 81 00 00 00    	jbe    80106dd0 <allocuvm+0x100>
    mem = kalloc();
80106d4f:	e8 6c b7 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106d5d:	68 a9 7a 10 80       	push   $0x80107aa9
...
80106d93:	68 c1 7a 10 80       	push   $0x80107ac1
...
80106dbb:	e8 50 b5 ff ff       	call   80102310 <kfree>
      return 0;
...
80106e7e:	e8 8d b4 ff ff       	call   80102310 <kfree>
...
80106e93:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106e94:	e9 77 b4 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106e99:	83 ec 0c             	sub    $0xc,%esp
80106e9c:	68 dd 7a 10 80       	push   $0x80107add
...
80106eb5:	e8 06 b6 ff ff       	call   801024c0 <kalloc>
...
80106f3b:	a3 a4 59 11 80       	mov    %eax,0x801159a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f6f:	68 ee 7a 10 80       	push   $0x80107aee
...
80107015:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80107018:	e8 a3 b4 ff ff       	call   801024c0 <kalloc>
