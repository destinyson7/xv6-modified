  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  29:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  2c:	e8 01 03 00 00       	call   332 <exit>
        int pid = atoi(argv[1]);
  31:	83 ec 0c             	sub    $0xc,%esp
  34:	ff 70 04             	pushl  0x4(%eax)
        int success = getpinfo(pid, &stat);
  37:	8d 75 c4             	lea    -0x3c(%ebp),%esi
        int pid = atoi(argv[1]);
 ...
 3f9:	85 d2                	test   %edx,%edx
{
 ...
 427:	f7 f1                	div    %ecx
 429:	0f b6 92 bc 08 00 00 	movzbl 0x8bc(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 644:	e9 8f fe ff ff       	jmp    4d8 <printf+0x48>
          s = "(null)";
 649:	bb b4 08 00 00       	mov    $0x8b4,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 80 0b 00 00       	mov    0xb80,%eax
{
 ...
 69d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 69f:	a3 80 0b 00 00       	mov    %eax,0xb80
}
 6a4:	5b                   	pop    %ebx
 6a5:	5e                   	pop    %esi
 6a6:	5f                   	pop    %edi
 ...
 6b6:	72 ce                	jb     686 <free+0x26>
{
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 80 0b 00 00       	mov    %eax,0xb80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 15 80 0b 00 00    	mov    0xb80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 47                	jae    788 <malloc+0x98>
    ...
    if(p == freep)
 741:	39 05 80 0b 00 00    	cmp    %eax,0xb80
 ...
 766:	e8 f5 fe ff ff       	call   660 <free>
  return freep;
 76b:	8b 15 80 0b 00 00    	mov    0xb80,%edx
 ...
 794:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 797:	89 15 80 0b 00 00    	mov    %edx,0xb80
}
 ...
 7a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 80 0b 00 00 84 	movl   $0xb84,0xb80
 7b7:	0b 00 00 
 7ba:	c7 05 84 0b 00 00 84 	movl   $0xb84,0xb84
 7c1:	0b 00 00 
    base.s.size = 0;
 7c4:	b8 84 0b 00 00       	mov    $0xb84,%eax
 7c9:	c7 05 88 0b 00 00 00 	movl   $0x0,0xb88
 7d0:	00 00 00 
