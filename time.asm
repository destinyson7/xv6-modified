...
{  
  ...
  int wtime, rtime;
  int pid = fork();
  18:	e8 cd 02 00 00       	call   2ea <fork>

  if(pid < 0)
  1d:	85 c0                	test   %eax,%eax
  1f:	78 6a                	js     8b <main+0x8b>
  {
  ...
  47:	53                   	push   %ebx
  48:	ff 33                	pushl  (%ebx)
  4a:	e8 db 02 00 00       	call   32a <exec>

    // success = 0;
    printf(1, "exec: fail\n");
  4f:	59                   	pop    %ecx
  50:	5b                   	pop    %ebx
  51:	68 b8 07 00 00       	push   $0x7b8
  56:	6a 01                	push   $0x1
  ...
  exit();
  60:	e8 8d 02 00 00       	call   2f2 <exit>
    waitx(&wtime, &rtime);
  65:	50                   	push   %eax
  66:	50                   	push   %eax
  ...
  6e:	50                   	push   %eax
  6f:	e8 1e 03 00 00       	call   392 <waitx>
    printf(1, "rtime = %d, wtime = %d\n", rtime, wtime);
  74:	ff 75 e0             	pushl  -0x20(%ebp)
  77:	ff 75 e4             	pushl  -0x1c(%ebp)
  7a:	68 c4 07 00 00       	push   $0x7c4
  7f:	6a 01                	push   $0x1
