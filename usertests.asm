...
00000480 <writetest>:
{
  ...
  i = read(fd, buf, 2000);
     ...
     561:	68 40 8b 00 00       	push   $0x8b40
     566:	53                   	push   %ebx
...
00000660 <writetest1>:
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     6a3:	89 1d 40 8b 00 00    	mov    %ebx,0x8b40
    if(write(fd, buf, 512) != 512){
     6a9:	68 00 02 00 00       	push   $0x200
     6ae:	68 40 8b 00 00       	push   $0x8b40
     6b3:	56                   	push   %esi
  ...
  n = 0;
    ...
    if(((int*)buf)[0] != n){
     70b:	a1 40 8b 00 00       	mov    0x8b40,%eax
    ...
    i = read(fd, buf, 512);
     ...
     71f:	68 40 8b 00 00       	push   $0x8b40
     724:	56                   	push   %esi
     ...
     834:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  name[0] = 'a';
     84c:	c6 05 40 ab 00 00 61 	movb   $0x61,0xab40
  name[2] = '\0';
     853:	c6 05 42 ab 00 00 00 	movb   $0x0,0xab42
     85a:	83 c4 10             	add    $0x10,%esp
     85d:	8d 76 00             	lea    0x0(%esi),%esi
    fd = open(name, O_CREATE|O_RDWR);
     860:	83 ec 08             	sub    $0x8,%esp
    name[1] = '0' + i;
     863:	88 1d 41 ab 00 00    	mov    %bl,0xab41
     869:	83 c3 01             	add    $0x1,%ebx
    fd = open(name, O_CREATE|O_RDWR);
     86c:	68 02 02 00 00       	push   $0x202
     871:	68 40 ab 00 00       	push   $0xab40
  ...
  name[0] = 'a';
     88b:	c6 05 40 ab 00 00 61 	movb   $0x61,0xab40
  name[2] = '\0';
     892:	c6 05 42 ab 00 00 00 	movb   $0x0,0xab42
     899:	bb 30 00 00 00       	mov    $0x30,%ebx
     89e:	66 90                	xchg   %ax,%ax
    unlink(name);
     8a0:	83 ec 0c             	sub    $0xc,%esp
    name[1] = '0' + i;
     8a3:	88 1d 41 ab 00 00    	mov    %bl,0xab41
     8a9:	83 c3 01             	add    $0x1,%ebx
    unlink(name);
     8ac:	68 40 ab 00 00       	push   $0xab40
     ...
     a16:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a60:	57                   	push   %edi
     a61:	68 40 8b 00 00       	push   $0x8b40
     ...
     a7e:	f7 d9                	neg    %ecx
     a80:	38 9c 0b 40 8b 00 00 	cmp    %bl,0x8b40(%ebx,%ecx,1)
    ...
    close(fds[0]);
     ...
     ade:	66 90                	xchg   %ax,%ax
        buf[i] = seq++;
     ae0:	88 84 03 40 8b 00 00 	mov    %al,0x8b40(%ebx,%eax,1)
     ...
     af6:	68 40 8b 00 00       	push   $0x8b40
...
00000bb0 <preempt>:
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c55:	68 40 8b 00 00       	push   $0x8b40
    ...
    101b:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i = 0; i < 2; i++){
    ...
    10b8:	68 40 8b 00 00       	push   $0x8b40
    ...
    10ce:	66 90                	xchg   %ax,%ax
        if(buf[j] != '0'+i){
    10d0:	0f be b2 40 8b 00 00 	movsbl 0x8b40(%edx),%esi
  ...
  printf(1, "fourfiles ok\n");
    ...
    1171:	68 40 8b 00 00       	push   $0x8b40
    ...
    1186:	68 40 8b 00 00       	push   $0x8b40
    118b:	56                   	push   %esi
...
00001430 <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14e1:	68 40 8b 00 00       	push   $0x8b40
    14e6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    14f8:	80 3d 40 8b 00 00 68 	cmpb   $0x68,0x8b40
    14ff:	75 6b                	jne    156c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    1501:	83 ec 04             	sub    $0x4,%esp
    1504:	6a 0a                	push   $0xa
    1506:	68 40 8b 00 00       	push   $0x8b40
    150b:	53                   	push   %ebx
...
000015c0 <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1694:	68 40 8b 00 00       	push   $0x8b40
    1699:	50                   	push   %eax
...
00001d10 <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e06:	68 40 8b 00 00       	push   $0x8b40
    1e0b:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e1d:	80 3d 40 8b 00 00 66 	cmpb   $0x66,0x8b40
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f05:	68 40 8b 00 00       	push   $0x8b40
    1f0a:	50                   	push   %eax
...
000023f0 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    243e:	53                   	push   %ebx
    243f:	68 40 8b 00 00       	push   $0x8b40
    2444:	50                   	push   %eax
    ...
    2454:	53                   	push   %ebx
    2455:	68 40 8b 00 00       	push   $0x8b40
    245a:	56                   	push   %esi
...
000024d0 <bigfile>:
{
  ...
  for(i = 0; ; i++){
    ...
    258b:	0f be 05 40 8b 00 00 	movsbl 0x8b40,%eax
    2592:	89 fa                	mov    %edi,%edx
    2594:	d1 fa                	sar    %edx
    2596:	39 d0                	cmp    %edx,%eax
    2598:	75 6e                	jne    2608 <bigfile+0x138>
    259a:	0f be 15 6b 8c 00 00 	movsbl 0x8c6b,%edx
  ...
  for(i = 0; ; i++){
    ...
    25b6:	68 40 8b 00 00       	push   $0x8b40
    25bb:	56                   	push   %esi
...
00003200 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    3219:	80 3d 00 64 00 00 00 	cmpb   $0x0,0x6400
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    if(uninit[i] != '\0'){
    3230:	80 b8 00 64 00 00 00 	cmpb   $0x0,0x6400(%eax)
    ...
    3386:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fsfull test\n");
    ...
    344a:	68 40 8b 00 00       	push   $0x8b40
    344f:	57                   	push   %edi
