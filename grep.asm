 ...
 236:	31 f6                	xor    %esi,%esi
{
 ...
 24a:	50                   	push   %eax
 24b:	8d 86 c0 13 00 00    	lea    0x13c0(%esi),%eax
 251:	50                   	push   %eax
 ...
 265:	01 c6                	add    %eax,%esi
    p = buf;
 267:	bb c0 13 00 00       	mov    $0x13c0,%ebx
    buf[m] = '\0';
 26c:	c6 86 c0 13 00 00 00 	movb   $0x0,0x13c0(%esi)
 ...
 2d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(p == buf)
 2d8:	81 fb c0 13 00 00    	cmp    $0x13c0,%ebx
 ...
 2ed:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 2f0:	2d c0 13 00 00       	sub    $0x13c0,%eax
 2f5:	29 c6                	sub    %eax,%esi
      memmove(buf, p, m);
 2f7:	56                   	push   %esi
 2f8:	53                   	push   %ebx
 2f9:	68 c0 13 00 00       	push   $0x13c0
