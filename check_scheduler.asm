...
int main(int argc, char *argv[])
{
  ...
  19:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    ...
    if(pid == 0)
  20:	74 38                	je     5a <main+0x5a>
  for(int i = 0; i < 100; i++)
  22:	83 eb 01             	sub    $0x1,%ebx
  25:	74 1c                	je     43 <main+0x43>
    int pid = fork();
  27:	e8 7e 02 00 00       	call   2aa <fork>
    if(pid < 0)
  2c:	85 c0                	test   %eax,%eax
  2e:	79 f0                	jns    20 <main+0x20>
      printf(1, "init: fork failed\n");
  30:	50                   	push   %eax
  31:	50                   	push   %eax
  32:	68 68 07 00 00       	push   $0x768
  37:	6a 01                	push   $0x1
  39:	e8 d2 03 00 00       	call   410 <printf>
      exit();
  3e:	e8 6f 02 00 00       	call   2b2 <exit>
  43:	bb 64 00 00 00       	mov    $0x64,%ebx
  48:	90                   	nop
